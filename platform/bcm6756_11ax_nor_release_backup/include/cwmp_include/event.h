...
#define EVENT_MRREBOOT_ACS_FLAG     4
#define EVENT_REBOOT_TRANSFERCOMPLETE_FLAG 8
#define EVENT_UPLOAD_TRANSFERCOMPLETE_FLAG     16
...
int cwmp_event_save_active(cwmp_t *cwmp);
int cwmp_event_file_save(cwmp_t * cwmp);
int cwmp_event_clear_transfercomplete_active(cwmp_t *cwmp);
