...
setMode() {
	...
	case "$mode" in
		"controller")
			...
			cfmSet steerd.ess "wlan0;wlan1;wlan2"
			cfmSet sys.workmode router
			cfmSet wans.flag 1
			cfmSet wlan0_enable 1
			cfmSet wlan0_maxbss 8
		...
		"agent")
			...
			case "$bsta" in
				"wlan0")
					...
					cfmSet wlan1_workmode ap
					cfmSet steerd.backhaul wlan0
					cfmSet steerd.ess "wlan0.x;wlan1;wlan2"
				...
				"wlan1")
					...
					cfmSet steerd.backhaul wlan1
					cfmSet steerd.ess "wlan0;wlan1.x;wlan2"
