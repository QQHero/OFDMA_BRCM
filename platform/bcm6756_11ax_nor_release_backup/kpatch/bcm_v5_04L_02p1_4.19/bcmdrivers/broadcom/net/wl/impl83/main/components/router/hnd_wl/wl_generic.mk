...
ifdef CONFIG_TENDA_WLAN_COUNTRY_DIV_CHANNEL
CLM_FILE_SUFFIX := _nic_6756_DC_30dB
CLM_FILE_SUFFIX_NIC = _nic_6756_DC_30dB
else
...
ifeq ($(TD_STEER), 1)
ifeq ($(CONFIG_STEERING_SUPPORT_6G), 1)
	EXTRA_CFLAGS += -DTD_STEER_SUPPORT_6G
endif
