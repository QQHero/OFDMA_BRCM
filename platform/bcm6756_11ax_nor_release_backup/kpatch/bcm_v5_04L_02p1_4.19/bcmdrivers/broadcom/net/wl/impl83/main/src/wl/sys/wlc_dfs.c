 ...
 *
 * $Id: wlc_dfs.c 800951 2021-07-12 06:32:47Z $
 */
...
enum wlc_dfs_iov {
    ...
    IOV_DFS_HANDLE_RADAR_ONSTA = 15,    /* Disabled by default. Radar detection logic for
                         ...
                         * WET/DWDS/MAP.
                         */
    IOV_DFS_RESET = 16,    /* clear radar status, clear cac time */
    IOV_LAST
};
...
#define DFS_REAL_BW160(wlc)        (D11REV_IS(wlc->pub->corerev, 129) || \
        ...
        D11MINORREV_IS(wlc->pub->corerev_minor, 2)) || D11REV_IS(wlc->pub->corerev, 132))
...
wlc_dfs_csa_each_up_ap(wlc_info_t *wlc, wl_chan_switch_t *csa, bool docs)
{
    ...
    if (csa->chspec == wlc->home_chanspec) {
        WL_DFS(("wl%d: %s: Reject CSA to current home channel 0x%x\n",
