 ...
 *
 * $Id: wlc_bsscfg.h 797938 2021-04-20 16:55:41Z $
 */
...
struct wlc_bsscfg {
    ...
    uint32       td_auto_hide;    /**< Automatically hide ssiD */
#endif
    ...
    bool ai_mesh_enable;
#endif
#if defined(CONFIG_MESH_MULTIFREQ_LOADBALANCE) && defined(CONFIG_TD_MESH_V3) && defined(CONFIG_TENDA_PRIVATE_WLAN)
    bool mesh3_0_enable;
#endif
