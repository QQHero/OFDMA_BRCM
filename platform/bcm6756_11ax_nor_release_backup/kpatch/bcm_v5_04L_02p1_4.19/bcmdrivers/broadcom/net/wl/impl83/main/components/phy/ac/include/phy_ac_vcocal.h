 ...
 *
 * $Id: phy_ac_vcocal.h 796169 2021-02-24 19:41:57Z $
 */
...
extern void wlc_phy_20708_radio_vcocal(phy_info_t *pi, uint8 cal_mode, uint8 logen_mode);
extern void wlc_phy_20709_radio_vcocal(phy_info_t *pi);
extern void wlc_phy_20710_radio_vcocal(phy_info_t *pi);
...
extern void wlc_phy_radio20708_vcocal_isdone(phy_info_t *pi, bool set_delay, uint8 logen_mode);
extern void wlc_phy_radio20709_vcocal_isdone(phy_info_t *pi, bool set_delay);
extern void wlc_phy_radio20710_vcocal_isdone(phy_info_t *pi, bool set_delay);
...
/* 20708 vco cal */
#define VCO_CAL_MODE_20708              0

void phy_ac_vcocal_singlephase(phy_info_t *pi);
void phy_ac_vcocal_multiphase(phy_info_t *pi, uint16 cts_time);
void wlc_phy_radio20707_vco_cal_sanity_check(phy_info_t *pi);
void wlc_phy_radio20710_vco_cal_sanity_check(phy_info_t *pi);
