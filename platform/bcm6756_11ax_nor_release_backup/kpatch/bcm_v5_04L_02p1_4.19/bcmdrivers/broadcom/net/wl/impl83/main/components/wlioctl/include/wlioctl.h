 ...
 *
 * $Id: wlioctl.h 800659 2021-07-01 19:23:31Z $
 */
...
typedef struct wl_join_params {
    wlc_ssid_t ssid;
    uint32    ssid_type;        /**< ssid_type flag ,0 use default, and flags specified
                     * WL_SCAN_SSID_FLAGS
                     */
...
typedef struct {
    ...
    uint16      states;       /* replace PAD above to check APClient status */
#else
