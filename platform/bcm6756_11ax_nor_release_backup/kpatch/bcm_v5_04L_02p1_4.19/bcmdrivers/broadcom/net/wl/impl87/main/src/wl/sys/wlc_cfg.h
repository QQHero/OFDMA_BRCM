 ...
 *
 * $Id: wlc_cfg.h 807005 2022-01-11 12:13:35Z $
 */
...
#define D11_DEFAULT5    0x0000001e    /* Supported  D11 revs: 129(43684b0),
                     * 130(63178a0), 131(6710a0), 132(6715b0)
                     */
...
#error "STS_XFER_TXS must not be defined along with WLC_OFFLOADS_TXSTS"
#endif /* WLC_OFFLOADS_TXSTS */

#if defined(BCMHWA4A)
#error "STS_XFER_TXS must not be defined along with BCMHWA4A"
#endif /* BCMHWA4A */
...
#error "STS_XFER_PHYRXS feature depends on BULKRX_PKTLIST"
#endif /* BULKRX_PKTLIST */

#if defined(STS_FIFO_RXEN)
#error "STS_XFER_PHYRXS must not be defined along with STS_FIFO_RXEN"
#endif /* STS_FIFO_RXEN */

#if defined(WLC_OFFLOADS_RXSTS)
#error "STS_XFER_PHYRXS must not be defined along with WLC_OFFLOADS_RXSTS"
#endif /* WLC_OFFLOADS_RXSTS */

#endif /* STS_XFER_PHYRXS */

#if defined(STS_XFER_M2M_INTR) && defined(BCMHWA) && !defined(DONGLEBUILD)
/**
...
#endif /* STS_XFER_M2M_INTR && BCMHWA && !DONGLEBUILD */
...
#else
#define VASIP_11AX_2X2_160_ENAB 1
#endif
#endif /* D11CONF_HAS(130) */
#if D11CONF_HAS(131)
...
#define MAXSCBCUBBIES        52    /* max number of cubbies in scb container */
#endif /* MAXSCBCUBBIES */
...
#else
#define AMPDU_PKTQ_LEN        8192 /* enough to accomodate 8MB TCP window on NIC driver */
#endif /* DONGLEBUILD */
 ...
 */
#ifndef MAXPKTCB
#define MAXPKTCB    (MAXSCB*2)    /* Max number of packet callbacks */
#endif /* MAXPKTCB */
...
#define MAXBSS		128 * 2 /* max # available networks */
#else
...
#define WLC_MAX_TX_NSS 4 /**< max number of simultaneous spatial tx streams supported by sw */
