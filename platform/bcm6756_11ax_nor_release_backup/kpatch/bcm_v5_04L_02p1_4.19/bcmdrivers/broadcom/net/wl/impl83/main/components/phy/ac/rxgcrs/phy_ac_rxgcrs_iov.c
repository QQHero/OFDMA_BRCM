 ...
 *
 * $Id: phy_ac_rxgcrs_iov.c 794248 2020-12-29 22:41:24Z $
 */
...
enum {
    ...
    IOV_PHY_FORCE_RXGAIN = 9,
    IOV_PHY_SUBBAND_EDADJ = 10
};
...
static const bcm_iovar_t phy_ac_rxgcrs_iovars[] = {
    ...
    IOVF_SET_UP, 0, IOVT_UINT32, 0},
    {"phy_force_rxgain", IOV_PHY_FORCE_RXGAIN,
    IOVF_SET_UP | IOVF_GET_UP, 0, IOVT_UINT32, 0},
    {"phy_subband_edadj", IOV_PHY_SUBBAND_EDADJ,
    IOVF_SET_UP | IOVF_GET_UP, 0, IOVT_UINT32, 0},
    {NULL, 0, 0, 0, 0, 0}
};
    ...
    void *p, uint plen, void *a, uint alen, uint vsize, struct wlc_if *wlcif)
{
    ...
    switch (aid) {
        ...
        case IOV_SVAL(IOV_PHY_LESISCALE_HALFDB_5G):
            ...
            break;
        case IOV_GVAL(IOV_PHY_FORCE_RXGAIN):
            err = phy_ac_rxgcrs_iovar_get_force_rxgain(rxgcrsi, ret_int_ptr);
            break;
        case IOV_SVAL(IOV_PHY_FORCE_RXGAIN):
            err = phy_ac_rxgcrs_iovar_set_force_rxgain(rxgcrsi, int_val);
            break;
        case IOV_GVAL(IOV_PHY_SUBBAND_EDADJ):
            err = phy_ac_rxgcrs_iovar_get_subband_edadj(rxgcrsi, ret_int_ptr);
            break;
        case IOV_SVAL(IOV_PHY_SUBBAND_EDADJ):
            err = phy_ac_rxgcrs_iovar_set_subband_edadj(rxgcrsi, int_val);
            break;
        default:
