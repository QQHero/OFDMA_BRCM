 ...
 *
 * $Id: wlc_scb_ratesel.c 796182 2021-02-25 02:33:12Z $
 */
...
wlc_scb_ratesel_init(wlc_info_t *wlc, struct scb *scb)
{
	...
	rs_init.bw_auto_ul = SCB_ULOFDMA(scb) ? FALSE : rs_init.bw_auto_ul;
	WL_RATE(("%s bw_auto_dl %d bw_auto_ul %d dl_ofdma policy 0x%x "
		"ul_ofdma policy 0x%x\n", __FUNCTION__, rs_init.bw_auto_dl,
		 rs_init.bw_auto_ul, SCB_DLOFDMA(scb), SCB_ULOFDMA(scb)));
#endif /* WL11AX */
