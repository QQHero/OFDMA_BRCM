 ...
 *
 * $Id: wlc_bsscfg.h 810655 2022-04-12 06:08:44Z $
 */
...
typedef struct wlc_mbssid_tag_list {
    wlc_iem_tag_t  tag[MAX_TAG_MBSSID_IE]; /* list of IE's  in non tx profile */
    uint8  tags_len;
    uint8  non_inherit[MAX_TAG_MBSSID_IE]; /* IE's to be added in inheritance IE */
    uint8  non_inherit_len;
    uint8  non_inherit_ext[MAX_TAG_MBSSID_IE]; /* Ext IE's in inheritance IE */
    uint8  non_inherit_ext_len;
} wlc_mbssid_tag_list_t;

#ifdef CONFIG_TENDA_WLAN_AUTOHIDE_SSID    /* The meaning of the td_auto_hide value */
typedef enum td_em_auto_hide
{
    SCB_AUTO_HIDE_OFF = 0,    /* Disable the automatic hide function */
    SCB_AUTO_HIDE_ON = 1,    /* Enable the automatic hide function */
    SCB_AUTO_HIDE = 2,    /* Autohide is in use */
    SCB_USER_HIDE = 3,    /* The SSID was hidden by the user */
}td_em_auto_hide_e;
...
struct wlc_bsscfg {
    ...
    int32   td_ethx_connect;
    int32   td_prio_assoc_flag;
#endif
#endif    /* MULTIAP */
    ...
    uint8       td_maps_radio_index;
    uint8       td_maps_bss_index;
#endif
#if defined(TD_EASYMESH_SUPPORT) && defined(CONFIG_TENDA_PRIVATE_WLAN)
    uint8       multiap_steering_policy;
    uint8       multiap_cu_threshold;
    uint8       multiap_rcpi_threshold;
    bool        multiap_bssSteer_scan;
    uint32      multiap_bssSteer_channel;
    struct ether_addr multiap_target_bssid;
    struct ether_addr multiap_sta_mac;
#endif
    ...
    uint32 prev_rxframe; /* 启动无线接口监测机制时，每1分钟更新一次prev_rxframe用作对比 */
#ifdef CONFIG_TENDA_WLAN_AUTOHIDE_SSID
    td_em_auto_hide_e    td_auto_hide;    /**< Automatically hide ssiD */
#endif /* CONFIG_TENDA_WLAN_AUTOHIDE_SSID */
#endif /* CONFIG_TENDA_PRIVATE_WLAN */
    uint8 bfe_capable;
    chanspec_t ap_orig_chanspec;
    bool    cac_started;
#ifdef BCMDBG
...
#define WLC_BSSCFG_FL2_RSN_CAP_SPPC    0x200000    /* SSP AMSDU capable */
#define WLC_BSSCFG_FL2_RSN_CAP_SPPR    0x400000    /* SSP AMSDU required */
#define WLC_BSSCFG_FL2_BLOCK_STA_ON_MAPBH    0x800000 /* block non-MAP STAs on MultiAP BH */
#define WLC_BSSCFG_FL2_EMPTY_SSID_ON_CLOSED_NW    0x2000000 /* empty ssid support on closed network */

#define BSSCFG_IS_EMPTY_SSID_SUPPORTED_ON_CLOSED_NW(cfg) \
    (((cfg)->flags2 & WLC_BSSCFG_FL2_EMPTY_SSID_ON_CLOSED_NW) != 0)

#ifdef MULTIAP
#define BSSCFG_BLOCK_STA_ON_MAPBH(cfg) ((((cfg)->map_attr) & MAP_EXT_ATTR_BACKHAUL_BSS) &&\
        !(((cfg)->map_attr) & MAP_EXT_ATTR_FRNTHAUL_BSS) &&\
        (((cfg)->flags2) & WLC_BSSCFG_FL2_BLOCK_STA_ON_MAPBH))
#else
#define BSSCFG_BLOCK_STA_ON_MAPBH(cfg) FALSE
#endif /* MULTIAP */
...
#ifdef WL_SPP_AMSDU
#define BSSCFG_IS_RSN_CAP_SPPC(cfg)    (((cfg)->flags2 & WLC_BSSCFG_FL2_RSN_CAP_SPPC) != 0)
#define BSSCFG_IS_RSN_CAP_SPPR(cfg)    (((cfg)->flags2 & WLC_BSSCFG_FL2_RSN_CAP_SPPR) != 0)

#define SPP_AMSDU_DISABLED    0
#define SPP_AMSDU_CAPABLE    1
#define SPP_AMSDU_REQUIRED    2

#define IS_RSN_CAP_SPPC(bss)        (((bss)->wpa2.cap[1] & (RSN_CAP_SPPC >> 8)) != 0)
#define IS_RSN_CAP_SPPR(bss)        (((bss)->wpa2.cap[1] & (RSN_CAP_SPPR >> 8)) != 0)
#endif /* WL_SPP_AMSDU */
#ifdef WLFBT
