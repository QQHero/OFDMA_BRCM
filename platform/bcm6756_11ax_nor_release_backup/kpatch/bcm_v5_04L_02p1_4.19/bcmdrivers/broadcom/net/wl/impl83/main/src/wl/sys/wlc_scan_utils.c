 ...
 *
 * $Id: wlc_scan_utils.c 801227 2021-07-19 11:40:32Z $
 */
...
#define CHANNELS_ALL_AVAILABLE     0
#define TD_SCAN_DEFAULT_NPROBES         3        /* 主动扫描时，对每个信道的probe次数. SDK默认是2 */
#define TD_SCAN_DEFAULT_ACTIVE_TIME    90        /* 主动扫描时，扫描每个信道的持续时间. 单位 :ms. SDK默认是20 */
#define WLC_SCAN_PARAMS_NPROBES_DEFAULT        -1
#define WLC_SCAN_PARAMS_ACTIVE_TIME_DEFAULT    -1
    ...
    do { /* go through all multiple BSSID IEs */
        ...
        do {
            ...
            if (((scan->bss_type == DOT11_BSSTYPE_ANY ||
                ...
                wlc_is_sh_ssid_match_reg_ssid(scan, ssid, ssid_len) ||
#ifdef NLO
                  (cfg && cfg->nlo) ||
#endif /* NLO */
                  FALSE) &&
...
#ifdef WLCHANIM
    bi->phy_noise = wlc_lq_chanim_phy_noise(wlc);
#else
