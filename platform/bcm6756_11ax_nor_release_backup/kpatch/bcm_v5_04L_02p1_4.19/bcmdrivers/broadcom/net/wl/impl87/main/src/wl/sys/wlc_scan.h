 ...
 *
 * $Id: wlc_scan.h 807674 2022-01-27 13:34:11Z $
 */
...
#define SCAN_STATE_ON_SCAN_CHANNEL     (1 << 20)
 ...
 */
#define WLC_SCAN_6G_ACTIVE_TIME            55
#define WLC_SCAN_6G_DISCOVERY_TIME        110
#endif /* BAND6G */
...
struct wlc_scan_info {
    ...
    bool is_host_short_ssid;        /* Short SSID provided by host */
    bool is_host_no_ssid;            /* No SSID provided by host */
};
...
extern bool wlc_is_sh_ssid_match_reg_ssid(wlc_scan_info_t *wlc_scan_info,
    uint8 *ssid_buf, uint8 ssid_len);
...
#ifdef WL_RANDMAC
struct ether_addr *wlc_scan_get_randmac(wlc_scan_info_t *scan, int macreq, wlc_bsscfg_t *bsscfg);
