 ...
 *
 * $Id: phy_ac_info.h 798982 2021-05-18 08:07:47Z $
 */
...
#define ACMAJORREV_47_129_130_131_132(phy_rev) \
	(ACREV_IS(phy_rev, 47) || ACREV_IS(phy_rev, 129) ||\
	ACREV_IS(phy_rev, 130) || ACREV_IS(phy_rev, 131) || ACREV_IS(phy_rev, 132))
