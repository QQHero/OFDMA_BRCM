...
#elif defined(CCI400)
    /*config XRDP for CCI */
    CCI400->si[3].snoop_ctrl |= SNOOP_CTRL_ENABLE_SNOOP;
...
#if defined(CONFIG_BCM947189) || defined(CONFIG_BCM96846) ||defined(CONFIG_BCM947622) || defined(CONFIG_BCM963178) || \
...
#if !defined(CONFIG_DT_SUPPORT_ONLY)
