 ...
 *
 * $Id: wltunable_lx_6756.h 772733 2019-03-04 01:50:03Z $
 *
 * wl driver tunables
 */
...
#define D11CONF5    0x0000000C    /* D11 Core Rev > 127, 130(6756), 131 (6710) */
#define ACCONF2        0x00000000    /* AC-Phy Rev > 31 */
#define ACCONF5        0x0000000A    /* AC-Phy Rev > 127, Rev 129(6710),
                     * 131 (6756)
                     */
#else /* __CONFIG_DHDAP__ */
#define D11CONF3    0x00000002    /* D11 Core Rev > 63, 65(4365c0) */
#define D11CONF5    0x0000001e    /* D11 Core Rev > 127, 129(43684b0),
                     * 130(6756), 131(6710), 132 (6715)
                     */
#define ACCONF2        0x00008002    /* AC-Phy Rev > 31, Rev 33(4365c0),
                     * 47(43684a0/b0)
                     */
#define ACCONF5        0x0000000E    /* AC-Phy Rev > 127, Rev 129(6710),
                     * 130 (6715), 131 (6756)
                     */
