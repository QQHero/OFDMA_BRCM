 ...
 *
 * $Id: wlc_ap.h 810739 2022-04-13 06:48:38Z $
 */
#ifndef _WLC_AP_H_
#define _WLC_AP_H_
...
/* Deauth filter related functions */
extern bool wlc_ap_intransit_filter_add_da(
    wlc_ap_info_t *apinfo, wlc_bsscfg_t *cfg,
    struct ether_addr *da);

extern void wlc_ap_intransit_filter_rem_da(
    wlc_ap_info_t *apinfo, wlc_bsscfg_t *cfg,
    struct ether_addr *da);

extern bool wlc_ap_intransit_filter_check_da(
    wlc_ap_info_t *apinfo, wlc_bsscfg_t *cfg,
    struct ether_addr *da);
#endif /* WLDEAUTH_INTRANSIT_FILTER */
extern int wlc_ap_check_tx_bss_for_upr_fd(wlc_info_t *wlc);
#else /* AP */
...
#define wlc_ap_check_tx_bss_for_upr_fd(a) do {} while (0)
...
void wlc_ap_reset_psp_attempt(wlc_ap_info_t *ap, struct scb *scb, uint16 cnt);

uint wlc_ap_get_activity_time(wlc_ap_info_t *ap);

bool wlc_ap_pspretend_probe(wlc_ap_info_t *ap, wlc_bsscfg_t *cfg, struct scb *scb);
...
void wlc_test_clear_aid(wlc_info_t *wlc, struct scb *scb);
#else
#define wlc_test_clear_aid(wlc, scb)
#endif
...
extern int wlc_ap_set_assoc_rej_rssi_th(wlc_info_t *wlc, wlc_bsscfg_t *bsscfg, int8 rssi);
extern int wlc_ap_get_assoc_rej_rssi_th(wlc_info_t *wlc, wlc_bsscfg_t *bsscfg, int8 *rssi);
#endif /* _WLC_AP_H_ */
#ifdef WL_MBSSID
...
#endif /* WL11AC */
uint8 wlc_ap_scb_supported_bands(wlc_info_t *wlc, struct scb *scb);

#ifdef BAND6G
int8 wlc_update_regulatory_info(wlc_info_t *wlc, chanspec_t chspec);
int8 wlc_get_regulatory_info(wlc_info_t *wlc);
#endif /* BAND6G */
