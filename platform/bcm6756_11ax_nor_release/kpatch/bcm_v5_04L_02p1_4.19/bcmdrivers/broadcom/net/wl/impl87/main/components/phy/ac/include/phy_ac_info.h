 ...
 *
 * $Id: phy_ac_info.h 809672 2022-03-22 04:44:16Z $
 */
...
#define ACMAJORREV_131(phy_rev) \
    (ACREV_IS(phy_rev, 131))

#define ACMAJORREV_GE131(phy_rev) \
    (ACREV_GE(phy_rev, 131))

#define ACMAJORREV_130(phy_rev) \
    (ACREV_IS(phy_rev, 130))

#define ACMAJORREV_GE130(phy_rev) \
    (ACREV_GE(phy_rev, 130))
...
#define ACMAJORREV_GE128(phy_rev) \
    (ACREV_GE(phy_rev, 128))
...
#define ACMAJORREV_47_51_131(phy_rev) \
    (ACREV_IS(phy_rev, 47) || ACREV_IS(phy_rev, 51) || ACREV_IS(phy_rev, 131))

#define ACMAJORREV_47_129(phy_rev) \
    (ACREV_IS(phy_rev, 47) || ACREV_IS(phy_rev, 129))

#define ACMAJORREV_47_130(phy_rev) \
    (ACREV_IS(phy_rev, 47) || ACREV_IS(phy_rev, 130))

#define ACMAJORREV_47_129_130(phy_rev) \
    (ACREV_IS(phy_rev, 47) || ACREV_IS(phy_rev, 129) || ACREV_IS(phy_rev, 130))

#define ACMAJORREV_47_129_130_131(phy_rev) \
    (ACREV_IS(phy_rev, 47) || ACREV_IS(phy_rev, 129) ||\
    ACREV_IS(phy_rev, 130) || ACREV_IS(phy_rev, 131))
...
#define ACMAJORREV_51_129_131(phy_rev) \
    (ACREV_IS(phy_rev, 51) || ACREV_IS(phy_rev, 129) || ACREV_IS(phy_rev, 131))

#define ACMAJORREV_51_129_130(phy_rev) \
    (ACREV_IS(phy_rev, 51) || ACREV_IS(phy_rev, 129) || ACREV_IS(phy_rev, 130))

#define ACMAJORREV_51_129_130_131(phy_rev) \
    (ACREV_IS(phy_rev, 51) || ACREV_IS(phy_rev, 129) ||\
    ACREV_IS(phy_rev, 130) || ACREV_IS(phy_rev, 131))

#define ACMAJORREV_129_130(phy_rev) \
    (ACREV_IS(phy_rev, 129) || ACREV_IS(phy_rev, 130))

#define ACMAJORREV_47_51_129(phy_rev) \
    (ACREV_IS(phy_rev, 47) || ACREV_IS(phy_rev, 51) ||\
     ACREV_IS(phy_rev, 129))

#define ACMAJORREV_47_51_129_131(phy_rev) \
    (ACREV_IS(phy_rev, 47) || ACREV_IS(phy_rev, 51) ||\
     ACREV_IS(phy_rev, 129) || ACREV_IS(phy_rev, 131))

#define ACMAJORREV_47_51_129_130(phy_rev) \
    (ACREV_IS(phy_rev, 47) || ACREV_IS(phy_rev, 51) ||\
     ACREV_IS(phy_rev, 129) || ACREV_IS(phy_rev, 130))

#define ACMAJORREV_47_51_129_130_131(phy_rev) \
    (ACREV_IS(phy_rev, 47) || ACREV_IS(phy_rev, 51) ||\
     ACREV_IS(phy_rev, 129) || ACREV_IS(phy_rev, 130) ||\
     ACREV_IS(phy_rev, 131))

#define ACMAJORREV_130_131(phy_rev) \
    (ACREV_IS(phy_rev, 130) || ACREV_IS(phy_rev, 131))
...
#define ACMAJORREV_GE40_NE47_NE129_NE130(phy_rev) \
    (ACREV_GE(phy_rev, 40) && !ACREV_IS(phy_rev, 47) &&\
     !ACREV_IS(phy_rev, 129) && !ACREV_IS(phy_rev, 130))
...
#define ACMAJORREV_GE40_NE47_NE51_NE129_NE130(phy_rev) \
    (ACREV_GE(phy_rev, 40) && !ACREV_IS(phy_rev, 47) && !ACREV_IS(phy_rev, 51) &&\
    !ACREV_IS(phy_rev, 129) && !ACREV_IS(phy_rev, 130))
...
#define ACMAJORREV_32(phy_rev) FALSE
...
#define SW_ACMINORREV_0(phy_rev) 0

#define SW_ACMINORREV_1(phy_rev) \
    (ACREV_IS(phy_rev, 1) || ACREV_IS(phy_rev, 18))
...
#define SW_ACMINORREV_4(phy_rev) 0

#define SW_ACMINORREV_5(phy_rev) \
    ACREV_IS(phy_rev, 17)

#define SW_ACMINORREV_6(phy_rev) 0
...
#define PHY_LESI_ON(pi) \
    ...
    ACMAJORREV_47(pi->pubpi->phy_rev) || ACMAJORREV_129(pi->pubpi->phy_rev) || \
...
#define ACPHY_RCAL_OFFSET (RADIOID_IS(pi->pubpi->radioid, BCM20693_ID) ? 0x14 : 0x10)
#else
...
#define ACPHY_TBL_ID_WBCAL_PTBL                  42
#define ACPHY_TBL_ID_WBCAL_TXDELAYBUF            43
#define ACPHY_TBL_ID_WBCAL_RXSYNCBUF             44
...
#define ACPHY_TBL_ID_PAPDLUTSELECT3             189
...
#define ACPHY_TBL_ID_RXIQCOMPGAIN0            330
...
#define ACPHY_TBL_ID_RXIQCOMPGAIN1            362
...
#define ACPHY_TBL_ID_RXIQCOMPGAIN2            394
...
#define ACPHY_TBL_ID_RXIQCOMPGAIN3            426
...
#define CHANESTTBL_REV0_DATA_OFFSET         256u
...
#define ACPHY_SPINWAIT_PKTPROC_STATE_L        5000
...
#define RADIO_REG_20708(pi, regnm, core) \
    ((core == 0) ? RF0_20708_##regnm((pi)->pubpi->radiorev) : \
    ((core == 1) ? RF1_20708_##regnm((pi)->pubpi->radiorev) : \
    ((core == 2) ? RF2_20708_##regnm((pi)->pubpi->radiorev) : \
    ((core == 3) ? RF3_20708_##regnm((pi)->pubpi->radiorev) : \
      INVALID_ADDRESS))))

#define RADIO_PLLREG_20708(pi, regnm, pll) \
    ((pll == 0) ? RFP0_20708_##regnm((pi)->pubpi->radiorev) : \
    ((pll == 1) ? RFP1_20708_##regnm((pi)->pubpi->radiorev) : \
      INVALID_ADDRESS))

#define RADIO_ALLREG_20708(pi, regnm)  RFX_20708_##regnm(pi->pubpi->radiorev)
...
#define RADIO_REG_20710(pi, regnm, core) \
    ((core == 0) ? RF0_20710_##regnm((pi)->pubpi->radiorev) : \
    ((core == 1) ? RF1_20710_##regnm((pi)->pubpi->radiorev) : \
      INVALID_ADDRESS))

#define RADIO_PLLREG_20710(pi, regnm, pll) \
    ((pll == 0) ? RFP0_20710_##regnm((pi)->pubpi->radiorev) : \
      INVALID_ADDRESS)

#define RADIO_ALLREG_20710(pi, regnm)  RFX_20710_##regnm(pi->pubpi->radiorev)
...
#define READ_RADIO_REG_20708(pi, regnm, core) \
    _READ_RADIO_REG(pi, RADIO_REG_20708(pi, regnm, core))
#define READ_RADIO_REG_20709(pi, regnm, core) \
    _READ_RADIO_REG(pi, RADIO_REG_20709(pi, regnm, core))
#define READ_RADIO_REG_20710(pi, regnm, core) \
    _READ_RADIO_REG(pi, RADIO_REG_20710(pi, regnm, core))
...
#define READ_RADIO_PLLREG_20708(pi, regnm, pll) \
    _READ_RADIO_REG(pi, RADIO_PLLREG_20708(pi, regnm, pll))

#define WRITE_RADIO_PLLREG_20708(pi, regnm, pll, val) \
    _WRITE_RADIO_REG(pi, RADIO_PLLREG_20708(pi, regnm, pll), val)

#define WRITE_RADIO_ALLREG_20708(pi, regnm, val) \
    _WRITE_RADIO_REG(pi, RADIO_ALLREG_20708(pi, regnm), val)
...
#define READ_RADIO_PLLREG_20710(pi, regnm, pll) \
    _READ_RADIO_REG(pi, RADIO_PLLREG_20710(pi, regnm, pll))

#define WRITE_RADIO_PLLREG_20710(pi, regnm, pll, val) \
    _WRITE_RADIO_REG(pi, RADIO_PLLREG_20710(pi, regnm, pll), val)

#define WRITE_RADIO_ALLREG_20710(pi, regnm, val) \
    _WRITE_RADIO_REG(pi, RADIO_ALLREG_20710(pi, regnm), val)
...
#define READ_RADIO_REGFLD_20708(pi, regpfx, regnm, core, fldname) \
    ((_READ_RADIO_REG(pi, RADIO_REG_20708(pi, regnm, core)) & \
        RF_20708_##regnm##_##fldname##_MASK(pi->pubpi->radiorev)) \
        >> RF_20708_##regnm##_##fldname##_SHIFT(pi->pubpi->radiorev))
...
#define READ_RADIO_REGFLD_20710(pi, regpfx, regnm, core, fldname) \
    ((_READ_RADIO_REG(pi, RADIO_REG_20710(pi, regnm, core)) & \
        RF_20710_##regnm##_##fldname##_MASK(pi->pubpi->radiorev)) \
        >> RF_20710_##regnm##_##fldname##_SHIFT(pi->pubpi->radiorev))

#define READ_RADIO_REGFLD_TINY(pi, regnm, core, fldname) \
    ((RADIOID_IS((pi)->pubpi->radioid, BCM20693_ID)) \
        ? READ_RADIO_REGFLD_20693(pi, regnm, core, fldname) : 0)

#define READ_RADIO_REGFLD_28NM(pi, regpfx, regnm, core, fldname) 0
...
#define READ_RADIO_PLLREGFLD_20708(pi, regnm, pll, fldname) \
    ((_READ_RADIO_REG(pi, RADIO_PLLREG_20708(pi, regnm, pll)) & \
        RF_20708_##regnm##_##fldname##_MASK(pi->pubpi->radiorev)) \
        >> RF_20708_##regnm##_##fldname##_SHIFT(pi->pubpi->radiorev))
...
#define READ_RADIO_PLLREGFLD_20710(pi, regnm, pll, fldname) \
    ((_READ_RADIO_REG(pi, RADIO_PLLREG_20710(pi, regnm, pll)) & \
        RF_20710_##regnm##_##fldname##_MASK(pi->pubpi->radiorev)) \
        >> RF_20710_##regnm##_##fldname##_SHIFT(pi->pubpi->radiorev))
...
#define MOD_RADIO_PLLREG_20708(pi, regnm, pll, fldname, value) \
    _MOD_RADIO_REG(pi, \
        RADIO_PLLREG_20708(pi, regnm, pll), \
        RF_20708_##regnm##_##fldname##_MASK(pi->pubpi->radiorev), \
        ((value) << RF_20708_##regnm##_##fldname##_SHIFT(pi->pubpi->radiorev)))
...
#define MOD_RADIO_PLLREG_20710(pi, regnm, pll, fldname, value) \
    _MOD_RADIO_REG(pi, \
        RADIO_PLLREG_20710(pi, regnm, pll), \
        RF_20710_##regnm##_##fldname##_MASK(pi->pubpi->radiorev), \
        ((value) << RF_20710_##regnm##_##fldname##_SHIFT(pi->pubpi->radiorev)))
...
#define MOD_RADIO_REG_20708(pi, regnm, core, fldname, value) \
    _MOD_RADIO_REG(pi, \
        RADIO_REG_20708(pi, regnm, core), \
        RF_##20708##_##regnm##_##fldname##_MASK(pi->pubpi->radiorev), \
        ((value) << RF_##20708##_##regnm##_##fldname##_SHIFT(pi->pubpi->radiorev)))

#define MOD_RADIO_ALLREG_20708(pi, regnm, fldname, value) \
    _MOD_RADIO_REG(pi, \
        RADIO_ALLREG_20708(pi, regnm), \
        RF_20708_##regnm##_##fldname##_MASK(pi->pubpi->radiorev), \
        ((value) << RF_20708_##regnm##_##fldname##_SHIFT(pi->pubpi->radiorev)))
...
#define MOD_RADIO_REG_20710(pi, regnm, core, fldname, value) \
    _MOD_RADIO_REG(pi, \
        RADIO_REG_20710(pi, regnm, core), \
        RF_##20710##_##regnm##_##fldname##_MASK(pi->pubpi->radiorev), \
        ((value) << RF_##20710##_##regnm##_##fldname##_SHIFT(pi->pubpi->radiorev)))

#define MOD_RADIO_REG_28NM(pi, regpfx, regnm, core, fldname, value) \
    (BCM_REFERENCE(pi), BCM_REFERENCE(value))
...
#define WRITE_RADIO_REG_20708(pi, regnm, core, value) \
    _WRITE_RADIO_REG(pi, RADIO_REG_20708(pi, regnm, core), value)

#define WRITE_RADIO_REG_20709(pi, regnm, core, value) \
    _WRITE_RADIO_REG(pi, RADIO_REG_20709(pi, regnm, core), value)

#define WRITE_RADIO_REG_20710(pi, regnm, core, value) \
    _WRITE_RADIO_REG(pi, RADIO_REG_20710(pi, regnm, core), value)

#define WRITE_RADIO_REG_28NM(pi, regpfx, regnm, core, value) (BCM_REFERENCE(pi))

#define IS43602WLCSP ((CHIPID(pi->sh->chip) == BCM43602_CHIP_ID ||    \
           CHIPID(pi->sh->chip) == BCM43602_CHIP_ID) &&    \
          RADIOREV(pi->pubpi->radiorev) == 13)

#define MOD_AFE_CAL_RFREGS_20708(pi, regnm, core, fldname, rail, iq, value) \
    _MOD_RADIO_REG(pi, \
        RADIO_REG_20708(pi, regnm, core), \
        ((rail == 0 && iq == 0) ? \
        RF_##20708##_##regnm##_##fldname##0_I##_MASK(pi->pubpi->radiorev) : \
        ((rail == 0 && iq == 1) ? \
        RF_##20708##_##regnm##_##fldname##0_Q##_MASK(pi->pubpi->radiorev) : \
        ((rail == 1 && iq == 0) ? \
        RF_##20708##_##regnm##_##fldname##1_I##_MASK(pi->pubpi->radiorev) : \
        ((rail == 1 && iq == 1) ? \
        RF_##20708##_##regnm##_##fldname##1_Q##_MASK(pi->pubpi->radiorev) : \
        INVALID_ADDRESS)))), \
        ((rail == 0 && iq == 0) ? \
        ((value) << RF_##20708##_##regnm##_##fldname##0_I##_SHIFT(pi->pubpi->radiorev)) : \
        ((rail == 0 && iq == 1) ? \
        ((value) << RF_##20708##_##regnm##_##fldname##0_Q##_SHIFT(pi->pubpi->radiorev)) : \
        ((rail == 1 && iq == 0) ? \
        ((value) << RF_##20708##_##regnm##_##fldname##1_I##_SHIFT(pi->pubpi->radiorev)) : \
        ((rail == 1 && iq == 1) ? \
        ((value) << RF_##20708##_##regnm##_##fldname##1_Q##_SHIFT(pi->pubpi->radiorev)) : \
        INVALID_ADDRESS)))))

#define READ_AFE_CAL_RFREGS_20708(pi, regpfx, regnm, core, fldname, rail, iq) \
    ((_READ_RADIO_REG(pi, RADIO_REG_20708(pi, regnm, core)) & \
        ((rail == 0 && iq == 0) ? \
        RF_##20708##_##regnm##_##fldname##0_I##_MASK(pi->pubpi->radiorev) : \
        ((rail == 0 && iq == 1) ? \
        ...
        INVALID_ADDRESS))))) \
        >> ((rail == 0 && iq == 0) ? \
        RF_##20708##_##regnm##_##fldname##0_I##_SHIFT(pi->pubpi->radiorev) : \
        ((rail == 0 && iq == 1) ? \
        RF_##20708##_##regnm##_##fldname##0_Q##_SHIFT(pi->pubpi->radiorev) : \
        ((rail == 1 && iq == 0) ? \
        RF_##20708##_##regnm##_##fldname##1_I##_SHIFT(pi->pubpi->radiorev) : \
        ((rail == 1 && iq == 1) ? \
        RF_##20708##_##regnm##_##fldname##1_Q##_SHIFT(pi->pubpi->radiorev) : \
        INVALID_ADDRESS)))))
 ...
 */
#if (defined(BCMRADIOREV) || defined(BCMRADIOREV20693REV) || \
    defined(BCMRADIOREV2096REV)) && defined(DONGLEBUILD) && !IS_MULTI_REV3(ACCONF, ACCONF2, \
    ACCONF5) && defined(BCMCHIPID)
...
#define RADIO_REG_LIST_EXECUTE(pi, core)                \
    ...
    phy_utils_write_radioreg_array(pi, write_radio_reg_table,    \
        ARRAYSIZE(write_radio_reg_table), core); }
...
#define MOD_RADIO_REG_20708_ENTRY(pi, regnm, core, fldname, value) \
    RADIO_REG_MOD_ENTRY(RADIO_REG_20708(pi, regnm, 0),              \
        RF_##20708##_##regnm##_##fldname##_MASK(pi->pubpi.radiorev), \
        ((value) << RF_##20708##_##regnm##_##fldname##_SHIFT(pi->pubpi.radiorev)))
...
#define MOD_RADIO_REG_20710_ENTRY(pi, regnm, core, fldname, value) \
    RADIO_REG_MOD_ENTRY(RADIO_REG_20710(pi, regnm, 0),        \
        RF_##20710##_##regnm##_##fldname##_MASK(pi->pubpi.radiorev), \
        ((value) << RF_##20710##_##regnm##_##fldname##_SHIFT(pi->pubpi.radiorev)))
...
#define MOD_RADIO_PLLREG_20708_ENTRY(pi, regnm, core, fldname, value) \
    RADIO_REG_MOD_ENTRY(RADIO_PLLREG_20708(pi, regnm, 0),           \
        RF_##20708##_##regnm##_##fldname##_MASK(pi->pubpi.radiorev), \
        ((value) << RF_##20708##_##regnm##_##fldname##_SHIFT(pi->pubpi.radiorev)))
...
#define MOD_RADIO_PLLREG_20710_ENTRY(pi, regnm, core, fldname, value) \
    RADIO_REG_MOD_ENTRY(RADIO_PLLREG_20710(pi, regnm, 0),        \
        RF_##20710##_##regnm##_##fldname##_MASK(pi->pubpi.radiorev), \
        ((value) << RF_##20710##_##regnm##_##fldname##_SHIFT(pi->pubpi.radiorev)))
...
#define WRITE_RADIO_REG_20708_ENTRY(pi, regnm, core, value) \
        RADIO_REG_WRITE_ENTRY(RADIO_REG_20708(pi, regnm, 0), value)
#define WRITE_RADIO_REG_20709_ENTRY(pi, regnm, core, value) \
         RADIO_REG_WRITE_ENTRY(RADIO_REG_20709(pi, regnm, 0), value)
#define WRITE_RADIO_REG_20710_ENTRY(pi, regnm, core, value) \
         RADIO_REG_WRITE_ENTRY(RADIO_REG_20710(pi, regnm, 0), value)
...
#define WRITE_RADIO_REG_20708_ENTRY(pi, regnm, core, value) \
    WRITE_RADIO_REG_20708(pi, regnm, core, value);
#define WRITE_RADIO_REG_20709_ENTRY(pi, regnm, core, value) \
    WRITE_RADIO_REG_20709(pi, regnm, core, value);
#define WRITE_RADIO_REG_20710_ENTRY(pi, regnm, core, value) \
    WRITE_RADIO_REG_20710(pi, regnm, core, value);
#define MOD_RADIO_REG_20693_ENTRY(pi, regnm, core, fldname, value)    \
...
#define MOD_RADIO_REG_20708_ENTRY(pi, regnm, core, fldname, value) \
    MOD_RADIO_REG_20708(pi, regnm, core, fldname, value);
#define MOD_RADIO_PLLREG_20708_ENTRY(pi, regnm, core, fldname, value) \
    MOD_RADIO_PLLREG_20708(pi, regnm, core, fldname, value);
#define MOD_RADIO_REG_20709_ENTRY(pi, regnm, core, fldname, value) \
    MOD_RADIO_REG_20709(pi, regnm, core, fldname, value);
#define MOD_RADIO_PLLREG_20709_ENTRY(pi, regnm, core, fldname, value) \
    MOD_RADIO_PLLREG_20709(pi, regnm, core, fldname, value);
#define MOD_RADIO_REG_20710_ENTRY(pi, regnm, core, fldname, value) \
    MOD_RADIO_REG_20710(pi, regnm, core, fldname, value);
#define MOD_RADIO_PLLREG_20710_ENTRY(pi, regnm, core, fldname, value) \
    MOD_RADIO_PLLREG_20710(pi, regnm, core, fldname, value);
...
/* Detector 1 : W1 - ADC */
#define HWACI_DET_TH1_0_2G_REV129 100
#define HWACI_DET_TH1_1_2G_REV129 0
#define HWACI_DET_TH1_2_2G_REV129 -200
#define HWACI_DET_TH1_0_5G_REV129 120
#define HWACI_DET_TH1_1_5G_REV129 0
#define HWACI_DET_TH1_2_5G_REV129 -200

/* Detector 2 : W1 - ADC */
#define HWACI_DET_TH2_0_2G_REV129 1
#define HWACI_DET_TH2_1_2G_REV129 0
#define HWACI_DET_TH2_2_2G_REV129 0
#define HWACI_DET_TH2_0_5G_REV129 1
#define HWACI_DET_TH2_1_5G_REV129 0
#define HWACI_DET_TH2_2_5G_REV129 0

#define HWACI_A_SHIFT2_2G_REV129  0
#define HWACI_B_SHIFT2_2G_REV129  0x100
#define HWACI_A_SHIFT2_5G_REV129  0
#define HWACI_B_SHIFT2_5G_REV129  0x100

/* Detector 1 : W1 - ADC */
#define HWACI_DET_TH1_0_2G_REV130 100
#define HWACI_DET_TH1_1_2G_REV130 0
#define HWACI_DET_TH1_2_2G_REV130 -200
#define HWACI_DET_TH1_0_5G_REV130 120
#define HWACI_DET_TH1_1_5G_REV130 0
#define HWACI_DET_TH1_2_5G_REV130 -200

/* Detector 2 : W1 - ADC */
#define HWACI_DET_TH2_0_2G_REV130 1
#define HWACI_DET_TH2_1_2G_REV130 0
#define HWACI_DET_TH2_2_2G_REV130 0
#define HWACI_DET_TH2_0_5G_REV130 1
#define HWACI_DET_TH2_1_5G_REV130 0
#define HWACI_DET_TH2_2_5G_REV130 0

#define HWACI_A_SHIFT2_2G_REV130  0
#define HWACI_B_SHIFT2_2G_REV130  0x100
#define HWACI_A_SHIFT2_5G_REV130  0
#define HWACI_B_SHIFT2_5G_REV130  0x100
...
typedef struct {
    uint8 mode;
    uint8 femctrl[PHY_CORE_MAX];

    /* If loopback core is different from TX core */
    uint8 lp_core[PHY_CORE_MAX];
    uint8 femctrl_lp[PHY_CORE_MAX];
} acphy_papd_swctrl_band_t;

/* 3 = 2g,5g,6g */
#define PAPD_SWCTRL_NUM_BANDS 3
typedef struct {
    uint8 valid;
    acphy_papd_swctrl_band_t band[PAPD_SWCTRL_NUM_BANDS];
} acphy_papd_swctrl_t;
...
typedef struct {
    ...
    acphy_fem_rxgains_t femrx_6g[PHY_CORE_MAX][NUM_6G_SUBBANDS];
    ...
    acphy_papd_swctrl_t *papd_swctrl;
...
struct phy_info_acphy
{
    ...
    phy_ac_txss_info_t    *txssi;
    phy_ac_smc_info_t    *smci;
    phy_ac_wareng_info_t    *warengi;
...
#define CALLED_ON_SUBBAND_CHG    8 // bit0 << 3
...
#define CCT_SUBBAND_CHG(x)    (mboolisset((x)->CCTrace, CALLED_ON_SUBBAND_CHG))

/* Chanspec Call Trace - Clear All */
#define CCT_CLR(x)    (mboolclr((x)->CCTrace, CALLED_ON_INIT | CALLED_ON_BW_CHG |\
            CALLED_ON_BAND_CHG | CALLED_ON_SUBBAND_CHG))
