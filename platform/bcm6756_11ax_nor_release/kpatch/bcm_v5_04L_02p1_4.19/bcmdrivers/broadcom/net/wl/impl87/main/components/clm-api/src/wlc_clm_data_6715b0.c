 ...
 * ClmCompiler flags: --clmapi_include_dir Z:\home\zhongbo\tiaoshi\dongle\UGW_main\bsp\kernel\bcm_v5_04L_02p1_4.19\bcmdrivers\broadcom\net\wl\impl87\main\components\clm-api\include --bcmwifi_include_dir Z:\home\zhongbo\tiaoshi\dongle\UGW_main\bsp\kernel\bcm_v5_04L_02p1_4.19\bcmdrivers\broadcom\net\wl\impl87\main\src\shared\bcmwifi\include --txbf --full_set --region "#a/0 CN/947 US/2" --1024_qam 6750_6715\US_30.xml 6750_6715\wlc_clm_data_6715b0.c
 *
...
#if (27 > CLM_FORMAT_VERSION_MAJOR) || ((27 == CLM_FORMAT_VERSION_MAJOR) && (1 > CLM_FORMAT_VERSION_MINOR))
    #error CLM data format version mismatch between wlc_clm_data_6715b0.c (this file) and wlc_clm_data.h (see CLM_FORMAT_VERSION_MAJOR and CLM_FORMAT_VERSION_MINOR macros in wlc_clm_data.h). This BLOB has format 27.1
#endif
...
static const struct clm_channel_range channel_ranges_5g_20m[] = {
    { 36,  48}, { 36,  64}, { 36, 140}, { 36, 177}, { 52, 140}, {149, 165},
};

/** Indices for 5G 20M channel ranges */
enum range_5g_20m {
    RANGE_5G_20M_36_48      = 0,   RANGE_5G_20M_36_64      = 1,   RANGE_5G_20M_36_140     = 2,   RANGE_5G_20M_36_177     = 3,
    RANGE_5G_20M_52_140     = 4,   RANGE_5G_20M_149_165    = 5,
};

/** 5G 40M channel ranges used in locales and restricted sets */
static const struct clm_channel_range channel_ranges_5g_40m[] = {
    { 38,  62}, { 38, 175}, {151, 159},
};

/** Indices for 5G 40M channel ranges */
enum range_5g_40m {
    RANGE_5G_40M_38_62      = 0,   RANGE_5G_40M_38_175     = 1,   RANGE_5G_40M_151_159    = 2,
};

/** 5G 80M channel ranges used in locales and restricted sets */
static const struct clm_channel_range channel_ranges_5g_80m[] = {
    { 42,  42}, { 42,  58}, { 42, 171}, { 58,  58}, {106, 106}, {122, 138}, {122, 171}, {155, 155},
    {155, 171}, { 42, 106}, {106,  42}, { 58, 106}, {106,  58}, { 42, 122}, {122,  42}, { 58, 122},
    {122,  58}, { 42, 138}, {138,  42}, { 58, 138}, {138,  58}, {106, 138}, {138, 106}, { 42, 155},
    {155,  42}, { 58, 155}, {155,  58}, {106, 155}, {155, 106}, {122, 155}, {155, 122}, {138, 155},
    {155, 138},
};

/** Indices for 5G 80M channel ranges */
enum range_5g_80m {
    RANGE_5G_80M_42_42      = 0,   RANGE_5G_80M_42_58      = 1,   RANGE_5G_80M_42_171     = 2,   RANGE_5G_80M_58_58      = 3,
    RANGE_5G_80M_106_106    = 4,   RANGE_5G_80M_122_138    = 5,   RANGE_5G_80M_122_171    = 6,   RANGE_5G_80M_155_155    = 7,
    RANGE_5G_80M_155_171    = 8,   CHANNEL_5G_80M_42p106L  = 9,   CHANNEL_5G_80M_42p106U  = 10,  CHANNEL_5G_80M_58p106L  = 11,
    CHANNEL_5G_80M_58p106U  = 12,  CHANNEL_5G_80M_42p122L  = 13,  CHANNEL_5G_80M_42p122U  = 14,  CHANNEL_5G_80M_58p122L  = 15,
    CHANNEL_5G_80M_58p122U  = 16,  CHANNEL_5G_80M_42p138L  = 17,  CHANNEL_5G_80M_42p138U  = 18,  CHANNEL_5G_80M_58p138L  = 19,
    CHANNEL_5G_80M_58p138U  = 20,  CHANNEL_5G_80M_106p138L = 21,  CHANNEL_5G_80M_106p138U = 22,  CHANNEL_5G_80M_42p155L  = 23,
    CHANNEL_5G_80M_42p155U  = 24,  CHANNEL_5G_80M_58p155L  = 25,  CHANNEL_5G_80M_58p155U  = 26,  CHANNEL_5G_80M_106p155L = 27,
    CHANNEL_5G_80M_106p155U = 28,  CHANNEL_5G_80M_122p155L = 29,  CHANNEL_5G_80M_122p155U = 30,  CHANNEL_5G_80M_138p155L = 31,
    CHANNEL_5G_80M_138p155U = 32,
};

/** 5G 160M channel ranges used in locales and restricted sets */
static const struct clm_channel_range channel_ranges_5g_160m[] = {
    { 50,  50}, { 50, 163}, {114, 163},
};

/** Indices for 5G 160M channel ranges */
enum range_5g_160m {
    RANGE_5G_160M_50_50     = 0,   RANGE_5G_160M_50_163    = 1,   RANGE_5G_160M_114_163   = 2,
};
...
static const unsigned char locale_channels[] = {
    ...
    /* Channel set 1 */ 1, RANGE_2G_20M_1_13,
    /* Channel set 2 */ 1, RANGE_2G_20M_1_14,
    /* Channel set 3 */ 2, RANGE_5G_20M_36_64, RANGE_5G_20M_149_165,
    /* Channel set 4 */ 2, RANGE_5G_20M_36_140, RANGE_5G_20M_149_165,
    /* Channel set 5 */ 1, RANGE_5G_20M_36_177,
    /* Channel set 6 */ 2, RANGE_6G_20M_1_233, RANGE_6G_20M_2_2,
};

/** Channel set indices */
enum channel_set {
    CHANNEL_SET_0   = 0,   CHANNEL_SET_1   = 1,   CHANNEL_SET_2   = 2,   CHANNEL_SET_3   = 3,
    CHANNEL_SET_4   = 4,   CHANNEL_SET_5   = 5,   CHANNEL_SET_6   = 6,
};
...
enum locale_5g_idx {
    ...
    LOCALE_5G_IDX_1DebugA             = 0,   LOCALE_5G_IDX_5CN947              = 1,   LOCALE_5G_IDX_5US2                = 2,
};
...
enum locale_2g_idx {
    ...
    LOCALE_2G_IDX_CN947               = 0,   LOCALE_2G_IDX_DebugA              = 1,   LOCALE_2G_IDX_US2                 = 2,
};
...
enum locale_2g_ht_idx {
    ...
    LOCALE_2G_HT_IDX_CN947n           = 0,   LOCALE_2G_HT_IDX_DebugAn__DebugA_3n = 1, LOCALE_2G_HT_IDX_US2n             = 2,
};
...
enum locale_5g_ht_idx {
    ...
    LOCALE_5G_HT_IDX_1DebugAn         = 0,   LOCALE_5G_HT_IDX_5CN947n          = 1,   LOCALE_5G_HT_IDX_5US2n            = 2,
};
...
static const unsigned char locales_5g_base[] = {
    ...
    /* Locale 1DebugA */
    CHANNEL_SET_5, 0, /* Locale channels (20M), locale flags */
    ...
    120, RANGE_5G_20M_36_64,   RATE_SET_5G_20M_1,       /*  30.00dBm,   36-64, OFDM6-54 */
    ...
    RESTRICTED_SET_NONE, /* Restricted channels */
        CLM_DATA_FLAG_WIDTH_20 | CLM_DATA_FLAG_MEAS_EIRP,
        2, /* 2 regulatory channel limit element(s) */
    30, RANGE_5G_20M_36_64,   /* 30.0dBm, 36-48 */
...
static const unsigned char locales_6g_base[] = {
    ...
    CHANNEL_SET_6, CLM_DATA_FLAG_PSD_LIMITS, /* Locale channels (20M), locale flags */
    RESTRICTED_SET_NONE, /* Restricted channels */
...
/* No 6GHz, 320MHz subchannel rules */

/** CC/rev indices */
enum ccrevs {
    CCREV__a_0,    /* #a/0 */      CCREV_CN_947,  /* CN/947 */    CCREV_US_2,    /* US/2 */
};
...
/** Region definitions */
static const clm_country_rev_definition_cd11_t country_definitions[] = {
    ...
    REGION("CN",  947,   CN947,  5CN947,           CN947n,          5CN947n,    NONE,             NONE, SCR_1,    CLM_DATA_FLAG_REG_TXBF), /* CN/947 */
...
/** BLOB ID */
static const char user_string[] = "2022-11-14 11:00:26\0<TIMESTAMP>";
