...
typedef int     (*parameter_notifyget_handler_pt)(cwmp_t * cwmp, const char * param_name, const char ** value, pool_t * pool);

typedef int     (*parameter_notifyset_handler_pt)(cwmp_t * cwmp, const char * param_name, const char * value, int length, callback_register_func_t callback_reg);
