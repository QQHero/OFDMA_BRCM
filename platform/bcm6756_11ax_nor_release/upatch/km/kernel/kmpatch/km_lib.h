...
/* 事件通知声明 */
extern int eventscenter_broadcast_send_msg(KM_NETLINK_MSG_TYPE msg_type, cJSON *msg, char *type);
extern int eventscenter_unicast_send_msg(KM_NETLINK_MSG_TYPE msg_type, cJSON *msg, unsigned pid);
