#ifndef __PKT_RUNNER_L2_UCAST_H_INCLUDED__
#define __PKT_RUNNER_L2_UCAST_H_INCLUDED__
...
int runnerL2Ucast_refresh_pathstat(int flowIdx, uint32_t *pktsCnt_p, uint32_t *octetsCnt_p);

int __init runnerL2Ucast_construct(void *, void *);
void __ref runnerL2Ucast_destruct(void);

#endif  /* defined(__PKT_RUNNER_L2_UCAST_H_INCLUDED__) */
