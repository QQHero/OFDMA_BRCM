...
def main(log_file, board_serial_number=''):
    ...
    log_file_header( log_file, "rogue_cal_log" )
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    # starting calibration
    echo( "$$$ rogue threshold validation starts  $$$############### ", 1 )

    #Run esc calibration
    send2shell("laser msg --set ae 2 0017")
    ...
    echo( "$$$  rogue threshold validation complete  $$$###############", 1 )
