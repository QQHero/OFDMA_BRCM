...
#if defined (CONFIG_BCM96858)  // EPON_GBOX is in MISC_3 in 6858, in MISC_0 in others
#define MISC_GBOX 3
#else
#define MISC_GBOX 0
#endif
...
static void serdes_init (pon_params_t *pon_params)
{
    ...
    RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_POR_H_RSTB,  0);


    // WAN_TOP_SCRATCH   //
#if defined (CONFIG_BCM96858) || defined (CONFIG_BCM96856) ||  defined (CONFIG_BCM96855) || defined(CONFIG_BCM963158)
    wr_data = 0x01234567;
    ...
    RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_POR_H_RSTB,        1); // release PMD reset
    RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_CORE_1_DP_H_RSTB,  1); // release DP reset
    RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_CORE_0_DP_H_RSTB,  1); // release DP reset
    RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_LN_H_RSTB,         1); // release Lane reset
    RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_LN_DP_H_RSTB,      1); // release Lane reset
    RU_REG_READ   (0, MISC, 2, rd_data);
    __logDebug("\n WAN_TOP_MISC_2 = 0x%08x", rd_data);

    /* MISC_1 = 0 */
    RU_FIELD_WRITE(0, MISC, 1, CR_XGWAN_TOP_WAN_MISC_PMD_CORE_1_MODE,  0);
    RU_FIELD_WRITE(0, MISC, 1, CR_XGWAN_TOP_WAN_MISC_PMD_CORE_0_MODE,  0);
    ...
    RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_LASER_OE,  0); //  Disable Laser(BE) during init
    ...
    if (std == STD_E)
    {
        ...
        RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_RX_OSR_MODE,  rx_osr_mode); // release PMD reset
        RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_TX_OSR_MODE,  tx_osr_mode); // release PMD reset
        RU_REG_READ(0, MISC, 2, rd_data);
        __logDebug("\n WAN_TOP_MISC_2 = 0x%08x", rd_data);

        if ((mode == EPON_2_2) || (mode == AE_2_2))
            RU_FIELD_WRITE(0, MISC, MISC_GBOX, CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_AE_2P5_FULL_RATE_MODE,  1);  //1: Explicit 2.5G Full Rate Serdes Mode.  0: all other modes.

        if ((mode == EPON_2_1) || (mode == AE_2_1))
            RU_FIELD_WRITE(0, MISC, MISC_GBOX, CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_PON_RX_WIDTH_MODE, 1);
        else
            RU_FIELD_WRITE(0, MISC, MISC_GBOX, CR_XGWAN_TOP_WAN_MISC_EPON_GBOX_PON_RX_WIDTH_MODE, 0);

#if (defined (CONFIG_BCM96858) || defined(CONFIG_BCM96846) || defined(CONFIG_BCM96856) || defined(CONFIG_BCM96855) || defined(CONFIG_BCM96878))
        RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_LASER_MODE,                   0); // laser_mode =0= EPON
        RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT,         0); // wan_interface_select = 0= EPON
#if (defined (CONFIG_BCM96858))
        if ((mode == EPON_10_10) || (mode == AE_10_10))
        {
            RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_LASER_MODE,               1); // laser_mode= 1 = 10G-EPON
            RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT,     1);  // wan_interface_select = 1 = 10G-EPON
        }
#elif (defined(CONFIG_BCM96856) || defined(CONFIG_BCM96855))
        RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT_HS,      0); // wan_interface_select_hs = 0= EPON
        if ((mode == EPON_10_10) || (mode == AE_10_10) || (mode == AE_5_5) || (mode == AE_2_2_R))
        {
            RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_LASER_MODE,               1); // laser_mode= 1 = 10G-EPON
            RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT_HS,  1); // wan_interface_select_hs = 1= 10G-EPON
        }
#endif
        ...
        if (mode == EPON_10_10)
        {
            RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_LASER_MODE,  1); 
            RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT,  6);
        }
        else if (mode == AE_10_10)
        {
            RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_LASER_MODE,  1);         
            RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT,  3);
        }
        else if (mode == EPON_10_1)
        {
            RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_LASER_MODE,  0);        
            RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT,  5);
        }
        else if (mode == AE_10_1)
        {
            RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_LASER_MODE,  0);  
            RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT,  1);
        }
        else if ((mode == EPON_2_2) || (mode == AE_2_2))
            RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT,  2);
...
// EPON_10G_GEARBOX
#if defined (CONFIG_BCM96858) || defined(CONFIG_BCM96856) || defined(CONFIG_BCM96855) || defined(CONFIG_BCM963158)
    if ((mode == EPON_10_10) || (mode == EPON_10_1) || (mode == AE_10_10) || (mode == AE_10_1) || (mode == AE_5_5) || (mode == AE_2_2_R))
    {
        RU_FIELD_WRITE(0, TEN_G_GEARBOX, GEARBOX, CFG_SGB_PON_10G_EPON_TX_FIFO_OFF   , 0);
        RU_FIELD_WRITE(0, TEN_G_GEARBOX, GEARBOX, CFG_SGB_PON_10G_EPON_TX_FIFO_OFF_LD, 0);
        RU_FIELD_WRITE(0, TEN_G_GEARBOX, GEARBOX, CFG_SGB_PON_10G_EPON_TX2RX_LOOP_EN , 0);
        RU_FIELD_WRITE(0, TEN_G_GEARBOX, GEARBOX, CFG_SGB_PON_10G_EPON_RX_DATA_END   , 0);
        RU_FIELD_WRITE(0, TEN_G_GEARBOX, GEARBOX, CFG_SGB_PON_10G_EPON_CLK_EN        , 1);
        RU_FIELD_WRITE(0, TEN_G_GEARBOX, GEARBOX, CFG_SGB_PON_10G_EPON_TX_GBOX_RSTN  , 1);
        RU_FIELD_WRITE(0, TEN_G_GEARBOX, GEARBOX, CFG_SGB_PON_10G_EPON_RX_GBOX_RSTN  , 1);
        RU_FIELD_WRITE(0, TEN_G_GEARBOX, GEARBOX, CFG_SGB_PON_10G_EPON_TX_CGEN_RSTN  , 1);
        RU_FIELD_WRITE(0, TEN_G_GEARBOX, GEARBOX, CFG_SGB_PON_10G_EPON_RX_CGEN_RSTN  , 1);

        RU_REG_READ(0, TEN_G_GEARBOX, GEARBOX, rd_data);
        __logDebug("\n EPON_10G_GEARBOX = 0x%08x", rd_data);
    }
#endif

    /* OSR Gearbox configuration */
    RU_FIELD_WRITE(0, TOP_OSR, CONTROL, CR_WAN_TOP_WAN_MISC_SERDES_OVERSAMPLE_CTRL_TXLBE_SER_ORDER      , 0);
    RU_FIELD_WRITE(0, TOP_OSR, CONTROL, CR_WAN_TOP_WAN_MISC_SERDES_OVERSAMPLE_CTRL_TXLBE_SER_INIT_VAL   , 0);
    RU_FIELD_WRITE(0, TOP_OSR, CONTROL, CR_WAN_TOP_WAN_MISC_SERDES_OVERSAMPLE_CTRL_TXLBE_SER_EN         , 0);
    RU_FIELD_WRITE(0, TOP_OSR, CONTROL, CR_WAN_TOP_WAN_MISC_SERDES_OVERSAMPLE_CTRL_TXFIFO_RD_LEGACY_MODE, 0);
    RU_FIELD_WRITE(0, TOP_OSR, CONTROL, CR_WAN_TOP_WAN_MISC_SERDES_OVERSAMPLE_CTRL_CFG_GPON_RX_CLK      , 2);
...
// ##########################################################
    ...
    //  update PLL Rz settings for all IEEE modes
    ...
    if ((pll_refclk == LCREF) && ((mode == EPON_10_10) || (mode == EPON_10_1) || 
        (mode == AE_10_10) || (mode == AE_10_1) || (mode == AE_5_5) || (mode == AE_2_2_R)))            // 10G mode & PLL ref.clk=50MHz
    {
#if defined (CONFIG_BCM96858) || defined (CONFIG_BCM963158) || defined (CONFIG_BCM96856) || defined (CONFIG_BCM96855)
    ...
    if ((mode == EPON_10_10) || (mode == EPON_10_1) || (mode == AE_10_1) || (mode == AE_10_10) || (mode == AE_5_5) || (mode == AE_2_2_R))
    ...
    RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_LASER_OE,  1);
    RU_REG_READ   (0, MISC, 3, rd_data);
    __logDebug("\n WAN_TOP_MISC_3 = 0x%08x", rd_data);
    rd_serdes = readPONSerdesReg(0x0800, 0xd128);
    if ( (rd_serdes & 0x300) != 0x100 )
        __logError("\n Unexpected error.  expected PLL_Lock==1, PLL_Low==0, but 0xd128-->0x%x\n", rd_serdes);
...
void pon_drv_epon_init(serdes_wan_type_t wan_type, int pll50mhz)
{
    ...
    switch (wan_type)
    {
        ...
        case SERDES_WAN_TYPE_AE_2_5G_R:
            __logInfo("\n\nserdes initialization: AE SYM(2G_2G) Base R Start\n");
            if (!pll50mhz)
            {
                AE_2_2_R_params.refclk = PADREF;  // PADREF = 156.25MHz refclk
            }
        
            pon_params = & AE_2_2_R_params;
            break;

        case SERDES_WAN_TYPE_AE_5G:
            __logInfo("\n\nserdes initialization: AE SYM(5G_5G) Base R Start\n");
            if (!pll50mhz)
            {
                AE_5_5_params.refclk = PADREF;  // PADREF = 156.25MHz refclk
            }

            pon_params = & AE_5_5_params;
            break;
