...
static int bcm_misc_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        misc_misc_3 misc_3 = { .cr_xgwan_top_wan_misc_epon_tx_fifo_off_hi=parm[1].value.unumber, .cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode=parm[2].value.unumber, .cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode=parm[3].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_epon_debug_sel=parm[4].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel=parm[5].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_ntr_sync_period_sel=parm[6].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_laser_oe=parm[7].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select=parm[8].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_laser_mode=parm[9].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_laser_invert=parm[10].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_mem_reb=parm[11].value.unumber};
...
int bcm_misc_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_misc_misc_3:
    {
        ...
        bdmf_session_print(session, "cr_xgwan_top_wan_misc_epon_tx_fifo_off_hi = %u (0x%x)\n", misc_3.cr_xgwan_top_wan_misc_epon_tx_fifo_off_hi, misc_3.cr_xgwan_top_wan_misc_epon_tx_fifo_off_hi);
        bdmf_session_print(session, "cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode = %u (0x%x)\n", misc_3.cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode, misc_3.cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode);
        bdmf_session_print(session, "cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode = %u (0x%x)\n", misc_3.cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode, misc_3.cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode);
...
static int bcm_misc_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        misc_misc_3 misc_3 = {.cr_xgwan_top_wan_misc_epon_tx_fifo_off_hi=gtmv(m, 3), .cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode=gtmv(m, 1), .cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode=gtmv(m, 1), .cr_xgwan_top_wan_misc_wan_cfg_epon_debug_sel=gtmv(m, 8), .cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel=gtmv(m, 4), .cr_xgwan_top_wan_misc_wan_cfg_ntr_sync_period_sel=gtmv(m, 4), .cr_xgwan_top_wan_misc_wan_cfg_laser_oe=gtmv(m, 1), .cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select=gtmv(m, 2), .cr_xgwan_top_wan_misc_wan_cfg_laser_mode=gtmv(m, 3), .cr_xgwan_top_wan_misc_wan_cfg_laser_invert=gtmv(m, 1), .cr_xgwan_top_wan_misc_wan_cfg_mem_reb=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_misc_misc_3_set( %u %u %u %u %u %u %u %u %u %u %u)\n", misc_3.cr_xgwan_top_wan_misc_epon_tx_fifo_off_hi, misc_3.cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode, misc_3.cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode, misc_3.cr_xgwan_top_wan_misc_wan_cfg_epon_debug_sel, misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel, misc_3.cr_xgwan_top_wan_misc_wan_cfg_ntr_sync_period_sel, misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_oe, misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select, misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_mode, misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_invert, misc_3.cr_xgwan_top_wan_misc_wan_cfg_mem_reb);
        ...
        if(err || misc_3.cr_xgwan_top_wan_misc_epon_tx_fifo_off_hi!=gtmv(m, 3) || misc_3.cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode!=gtmv(m, 1) || misc_3.cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode!=gtmv(m, 1) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_epon_debug_sel!=gtmv(m, 8) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel!=gtmv(m, 4) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_ntr_sync_period_sel!=gtmv(m, 4) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_oe!=gtmv(m, 1) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select!=gtmv(m, 2) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_mode!=gtmv(m, 3) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_invert!=gtmv(m, 1) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_mem_reb!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    return err;
}
...
bdmfmon_handle_t ag_drv_misc_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_misc_3[]={
            BDMFMON_MAKE_PARM("cr_xgwan_top_wan_misc_epon_tx_fifo_off_hi", "cr_xgwan_top_wan_misc_epon_tx_fifo_off_hi", BDMFMON_PARM_NUMBER, 0),
