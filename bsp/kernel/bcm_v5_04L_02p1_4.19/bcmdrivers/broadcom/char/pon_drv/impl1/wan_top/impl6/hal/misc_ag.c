...
bdmf_error_t ag_drv_misc_misc_0_set(const misc_misc_0 *misc_0)
{
    ...
    if((misc_0->cr_xgwan_top_wan_misc_onu2g_pmd_status_sel >= _1BITS_MAX_VAL_) ||
       ...
       (misc_0->cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode >= _1BITS_MAX_VAL_))
    {
...
#ifdef VALIDATE_PARMS
    if(!cr_xgwan_top_wan_misc_pmd_core_0_mode || !cr_xgwan_top_wan_misc_pmd_core_1_mode)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
...
bdmf_error_t ag_drv_misc_misc_2_set(const misc_misc_2 *misc_2)
{
    ...
    if((misc_2->cr_xgwan_top_wan_misc_pmd_rx_mode >= _1BITS_MAX_VAL_) ||
...
bdmf_error_t ag_drv_misc_misc_3_set(const misc_misc_3 *misc_3)
{
    ...
    if((misc_3->cr_xgwan_top_wan_misc_wan_cfg_mem_reb >= _1BITS_MAX_VAL_) ||
       ...
       (misc_3->cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select_hs >= _1BITS_MAX_VAL_) ||
       ...
       (misc_3->cr_xgwan_top_wan_misc_epon_power_zone_sel >= _1BITS_MAX_VAL_))
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_RANGE), BDMF_ERR_RANGE);
        return BDMF_ERR_RANGE;
    }
    ...
    reg_3 = RU_FIELD_SET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT_HS, reg_3, misc_3->cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select_hs);
    ...
    reg_3 = RU_FIELD_SET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_EPON_DEBUG_SEL, reg_3, misc_3->cr_xgwan_top_wan_misc_epon_debug_sel);
    reg_3 = RU_FIELD_SET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF, reg_3, misc_3->cr_xgwan_top_wan_misc_epon_tx_fifo_off);
    reg_3 = RU_FIELD_SET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_EPON_POWER_ZONE_SEL, reg_3, misc_3->cr_xgwan_top_wan_misc_epon_power_zone_sel);
...
bdmf_error_t ag_drv_misc_misc_3_get(misc_misc_3 *misc_3)
{
    ...
    misc_3->cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select_hs = RU_FIELD_GET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT_HS, reg_3);
    ...
    misc_3->cr_xgwan_top_wan_misc_epon_debug_sel = RU_FIELD_GET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_EPON_DEBUG_SEL, reg_3);
    misc_3->cr_xgwan_top_wan_misc_epon_tx_fifo_off = RU_FIELD_GET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_EPON_TX_FIFO_OFF, reg_3);
    misc_3->cr_xgwan_top_wan_misc_epon_power_zone_sel = RU_FIELD_GET(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_EPON_POWER_ZONE_SEL, reg_3);
...
static int bcm_misc_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        misc_misc_0 misc_0 = { .cr_xgwan_top_wan_misc_onu2g_pmd_status_sel=parm[1].value.unumber, .cr_xgwan_top_wan_misc_refin_en=parm[2].value.unumber, .cr_xgwan_top_wan_misc_refout_en=parm[3].value.unumber, .cr_xgwan_top_wan_misc_mdio_mode=parm[4].value.unumber, .cr_xgwan_top_wan_misc_mdio_fast_mode=parm[5].value.unumber, .cr_xgwan_top_wan_misc_epon_tx_fifo_off_ld=parm[6].value.unumber, .cr_xgwan_top_wan_misc_onu2g_phya=parm[7].value.unumber, .cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode=parm[8].value.unumber, .cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode=parm[9].value.unumber, .cr_xgwan_top_wan_misc_pmd_lane_mode=parm[10].value.unumber};
    ...
    {
        misc_misc_2 misc_2 = { .cr_xgwan_top_wan_misc_pmd_rx_mode=parm[1].value.unumber, .cr_xgwan_top_wan_misc_pmd_ln_dp_h_rstb=parm[2].value.unumber, .cr_xgwan_top_wan_misc_pmd_ln_h_rstb=parm[3].value.unumber, .cr_xgwan_top_wan_misc_pmd_core_0_dp_h_rstb=parm[4].value.unumber, .cr_xgwan_top_wan_misc_pmd_core_1_dp_h_rstb=parm[5].value.unumber, .cr_xgwan_top_wan_misc_pmd_por_h_rstb=parm[6].value.unumber, .cr_xgwan_top_wan_misc_pmd_ext_los=parm[7].value.unumber, .cr_xgwan_top_wan_misc_pmd_ln_tx_h_pwrdn=parm[8].value.unumber, .cr_xgwan_top_wan_misc_pmd_ln_rx_h_pwrdn=parm[9].value.unumber, .cr_xgwan_top_wan_misc_pmd_tx_disable=parm[10].value.unumber, .cr_xgwan_top_wan_misc_pmd_tx_osr_mode=parm[11].value.unumber, .cr_xgwan_top_wan_misc_pmd_tx_mode=parm[12].value.unumber, .cr_xgwan_top_wan_misc_pmd_rx_osr_mode=parm[13].value.unumber, .cfgactiveethernet2p5=parm[14].value.unumber, .cfgngpontxclk=parm[15].value.unumber, .cfgngponrxclk=parm[16].value.unumber, .cfg_apm_mux_sel_0=parm[17].value.unumber, .cfg_apm_mux_sel_1=parm[18].value.unumber};
        err = ag_drv_misc_misc_2_set(&misc_2);
        break;
    }
    case cli_misc_misc_3:
    {
        misc_misc_3 misc_3 = { .cr_xgwan_top_wan_misc_wan_cfg_mem_reb=parm[1].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_laser_invert=parm[2].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_laser_mode=parm[3].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select_hs=parm[4].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select=parm[5].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_laser_oe=parm[6].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_ntr_sync_period_sel=parm[7].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel=parm[8].value.unumber, .cr_xgwan_top_wan_misc_epon_debug_sel=parm[9].value.unumber, .cr_xgwan_top_wan_misc_epon_tx_fifo_off=parm[10].value.unumber, .cr_xgwan_top_wan_misc_epon_power_zone_sel=parm[11].value.unumber};
...
int bcm_misc_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_misc_misc_1:
    {
        ...
        err = ag_drv_misc_misc_1_get(&cr_xgwan_top_wan_misc_pmd_core_0_mode, &cr_xgwan_top_wan_misc_pmd_core_1_mode);
    ...
    case cli_misc_misc_3:
    {
        ...
        bdmf_session_print(session, "cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select_hs = %u (0x%x)\n", misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select_hs, misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select_hs);
        ...
        bdmf_session_print(session, "cr_xgwan_top_wan_misc_epon_debug_sel = %u (0x%x)\n", misc_3.cr_xgwan_top_wan_misc_epon_debug_sel, misc_3.cr_xgwan_top_wan_misc_epon_debug_sel);
        ...
        bdmf_session_print(session, "cr_xgwan_top_wan_misc_epon_power_zone_sel = %u (0x%x)\n", misc_3.cr_xgwan_top_wan_misc_epon_power_zone_sel, misc_3.cr_xgwan_top_wan_misc_epon_power_zone_sel);
        break;
    }
    default:
        err = BDMF_ERR_NOT_SUPPORTED;
...
static int bcm_misc_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        misc_misc_0 misc_0 = {.cr_xgwan_top_wan_misc_onu2g_pmd_status_sel=gtmv(m, 1), .cr_xgwan_top_wan_misc_refin_en=gtmv(m, 1), .cr_xgwan_top_wan_misc_refout_en=gtmv(m, 1), .cr_xgwan_top_wan_misc_mdio_mode=gtmv(m, 1), .cr_xgwan_top_wan_misc_mdio_fast_mode=gtmv(m, 1), .cr_xgwan_top_wan_misc_epon_tx_fifo_off_ld=gtmv(m, 1), .cr_xgwan_top_wan_misc_onu2g_phya=gtmv(m, 5), .cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode=gtmv(m, 1), .cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode=gtmv(m, 1), .cr_xgwan_top_wan_misc_pmd_lane_mode=gtmv(m, 16)};
        if(!err) bdmf_session_print(session, "ag_drv_misc_misc_0_set( %u %u %u %u %u %u %u %u %u %u)\n", misc_0.cr_xgwan_top_wan_misc_onu2g_pmd_status_sel, misc_0.cr_xgwan_top_wan_misc_refin_en, misc_0.cr_xgwan_top_wan_misc_refout_en, misc_0.cr_xgwan_top_wan_misc_mdio_mode, misc_0.cr_xgwan_top_wan_misc_mdio_fast_mode, misc_0.cr_xgwan_top_wan_misc_epon_tx_fifo_off_ld, misc_0.cr_xgwan_top_wan_misc_onu2g_phya, misc_0.cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode, misc_0.cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode, misc_0.cr_xgwan_top_wan_misc_pmd_lane_mode);
        ...
        if(err || misc_0.cr_xgwan_top_wan_misc_onu2g_pmd_status_sel!=gtmv(m, 1) || misc_0.cr_xgwan_top_wan_misc_refin_en!=gtmv(m, 1) || misc_0.cr_xgwan_top_wan_misc_refout_en!=gtmv(m, 1) || misc_0.cr_xgwan_top_wan_misc_mdio_mode!=gtmv(m, 1) || misc_0.cr_xgwan_top_wan_misc_mdio_fast_mode!=gtmv(m, 1) || misc_0.cr_xgwan_top_wan_misc_epon_tx_fifo_off_ld!=gtmv(m, 1) || misc_0.cr_xgwan_top_wan_misc_onu2g_phya!=gtmv(m, 5) || misc_0.cr_xgwan_top_wan_misc_epon_gbox_pon_rx_width_mode!=gtmv(m, 1) || misc_0.cr_xgwan_top_wan_misc_epon_gbox_ae_2p5_full_rate_mode!=gtmv(m, 1) || misc_0.cr_xgwan_top_wan_misc_pmd_lane_mode!=gtmv(m, 16))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint16_t cr_xgwan_top_wan_misc_pmd_core_0_mode=gtmv(m, 16);
        uint16_t cr_xgwan_top_wan_misc_pmd_core_1_mode=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_misc_misc_1_set( %u %u)\n", cr_xgwan_top_wan_misc_pmd_core_0_mode, cr_xgwan_top_wan_misc_pmd_core_1_mode);
        if(!err) ag_drv_misc_misc_1_set(cr_xgwan_top_wan_misc_pmd_core_0_mode, cr_xgwan_top_wan_misc_pmd_core_1_mode);
        if(!err) ag_drv_misc_misc_1_get( &cr_xgwan_top_wan_misc_pmd_core_0_mode, &cr_xgwan_top_wan_misc_pmd_core_1_mode);
        if(!err) bdmf_session_print(session, "ag_drv_misc_misc_1_get( %u %u)\n", cr_xgwan_top_wan_misc_pmd_core_0_mode, cr_xgwan_top_wan_misc_pmd_core_1_mode);
        if(err || cr_xgwan_top_wan_misc_pmd_core_0_mode!=gtmv(m, 16) || cr_xgwan_top_wan_misc_pmd_core_1_mode!=gtmv(m, 16))
            return err ? err : BDMF_ERR_IO;
    }
    {
        misc_misc_2 misc_2 = {.cr_xgwan_top_wan_misc_pmd_rx_mode=gtmv(m, 1), .cr_xgwan_top_wan_misc_pmd_ln_dp_h_rstb=gtmv(m, 1), .cr_xgwan_top_wan_misc_pmd_ln_h_rstb=gtmv(m, 1), .cr_xgwan_top_wan_misc_pmd_core_0_dp_h_rstb=gtmv(m, 1), .cr_xgwan_top_wan_misc_pmd_core_1_dp_h_rstb=gtmv(m, 1), .cr_xgwan_top_wan_misc_pmd_por_h_rstb=gtmv(m, 1), .cr_xgwan_top_wan_misc_pmd_ext_los=gtmv(m, 1), .cr_xgwan_top_wan_misc_pmd_ln_tx_h_pwrdn=gtmv(m, 1), .cr_xgwan_top_wan_misc_pmd_ln_rx_h_pwrdn=gtmv(m, 1), .cr_xgwan_top_wan_misc_pmd_tx_disable=gtmv(m, 1), .cr_xgwan_top_wan_misc_pmd_tx_osr_mode=gtmv(m, 4), .cr_xgwan_top_wan_misc_pmd_tx_mode=gtmv(m, 2), .cr_xgwan_top_wan_misc_pmd_rx_osr_mode=gtmv(m, 4), .cfgactiveethernet2p5=gtmv(m, 1), .cfgngpontxclk=gtmv(m, 2), .cfgngponrxclk=gtmv(m, 2), .cfg_apm_mux_sel_0=gtmv(m, 1), .cfg_apm_mux_sel_1=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_misc_misc_2_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", misc_2.cr_xgwan_top_wan_misc_pmd_rx_mode, misc_2.cr_xgwan_top_wan_misc_pmd_ln_dp_h_rstb, misc_2.cr_xgwan_top_wan_misc_pmd_ln_h_rstb, misc_2.cr_xgwan_top_wan_misc_pmd_core_0_dp_h_rstb, misc_2.cr_xgwan_top_wan_misc_pmd_core_1_dp_h_rstb, misc_2.cr_xgwan_top_wan_misc_pmd_por_h_rstb, misc_2.cr_xgwan_top_wan_misc_pmd_ext_los, misc_2.cr_xgwan_top_wan_misc_pmd_ln_tx_h_pwrdn, misc_2.cr_xgwan_top_wan_misc_pmd_ln_rx_h_pwrdn, misc_2.cr_xgwan_top_wan_misc_pmd_tx_disable, misc_2.cr_xgwan_top_wan_misc_pmd_tx_osr_mode, misc_2.cr_xgwan_top_wan_misc_pmd_tx_mode, misc_2.cr_xgwan_top_wan_misc_pmd_rx_osr_mode, misc_2.cfgactiveethernet2p5, misc_2.cfgngpontxclk, misc_2.cfgngponrxclk, misc_2.cfg_apm_mux_sel_0, misc_2.cfg_apm_mux_sel_1);
        ...
        if(err || misc_2.cr_xgwan_top_wan_misc_pmd_rx_mode!=gtmv(m, 1) || misc_2.cr_xgwan_top_wan_misc_pmd_ln_dp_h_rstb!=gtmv(m, 1) || misc_2.cr_xgwan_top_wan_misc_pmd_ln_h_rstb!=gtmv(m, 1) || misc_2.cr_xgwan_top_wan_misc_pmd_core_0_dp_h_rstb!=gtmv(m, 1) || misc_2.cr_xgwan_top_wan_misc_pmd_core_1_dp_h_rstb!=gtmv(m, 1) || misc_2.cr_xgwan_top_wan_misc_pmd_por_h_rstb!=gtmv(m, 1) || misc_2.cr_xgwan_top_wan_misc_pmd_ext_los!=gtmv(m, 1) || misc_2.cr_xgwan_top_wan_misc_pmd_ln_tx_h_pwrdn!=gtmv(m, 1) || misc_2.cr_xgwan_top_wan_misc_pmd_ln_rx_h_pwrdn!=gtmv(m, 1) || misc_2.cr_xgwan_top_wan_misc_pmd_tx_disable!=gtmv(m, 1) || misc_2.cr_xgwan_top_wan_misc_pmd_tx_osr_mode!=gtmv(m, 4) || misc_2.cr_xgwan_top_wan_misc_pmd_tx_mode!=gtmv(m, 2) || misc_2.cr_xgwan_top_wan_misc_pmd_rx_osr_mode!=gtmv(m, 4) || misc_2.cfgactiveethernet2p5!=gtmv(m, 1) || misc_2.cfgngpontxclk!=gtmv(m, 2) || misc_2.cfgngponrxclk!=gtmv(m, 2) || misc_2.cfg_apm_mux_sel_0!=gtmv(m, 1) || misc_2.cfg_apm_mux_sel_1!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
        misc_misc_3 misc_3 = {.cr_xgwan_top_wan_misc_wan_cfg_mem_reb=gtmv(m, 1), .cr_xgwan_top_wan_misc_wan_cfg_laser_invert=gtmv(m, 1), .cr_xgwan_top_wan_misc_wan_cfg_laser_mode=gtmv(m, 3), .cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select_hs=gtmv(m, 1), .cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select=gtmv(m, 1), .cr_xgwan_top_wan_misc_wan_cfg_laser_oe=gtmv(m, 1), .cr_xgwan_top_wan_misc_wan_cfg_ntr_sync_period_sel=gtmv(m, 4), .cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel=gtmv(m, 4), .cr_xgwan_top_wan_misc_epon_debug_sel=gtmv(m, 8), .cr_xgwan_top_wan_misc_epon_tx_fifo_off=gtmv(m, 6), .cr_xgwan_top_wan_misc_epon_power_zone_sel=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_misc_misc_3_set( %u %u %u %u %u %u %u %u %u %u %u)\n", misc_3.cr_xgwan_top_wan_misc_wan_cfg_mem_reb, misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_invert, misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_mode, misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select_hs, misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select, misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_oe, misc_3.cr_xgwan_top_wan_misc_wan_cfg_ntr_sync_period_sel, misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel, misc_3.cr_xgwan_top_wan_misc_epon_debug_sel, misc_3.cr_xgwan_top_wan_misc_epon_tx_fifo_off, misc_3.cr_xgwan_top_wan_misc_epon_power_zone_sel);
        ...
        if(err || misc_3.cr_xgwan_top_wan_misc_wan_cfg_mem_reb!=gtmv(m, 1) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_invert!=gtmv(m, 1) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_mode!=gtmv(m, 3) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select_hs!=gtmv(m, 1) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select!=gtmv(m, 1) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_oe!=gtmv(m, 1) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_ntr_sync_period_sel!=gtmv(m, 4) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel!=gtmv(m, 4) || misc_3.cr_xgwan_top_wan_misc_epon_debug_sel!=gtmv(m, 8) || misc_3.cr_xgwan_top_wan_misc_epon_tx_fifo_off!=gtmv(m, 6) || misc_3.cr_xgwan_top_wan_misc_epon_power_zone_sel!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    return err;
}
...
bdmfmon_handle_t ag_drv_misc_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_cmd_parm_t set_misc_3[]={
            ...
            BDMFMON_MAKE_PARM("cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select_hs", "cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select_hs", BDMFMON_PARM_NUMBER, 0),
            ...
            BDMFMON_MAKE_PARM("cr_xgwan_top_wan_misc_epon_debug_sel", "cr_xgwan_top_wan_misc_epon_debug_sel", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cr_xgwan_top_wan_misc_epon_tx_fifo_off", "cr_xgwan_top_wan_misc_epon_tx_fifo_off", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("cr_xgwan_top_wan_misc_epon_power_zone_sel", "cr_xgwan_top_wan_misc_epon_power_zone_sel", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
