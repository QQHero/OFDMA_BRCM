...
bdmf_error_t ag_drv_gpon_gearbox_2_set(uint8_t cr_xgwan_top_wan_misc_gpon_gearbox_config_burst_delay_cyc, uint8_t cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc, uint8_t cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_wr_pointer, uint8_t cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_rd_pointer)
{
    uint32_t reg_gearbox_2=0;

#ifdef VALIDATE_PARMS
    if((cr_xgwan_top_wan_misc_gpon_gearbox_config_burst_delay_cyc >= _4BITS_MAX_VAL_) ||
       (cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc >= _3BITS_MAX_VAL_) ||
    ...
    reg_gearbox_2 = RU_FIELD_SET(0, GPON, GEARBOX_2, CR_XGWAN_TOP_WAN_MISC_GPON_GEARBOX_TX_VLD_DELAY_CYC, reg_gearbox_2, cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc);
...
bdmf_error_t ag_drv_gpon_gearbox_2_get(uint8_t *cr_xgwan_top_wan_misc_gpon_gearbox_config_burst_delay_cyc, uint8_t *cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc, uint8_t *cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_wr_pointer, uint8_t *cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_rd_pointer)
{
    uint32_t reg_gearbox_2;

#ifdef VALIDATE_PARMS
    if(!cr_xgwan_top_wan_misc_gpon_gearbox_config_burst_delay_cyc || !cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc || !cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_wr_pointer || !cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_rd_pointer)
    {
        bdmf_trace("ERROR driver %s:%u| err=%s (%d)\n", __FILE__, __LINE__, bdmf_strerror(BDMF_ERR_PARM), BDMF_ERR_PARM);
        return BDMF_ERR_PARM;
    }
    ...
    *cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc = RU_FIELD_GET(0, GPON, GEARBOX_2, CR_XGWAN_TOP_WAN_MISC_GPON_GEARBOX_TX_VLD_DELAY_CYC, reg_gearbox_2);
...
static int bcm_gpon_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_gpon_gearbox_2:
        err = ag_drv_gpon_gearbox_2_set(parm[1].value.unumber, parm[2].value.unumber, parm[3].value.unumber, parm[4].value.unumber);
        break;
    default:
...
int bcm_gpon_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_gpon_gearbox_2:
    {
        ...
        err = ag_drv_gpon_gearbox_2_get(&cr_xgwan_top_wan_misc_gpon_gearbox_config_burst_delay_cyc, &cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc, &cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_wr_pointer, &cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_rd_pointer);
        ...
        bdmf_session_print(session, "cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc = %u (0x%x)\n", cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc, cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc);
...
static int bcm_gpon_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        uint8_t cr_xgwan_top_wan_misc_gpon_gearbox_config_burst_delay_cyc=gtmv(m, 4);
        uint8_t cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc=gtmv(m, 3);
        ...
        if(!err) bdmf_session_print(session, "ag_drv_gpon_gearbox_2_set( %u %u %u %u)\n", cr_xgwan_top_wan_misc_gpon_gearbox_config_burst_delay_cyc, cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc, cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_wr_pointer, cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_rd_pointer);
        if(!err) ag_drv_gpon_gearbox_2_set(cr_xgwan_top_wan_misc_gpon_gearbox_config_burst_delay_cyc, cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc, cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_wr_pointer, cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_rd_pointer);
        if(!err) ag_drv_gpon_gearbox_2_get( &cr_xgwan_top_wan_misc_gpon_gearbox_config_burst_delay_cyc, &cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc, &cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_wr_pointer, &cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_rd_pointer);
        if(!err) bdmf_session_print(session, "ag_drv_gpon_gearbox_2_get( %u %u %u %u)\n", cr_xgwan_top_wan_misc_gpon_gearbox_config_burst_delay_cyc, cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc, cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_wr_pointer, cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_rd_pointer);
        if(err || cr_xgwan_top_wan_misc_gpon_gearbox_config_burst_delay_cyc!=gtmv(m, 4) || cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc!=gtmv(m, 3) || cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_wr_pointer!=gtmv(m, 5) || cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_rd_pointer!=gtmv(m, 5))
            return err ? err : BDMF_ERR_IO;
    }
    return err;
}
