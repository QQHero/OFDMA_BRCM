...
bdmf_error_t ag_drv_early_txen_txen_set(const early_txen_txen *txen)
{
    ...
    reg_cfg = RU_FIELD_SET(0, EARLY_TXEN, CFG, HOLD_TIME, reg_cfg, txen->cr_xgwan_top_wan_misc_early_txen_cfg_hold_time);
    reg_cfg = RU_FIELD_SET(0, EARLY_TXEN, CFG, SETUP_TIME, reg_cfg, txen->cr_xgwan_top_wan_misc_early_txen_cfg_setup_time);
    reg_cfg = RU_FIELD_SET(0, EARLY_TXEN, CFG, TOFF_TIME, reg_cfg, txen->cr_xgwan_top_wan_misc_early_txen_cfg_toff_time);
    reg_cfg = RU_FIELD_SET(0, EARLY_TXEN, CFG, OUTPUT_TXEN_POLARITY, reg_cfg, txen->cr_xgwan_top_wan_misc_early_txen_cfg_output_txen_polarity);
    reg_cfg = RU_FIELD_SET(0, EARLY_TXEN, CFG, INPUT_TXEN_POLARITY, reg_cfg, txen->cr_xgwan_top_wan_misc_early_txen_cfg_input_txen_polarity);
    reg_cfg = RU_FIELD_SET(0, EARLY_TXEN, CFG, EARLY_TXEN_BYPASS, reg_cfg, txen->cr_xgwan_top_wan_misc_early_txen_cfg_early_txen_bypass);

    RU_REG_WRITE(0, EARLY_TXEN, CFG, reg_cfg);
...
bdmf_error_t ag_drv_early_txen_txen_get(early_txen_txen *txen)
{
    ...
    RU_REG_READ(0, EARLY_TXEN, CFG, reg_cfg);

    txen->cr_xgwan_top_wan_misc_early_txen_cfg_hold_time = RU_FIELD_GET(0, EARLY_TXEN, CFG, HOLD_TIME, reg_cfg);
    txen->cr_xgwan_top_wan_misc_early_txen_cfg_setup_time = RU_FIELD_GET(0, EARLY_TXEN, CFG, SETUP_TIME, reg_cfg);
    txen->cr_xgwan_top_wan_misc_early_txen_cfg_toff_time = RU_FIELD_GET(0, EARLY_TXEN, CFG, TOFF_TIME, reg_cfg);
    txen->cr_xgwan_top_wan_misc_early_txen_cfg_output_txen_polarity = RU_FIELD_GET(0, EARLY_TXEN, CFG, OUTPUT_TXEN_POLARITY, reg_cfg);
    txen->cr_xgwan_top_wan_misc_early_txen_cfg_input_txen_polarity = RU_FIELD_GET(0, EARLY_TXEN, CFG, INPUT_TXEN_POLARITY, reg_cfg);
    txen->cr_xgwan_top_wan_misc_early_txen_cfg_early_txen_bypass = RU_FIELD_GET(0, EARLY_TXEN, CFG, EARLY_TXEN_BYPASS, reg_cfg);
...
static int bcm_early_txen_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
    case cli_early_txen_txen:
    {
        early_txen_txen txen = { .cr_xgwan_top_wan_misc_early_txen_cfg_hold_time=parm[1].value.unumber, .cr_xgwan_top_wan_misc_early_txen_cfg_setup_time=parm[2].value.unumber, .cr_xgwan_top_wan_misc_early_txen_cfg_toff_time=parm[3].value.unumber, .cr_xgwan_top_wan_misc_early_txen_cfg_output_txen_polarity=parm[4].value.unumber, .cr_xgwan_top_wan_misc_early_txen_cfg_input_txen_polarity=parm[5].value.unumber, .cr_xgwan_top_wan_misc_early_txen_cfg_early_txen_bypass=parm[6].value.unumber};
...
static int bcm_early_txen_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        early_txen_txen txen = {.cr_xgwan_top_wan_misc_early_txen_cfg_hold_time=gtmv(m, 8), .cr_xgwan_top_wan_misc_early_txen_cfg_setup_time=gtmv(m, 8), .cr_xgwan_top_wan_misc_early_txen_cfg_toff_time=gtmv(m, 8), .cr_xgwan_top_wan_misc_early_txen_cfg_output_txen_polarity=gtmv(m, 1), .cr_xgwan_top_wan_misc_early_txen_cfg_input_txen_polarity=gtmv(m, 1), .cr_xgwan_top_wan_misc_early_txen_cfg_early_txen_bypass=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_early_txen_txen_set( %u %u %u %u %u %u)\n", txen.cr_xgwan_top_wan_misc_early_txen_cfg_hold_time, txen.cr_xgwan_top_wan_misc_early_txen_cfg_setup_time, txen.cr_xgwan_top_wan_misc_early_txen_cfg_toff_time, txen.cr_xgwan_top_wan_misc_early_txen_cfg_output_txen_polarity, txen.cr_xgwan_top_wan_misc_early_txen_cfg_input_txen_polarity, txen.cr_xgwan_top_wan_misc_early_txen_cfg_early_txen_bypass);
        ...
        if(err || txen.cr_xgwan_top_wan_misc_early_txen_cfg_hold_time!=gtmv(m, 8) || txen.cr_xgwan_top_wan_misc_early_txen_cfg_setup_time!=gtmv(m, 8) || txen.cr_xgwan_top_wan_misc_early_txen_cfg_toff_time!=gtmv(m, 8) || txen.cr_xgwan_top_wan_misc_early_txen_cfg_output_txen_polarity!=gtmv(m, 1) || txen.cr_xgwan_top_wan_misc_early_txen_cfg_input_txen_polarity!=gtmv(m, 1) || txen.cr_xgwan_top_wan_misc_early_txen_cfg_early_txen_bypass!=gtmv(m, 1))
...
static int bcm_early_txen_cli_address(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    switch (parm[0].value.unumber)
    {
    case bdmf_address_cfg : reg = &RU_REG(EARLY_TXEN, CFG); blk = &RU_BLK(EARLY_TXEN); break;
    default :
...
bdmfmon_handle_t ag_drv_early_txen_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            { .name="txen", .val=cli_early_txen_txen, .parms=set_txen },
            BDMFMON_ENUM_LAST
        };
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            { .name="txen", .val=cli_early_txen_txen, .parms=set_default },
            BDMFMON_ENUM_LAST
        };
