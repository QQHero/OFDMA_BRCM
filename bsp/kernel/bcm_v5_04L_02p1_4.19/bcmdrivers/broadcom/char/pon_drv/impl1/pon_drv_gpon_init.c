...
static void wan_init(pon_params_t *pon_params)
{
    ...
    if (mode == GPON_2_1)
    {
        RU_FIELD_WRITE(0, GPON, GEARBOX_0, CR_XGWAN_TOP_WAN_MISC_GPON_GEARBOX_FIFO_CFG_0_TXLBE_BIT_ORDER, 1);
        RU_FIELD_WRITE(0, GPON, GEARBOX_0, CR_XGWAN_TOP_WAN_MISC_GPON_GEARBOX_FIFO_CFG_0_RX_16BIT_ORDER,  1);
        RU_FIELD_WRITE(0, GPON, GEARBOX_0, CR_XGWAN_TOP_WAN_MISC_GPON_GEARBOX_FIFO_CFG_0_TX_8BIT_ORDER,   0);
#if defined(CONFIG_BCM96846) || defined(CONFIG_BCM96856) || defined (CONFIG_BCM96878) || defined(CONFIG_BCM96855) 
        RU_FIELD_WRITE(0, GPON, GEARBOX_0, CR_XGWAN_TOP_WAN_MISC_GPON_GEARBOX_FIFO_CFG_0_TX_20BIT_ORDER,  1);
#else
        RU_FIELD_WRITE(0, GPON, GEARBOX_0, CR_XGWAN_TOP_WAN_MISC_GPON_GEARBOX_FIFO_CFG_0_TX_16BIT_ORDER,  1);
#endif
        ...
        RU_FIELD_WRITE(0, GPON, GEARBOX_2, CR_XGWAN_TOP_WAN_MISC_GPON_GEARBOX_CONFIG_BURST_DELAY_CYC,  1);
#if defined (CONFIG_BCM96858)
        RU_FIELD_WRITE(0, GPON, GEARBOX_2, CR_XGWAN_TOP_WAN_MISC_GPON_GEARBOX_TX_VLD_DELAY_CYC,  0);
#endif
    ...
    {   // GP_OVERSAMPLE mode :  WAN_TOP_OSR_CONTROL = 0x9
        RU_FIELD_WRITE(0, TOP_OSR, CONTROL, CR_WAN_TOP_WAN_MISC_SERDES_OVERSAMPLE_CTRL_CFG_GPON_RX_CLK      , 1);
        RU_FIELD_WRITE(0, TOP_OSR, CONTROL, CR_WAN_TOP_WAN_MISC_SERDES_OVERSAMPLE_CTRL_TXFIFO_RD_LEGACY_MODE, 0);
        RU_FIELD_WRITE(0, TOP_OSR, CONTROL, CR_WAN_TOP_WAN_MISC_SERDES_OVERSAMPLE_CTRL_TXLBE_SER_EN         , 1);
    }
#if defined(CONFIG_BCM_NGPON) || defined(CONFIG_BCM_NGPON_MODULE) || defined(CONFIG_BCM963158)
    else if (mode == XGPON_10_2)
    {
        ...
        if (std == STD_G__SubRate) //Should be for XGPON1 only
            RU_FIELD_WRITE(0, TOP_OSR, CONTROL, CR_WAN_TOP_WAN_MISC_SERDES_OVERSAMPLE_CTRL_TXFIFO_RD_LEGACY_MODE, 0); // must set to 1 for XGpon & NGPON2 OSR modes.
        else
            RU_FIELD_WRITE(0, TOP_OSR, CONTROL, CR_WAN_TOP_WAN_MISC_SERDES_OVERSAMPLE_CTRL_TXFIFO_RD_LEGACY_MODE, 1); // must set to 1 for XGpon & NGPON2 OSR modes.
    ...
    RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_RX_OSR_MODE,  0);
    RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_TX_MODE,      0);
    RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_TX_OSR_MODE,  0);
    RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_TX_DISABLE,   0);
    RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_RX_MODE,      0);
    if (mode == GPON_2_1)
    {
        RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_RX_OSR_MODE,  4);  // OSX4
        RU_FIELD_WRITE(0, MISC, 2, CR_XGWAN_TOP_WAN_MISC_PMD_TX_OSR_MODE,  7);  // OSX8
    }
#if defined(CONFIG_BCM_NGPON) || defined(CONFIG_BCM_NGPON_MODULE)
    else if (mode == XGPON_10_2)
    {
    ...
    RU_FIELD_WRITE(0, MISC, 0, CR_XGWAN_TOP_WAN_MISC_REFIN_EN,  1);
    ...
    if (mode == GPON_2_1)
    {
        RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_LASER_MODE, 2); //  BE control by Gpon MAC
#if defined (CONFIG_BCM96858)
        RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT, 2); //  Gpon mode. Sequoia(6858)
#elif (defined (CONFIG_BCM96846) || defined(CONFIG_BCM96856) || defined (CONFIG_BCM96878) || defined (CONFIG_BCM96855))
        RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT, 1); //  Gpon mode. Acacia(68360) has only Epon(0) & Gpon(1) modes.
#elif defined(CONFIG_BCM963158)
        RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT, 4); /*  Gpon mode. 63158 has lots of AE modes GPON = 4. */
#endif
    }
    else if ((mode == XGPON_10_2) || (mode == NGPON_10_10))
    {
        RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_LASER_MODE, 3); //  BE control by NGpon MAC
#if defined (CONFIG_BCM96858)
        RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT, 3); //  NGpon mode
#elif defined(CONFIG_BCM96856) || defined(CONFIG_BCM96855)
        RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT, 1); //  XGPON
        RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT_HS, 1); //
#elif defined(CONFIG_BCM963158)
        RU_FIELD_WRITE(0, MISC, 3, CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT, 7); /*  NGPON mode. 63158 has lots of AE modes NGPON = 7. */
#endif
    }

    //EWAKE configuration for PMD in XGPON modes
    if ((mode == XGPON_10_2) && is_pmd())
    {
...
#if defined(CONFIG_BCM_NGPON) || defined(CONFIG_BCM_NGPON_MODULE)
void reset_ngpon_tx_fifo(void)
{
    __attribute__((unused)) uint32_t rd32_data = 0;
    ...
    // not replacing 2 statements below with a single read-modify-write
    ...
    // RU_REG_READ(0, NGPON_GEARBOX, TX_CTL, rd32_data);
    // rd32_data &= ~0b110;
    // RU_REG_WRITE(0, NGPON_GEARBOX, TX_CTL, rd32_data);
}

void reset_ngpon_rx_fifo(void)
{
    /* #RX FIFO Control */
...
static void serdes_init (pon_params_t *pon_params)
{
    ...
    //  update PLL Rz settings for all ITUT modes
    ...
    {
        /* GPON_GEARBOX_2.CONFIG_BURST_DELAY_CYC = 0x3  [ln:192 @ GponEnvChip.cc ]   */
        RU_FIELD_WRITE(0, GPON, GEARBOX_2, CR_XGWAN_TOP_WAN_MISC_GPON_GEARBOX_FIFO_CFG_1_TX_WR_POINTER,  0x00);
        RU_FIELD_WRITE(0, GPON, GEARBOX_2, CR_XGWAN_TOP_WAN_MISC_GPON_GEARBOX_FIFO_CFG_1_TX_RD_POINTER,  0x10);

        RU_FIELD_WRITE(0, GPON, GEARBOX_0, CR_XGWAN_TOP_WAN_MISC_GPON_GEARBOX_SW_RESET_TXFIFO_RESET,   1);
        udelay(10);
        RU_FIELD_WRITE(0, GPON, GEARBOX_0, CR_XGWAN_TOP_WAN_MISC_GPON_GEARBOX_SW_RESET_TXFIFO_RESET,   0);
    }
