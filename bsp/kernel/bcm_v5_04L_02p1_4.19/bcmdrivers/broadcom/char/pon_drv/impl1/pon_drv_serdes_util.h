...
#define TX_FIR0_DEFAULT (0)
#define TX_FIR1_DEFAULT (90)
#define TX_FIR2_DEFAULT (22)
#define TX_FIR3_DEFAULT (0)
#define TX_FIR4_DEFAULT (0)
...
extern int g_fir_type;
extern uint16_t g_fir_mask;
extern uint16_t g_fir_read_addr;
