...
#define RU_BLK(b)             TOKENPASTE2( b, _BLOCK )
#define RU_REG(b,r)           TOKENPASTE2( TOKENPASTE2( TOKENPASTE2( b, _ ), r ), _REG )
#define RU_REG_OFFSET(b,r)    TOKENPASTE2( RU_REG(b, r), _OFFSET )
#define RU_REG_RAM_CNT(b,r)   TOKENPASTE2( RU_REG(b, r), _RAM_CNT )
#define RU_FLD(b,r,f)         TOKENPASTE2( TOKENPASTE2( TOKENPASTE2( TOKENPASTE2( TOKENPASTE2( b, _ ), r ), _ ), f ), _FIELD )
#define RU_FLD_MASK(b,r,f)    TOKENPASTE2( RU_FLD(b,r,f), _MASK )
#define RU_FLD_SHIFT(b,r,f)   TOKENPASTE2( RU_FLD(b,r,f), _SHIFT )
