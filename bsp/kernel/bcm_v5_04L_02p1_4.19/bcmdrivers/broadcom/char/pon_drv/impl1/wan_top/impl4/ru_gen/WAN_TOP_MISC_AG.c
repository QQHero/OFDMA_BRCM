...
const ru_field_rec MISC_0_CR_XGWAN_TOP_WAN_MISC_PMD_LANE_MODE_FIELD =
{
    ...
    "based register during core_dp_rstb.",
#endif
...
const ru_field_rec MISC_1_CR_XGWAN_TOP_WAN_MISC_PMD_CORE_1_MODE_FIELD =
{
    ...
    "a core register during core_dp_rstb.",
#endif
...
/******************************************************************************
 * Field: MISC_3_CFG_EN_SGMII
 ******************************************************************************/
const ru_field_rec MISC_3_CFG_EN_SGMII_FIELD =
{
    "CFG_EN_SGMII",
#if RU_INCLUDE_DESC
    "",
    "Enable SGMII mode for 1G/100M AE : 0 - fiber mode; 1 - SGMII.",
#endif
    MISC_3_CFG_EN_SGMII_FIELD_MASK,
    0,
    MISC_3_CFG_EN_SGMII_FIELD_WIDTH,
    MISC_3_CFG_EN_SGMII_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
#if RU_INCLUDE_DESC
    "",
    "Allows the bypassing of the NTR pulse generator.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "Selects the source of NTR pulse : 0 - programmable clock; 1 - PON"
    "(EPON/GPON/NGPON); 2 - GPIO, 3 - NCO.",
#endif
...
const ru_field_rec MISC_3_CR_XGWAN_TOP_WAN_MISC_WAN_CFG_WAN_INTERFACE_SELECT_FIELD =
{
    ...
    "1: 1G AE; 2: 2.5G AE; 3: 10G AE; 4: GPON; 5: 1G EPON; 6: 10G EPON;"
    "7: NGPON.",
#endif
...
/******************************************************************************
 * Field: MISC_4_RESERVED0
 ******************************************************************************/
const ru_field_rec MISC_4_RESERVED0_FIELD =
{
    "RESERVED0",
#if RU_INCLUDE_DESC
    "",
    "",
#endif
    MISC_4_RESERVED0_FIELD_MASK,
    0,
    MISC_4_RESERVED0_FIELD_WIDTH,
    MISC_4_RESERVED0_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: MISC_4_CFG_EN_EPON_NTR
 ******************************************************************************/
const ru_field_rec MISC_4_CFG_EN_EPON_NTR_FIELD =
{
    "CFG_EN_EPON_NTR",
#if RU_INCLUDE_DESC
    "",
    "Enable EPON programmable clock to NTR : 0 - WAN; 1 - EPON.",
#endif
    MISC_4_CFG_EN_EPON_NTR_FIELD_MASK,
    0,
    MISC_4_CFG_EN_EPON_NTR_FIELD_WIDTH,
    MISC_4_CFG_EN_EPON_NTR_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: MISC_4_CFG_EN_EPON_PROG_CLK
 ******************************************************************************/
const ru_field_rec MISC_4_CFG_EN_EPON_PROG_CLK_FIELD =
{
    "CFG_EN_EPON_PROG_CLK",
#if RU_INCLUDE_DESC
    "",
    "Enable EPON programmable clock to I2S : 0 - WAN; 1 - EPON.",
#endif
    MISC_4_CFG_EN_EPON_PROG_CLK_FIELD_MASK,
    0,
    MISC_4_CFG_EN_EPON_PROG_CLK_FIELD_WIDTH,
    MISC_4_CFG_EN_EPON_PROG_CLK_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
static const ru_field_rec *MISC_4_FIELDS[] =
{
    ...
    &MISC_4_RESERVED0_FIELD,
    &MISC_4_CFG_EN_EPON_NTR_FIELD,
    &MISC_4_CFG_EN_EPON_PROG_CLK_FIELD,
};
