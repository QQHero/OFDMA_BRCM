...
#define TOP_OSR_CONTROL WAN_SERDES
#define TOP_OSR_BLOCK   WAN_SERDES_BLOCK
#define WAN_SERDES_REG_OFFSET WAN_SERDES_CR_WAN_TOP_WAN_MISC_SERDES_OVERSAMPLE_CTRL_REG_OFFSET
#endif
