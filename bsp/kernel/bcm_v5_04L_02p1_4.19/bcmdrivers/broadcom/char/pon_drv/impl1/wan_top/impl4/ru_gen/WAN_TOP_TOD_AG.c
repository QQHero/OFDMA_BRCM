...
const ru_field_rec TOD_CONFIG_0_TOD_READ_BUSY_FIELD =
{
    ...
    "valid values at WAN_TOD/WAN_TOD_TS64 registers.",
#endif
...
const ru_reg_rec TOD_CONFIG_0_REG = 
{
    ...
    "DEPRECATED. Register used for 48-bit timestamp Time Of Day (TOD)"
    "configuration.",
#endif
...
const ru_reg_rec TOD_CONFIG_2_REG = 
{
    ...
    "DEPRECATED.  Register used for 16-bit timestamp configuration.",
#endif
...
const ru_reg_rec TOD_CONFIG_4_REG = 
{
    ...
    "DEPRECATED.  Offset for 1pps loading.",
#endif
...
const ru_reg_rec TOD_CONFIG_5_REG = 
{
    ...
    "DEPRECATED.  Debug register, used for loading TOD nanosecond counte for"
    "rollover testing.",
#endif
...
const ru_reg_rec TOD_MSB_REG = 
{
    "MSB",
#if RU_INCLUDE_DESC
    "WAN_TOD_MSB Register",
    "DEPRECATED.  Register used for 48-bit timestamp Time Of Day (TOD) read"
    "back.",
#endif
    TOD_MSB_REG_OFFSET,
    0,
...
const ru_reg_rec TOD_TS64_MSB_REG = 
{
    ...
    "DEPRECATED.  Register used for 64-bit timestamp Time Of Day (TOD) read"
    "back.",
#endif
...
const ru_reg_rec TOD_STATUS_0_REG = 
{
    ...
    "DEPRECATED.  Register used for 16-bit timestamp read back.",
#endif
