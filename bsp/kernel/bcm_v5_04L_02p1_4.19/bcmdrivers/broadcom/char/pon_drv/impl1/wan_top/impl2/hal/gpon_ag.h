...
/*                                                                 %s%-29svalue.                  */
/* cr_xgwan_top_wan_misc_gpon_gearbox_0_fifo_cfg_0_asym_loopback:  - 0: Disable nothing. 1: Enabl */
/*                                                                e loopback.                     */
/* cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_0_tx_pointer_distance_max:  - Maximum distance all */
/*                                                                 %s%-37sowed between the Tx FIF */
/*                                                                 %s%-37sO write and readpointer */
/*                                                                 %s%-37ss.  The TXFIFO_DRIFTED  */
/*                                                                 %s%-37sstatus bit is asserted  */
/*                                                                 %s%-37sifTX_POINTER_DISTANCE g */
/*                                                                 %s%-37soes above this maximum  */
/*                                                                 %s%-29svalue.                  */
