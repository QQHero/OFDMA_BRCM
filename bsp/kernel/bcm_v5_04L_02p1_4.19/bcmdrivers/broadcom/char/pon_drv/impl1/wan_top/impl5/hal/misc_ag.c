...
static int bcm_misc_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        misc_misc_3 misc_3 = { .cr_xgwan_top_wan_misc_wan_cfg_mem_reb=parm[1].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_laser_invert=parm[2].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_laser_mode=parm[3].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select=parm[4].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_laser_oe=parm[5].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_ntr_sync_period_sel=parm[6].value.unumber, .cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel=parm[7].value.unumber, .cr_xgwan_top_wan_misc_epon_debug_sel=parm[8].value.unumber, .cr_xgwan_top_wan_misc_epon_tx_fifo_off=parm[9].value.unumber};
...
static int bcm_misc_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        misc_misc_3 misc_3 = {.cr_xgwan_top_wan_misc_wan_cfg_mem_reb=gtmv(m, 1), .cr_xgwan_top_wan_misc_wan_cfg_laser_invert=gtmv(m, 1), .cr_xgwan_top_wan_misc_wan_cfg_laser_mode=gtmv(m, 3), .cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select=gtmv(m, 1), .cr_xgwan_top_wan_misc_wan_cfg_laser_oe=gtmv(m, 1), .cr_xgwan_top_wan_misc_wan_cfg_ntr_sync_period_sel=gtmv(m, 4), .cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel=gtmv(m, 4), .cr_xgwan_top_wan_misc_epon_debug_sel=gtmv(m, 8), .cr_xgwan_top_wan_misc_epon_tx_fifo_off=gtmv(m, 6)};
        if(!err) bdmf_session_print(session, "ag_drv_misc_misc_3_set( %u %u %u %u %u %u %u %u %u)\n", misc_3.cr_xgwan_top_wan_misc_wan_cfg_mem_reb, misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_invert, misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_mode, misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select, misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_oe, misc_3.cr_xgwan_top_wan_misc_wan_cfg_ntr_sync_period_sel, misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel, misc_3.cr_xgwan_top_wan_misc_epon_debug_sel, misc_3.cr_xgwan_top_wan_misc_epon_tx_fifo_off);
        if(!err) ag_drv_misc_misc_3_set(&misc_3);
        if(!err) ag_drv_misc_misc_3_get( &misc_3);
        if(!err) bdmf_session_print(session, "ag_drv_misc_misc_3_get( %u %u %u %u %u %u %u %u %u)\n", misc_3.cr_xgwan_top_wan_misc_wan_cfg_mem_reb, misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_invert, misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_mode, misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select, misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_oe, misc_3.cr_xgwan_top_wan_misc_wan_cfg_ntr_sync_period_sel, misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel, misc_3.cr_xgwan_top_wan_misc_epon_debug_sel, misc_3.cr_xgwan_top_wan_misc_epon_tx_fifo_off);
        if(err || misc_3.cr_xgwan_top_wan_misc_wan_cfg_mem_reb!=gtmv(m, 1) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_invert!=gtmv(m, 1) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_mode!=gtmv(m, 3) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_interface_select!=gtmv(m, 1) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_laser_oe!=gtmv(m, 1) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_ntr_sync_period_sel!=gtmv(m, 4) || misc_3.cr_xgwan_top_wan_misc_wan_cfg_wan_debug_sel!=gtmv(m, 4) || misc_3.cr_xgwan_top_wan_misc_epon_debug_sel!=gtmv(m, 8) || misc_3.cr_xgwan_top_wan_misc_epon_tx_fifo_off!=gtmv(m, 6))
            return err ? err : BDMF_ERR_IO;
    }
    return err;
}
