...
/**************************************************************************************************/
/* cr_xgwan_top_wan_misc_gpon_gearbox_ptg_status2_sel:  - TBD                                     */
/* cr_xgwan_top_wan_misc_gpon_gearbox_ptg_status1_sel:  - TBD                                     */
/* cr_xgwan_top_wan_misc_gpon_gearbox_fifo_status_sel:  - TBD                                     */
/* cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_0_txlbe_bit_order:  - TBD                          */
...
/*                                                                 %s%-29svalue.                  */
/* cr_xgwan_top_wan_misc_gpon_gearbox_0_fifo_cfg_0_asym_loopback:  - TBD                          */
/* cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_0_tx_pointer_distance_max:  - Maximum distance all */
/*                                                                 %s%-100owed between the Tx FIF */
/*                                                                 %s%-100O write and readpointer */
/*                                                                 %s%-100s.  The TXFIFO_DRIFTED  */
/*                                                                 %s%-100status bit is asserted  */
/*                                                                 %s%-100ifTX_POINTER_DISTANCE g */
/*                                                                 %s%-100oes above this maximum  */
/*                                                                 %s%-29svalue.                  */
...
typedef struct
{
    ...
    bdmf_boolean cr_xgwan_top_wan_misc_gpon_gearbox_0_fifo_cfg_0_asym_loopback;
...
/**************************************************************************************************/
/* cr_xgwan_top_wan_misc_gpon_gearbox_pattern_cfg1_filler:  - 8-bit pattern to placed between Tx  */
/*                                                         bursts when PG_MODE is 1.              */
/* cr_xgwan_top_wan_misc_gpon_gearbox_pattern_cfg1_payload:  - 8-bit pattern to placed after the  */
/*                                                          HEADER byte in every Tx burst whenPG_ */
/*                                                          MODE is 1.                            */
/* cr_xgwan_top_wan_misc_gpon_gearbox_pattern_cfg1_header:  - 8-bit pattern to placed at the star */
/*                                                         t of every Tx burst when PG_MODEis 1.  */
/* cr_xgwan_top_wan_misc_gpon_gearbox_pattern_cfg1_pg_mode:  - Pattern generator modes:0: Pattern */
/*                                                           generator disabled. GPON MAC has con */
/*                                                          trol of Tx outputand burst enable.1:  */
/*                                                          Generate repetitive Tx bursts. Each b */
/*                                                          urst consists of 1 headerbyte and1 or */
/*                                                           more payload bytes. Filler bytes are */
/*                                                           placed between Txbursts.2: Reserved3 */
/*                                                          : Reserved4: Generate PRBS7 pattern5: */
/*                                                           Generate PRBS15 pattern6: Generate P */
/*                                                          RBS23 pattern7: Generate PRBS31 patte */
/*                                                          rnMode 0 is for GPON normal operation */
/*                                                          .  Mode 1 is for laser burstenable ca */
/*                                                          libration.                            */
/**************************************************************************************************/
typedef struct
{
...
/**************************************************************************************************/
/* cr_xgwan_top_wan_misc_gpon_gearbox_config_burst_delay_cyc:  - TBD                              */
/* cr_xgwan_top_wan_misc_gpon_gearbox_tx_vld_delay_cyc:  - TBD                                    */
/* cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_wr_pointer:  - Initial value to be loaded int */
/*                                                              o Tx FIFO write pointer whenTXFIF */
/*                                                              O_RESET is asserted.  Legal value */
/*                                                              s are 0 to 19.                    */
/* cr_xgwan_top_wan_misc_gpon_gearbox_fifo_cfg_1_tx_rd_pointer:  - Initial value to be loaded int */
/*                                                              o Tx FIFO read pointer whenTXFIFO */
/*                                                              _REET is asserted.  Legal values  */
/*                                                              are 0 to 31.                      */
/**************************************************************************************************/
typedef struct
{
...
{
    cli_gpon_gearbox_0,
    cli_gpon_pattern_cfg1,
    cli_gpon_pattern_cfg2,
    cli_gpon_gearbox_2,
};
