...
/******************************************************************************
 * Field: QEGPHY__CNTRL_REF_CLK_FREQ_SEL
 ******************************************************************************/
const ru_field_rec QEGPHY__CNTRL_REF_CLK_FREQ_SEL_FIELD =
{
    "REF_CLK_FREQ_SEL",
#if RU_INCLUDE_DESC
    "REF_CLK_FREQ_SEL",
    ...
    "",
#endif
    QEGPHY__CNTRL_REF_CLK_FREQ_SEL_FIELD_MASK,
    0,
    QEGPHY__CNTRL_REF_CLK_FREQ_SEL_FIELD_WIDTH,
    QEGPHY__CNTRL_REF_CLK_FREQ_SEL_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: QEGPHY__CNTRL_TRIMHYB
 ******************************************************************************/
const ru_field_rec QEGPHY__CNTRL_TRIMHYB_FIELD =
{
    "TRIMHYB",
#if RU_INCLUDE_DESC
    "trimhyb",
    "Do not change this bit from its default value before consulting with Broadcom",
#endif
    QEGPHY__CNTRL_TRIMHYB_FIELD_MASK,
    0,
    QEGPHY__CNTRL_TRIMHYB_FIELD_WIDTH,
    QEGPHY__CNTRL_TRIMHYB_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: QEGPHY__CNTRL_TRIMDAC
 ******************************************************************************/
const ru_field_rec QEGPHY__CNTRL_TRIMDAC_FIELD =
{
    "TRIMDAC",
#if RU_INCLUDE_DESC
    "trimdac",
    "Do not change this bit from its default value before consulting with Broadcom",
#endif
    QEGPHY__CNTRL_TRIMDAC_FIELD_MASK,
    0,
    QEGPHY__CNTRL_TRIMDAC_FIELD_WIDTH,
    QEGPHY__CNTRL_TRIMDAC_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_rw
#endif
};
...
/******************************************************************************
 * Field: QEGPHY__STATUS_LOCK_RECOVERY_CLK
 ******************************************************************************/
const ru_field_rec QEGPHY__STATUS_LOCK_RECOVERY_CLK_FIELD =
{
    "LOCK_RECOVERY_CLK",
#if RU_INCLUDE_DESC
    "LOCK_RECOVERY_CLK",
...
#endif
    QEGPHY__STATUS_LOCK_RECOVERY_CLK_FIELD_MASK,
    0,
    QEGPHY__STATUS_LOCK_RECOVERY_CLK_FIELD_WIDTH,
    QEGPHY__STATUS_LOCK_RECOVERY_CLK_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
static const ru_field_rec *QEGPHY__CNTRL_FIELDS[] =
{
    ...
    &QEGPHY__CNTRL_REF_CLK_FREQ_SEL_FIELD,
    &QEGPHY__CNTRL_PLL_CLK125_250_SEL_FIELD,
    &QEGPHY__CNTRL_RESERVED1_FIELD,
    &QEGPHY__CNTRL_TRIMHYB_FIELD,
    &QEGPHY__CNTRL_TRIMDAC_FIELD,
};
...
static const ru_field_rec *QEGPHY__STATUS_FIELDS[] =
{
    ...
    &QEGPHY__STATUS_LOCK_RECOVERY_CLK_FIELD,
