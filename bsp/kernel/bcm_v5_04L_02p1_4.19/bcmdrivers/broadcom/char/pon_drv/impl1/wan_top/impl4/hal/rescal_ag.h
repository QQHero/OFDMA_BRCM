...
/**************************************************************************************************/
/* cfg_wan_rescal_rstb:  - Connects to i_rstb.                                                    */
/* cfg_wan_rescal_diag_on:  - Connects to i_diag_on.                                              */
/* cfg_wan_rescal_pwrdn:  - Connects to i_pwrdn.                                                  */
/* cfg_wan_rescal_ctrl:  - Connects to i_rescal_ctrl.                                             */
/**************************************************************************************************/
typedef struct
{
