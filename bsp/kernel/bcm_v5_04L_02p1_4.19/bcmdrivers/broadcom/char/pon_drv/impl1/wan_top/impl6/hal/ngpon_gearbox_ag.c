...
static int bcm_ngpon_gearbox_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
    case cli_ngpon_gearbox_rx_ctl_0:
    {
        ngpon_gearbox_rx_ctl_0 rx_ctl_0 = { .cfngpongboxrstn=parm[1].value.unumber, .cfngpongboxrxen=parm[2].value.unumber, .cfngpongboxrxmode=parm[3].value.unumber, .cfngpongboxrxswsynchold=parm[4].value.unumber, .cfngpongboxrxfifoptrld=parm[5].value.unumber, .cfngpongboxrxserdatainv=parm[6].value.unumber, .cfngpongboxrxserdataflip=parm[7].value.unumber, .cfngpongboxrx20bdataflip=parm[8].value.unumber, .cfngpongboxrxfrcmuxval=parm[9].value.unumber, .cfngpongboxrxfrcmuxsel=parm[10].value.unumber, .cfngpongboxrxoutdataflip=parm[11].value.unumber, .cfngpongboxrxfrchunt=parm[12].value.unumber, .cfngpongboxrxmaxgoodk=parm[13].value.unumber, .cfngpongboxrxfrmk28only=parm[14].value.unumber, .cfngpongboxrxmaxbadk=parm[15].value.unumber, .cfngpongboxrxptrautolddis=parm[16].value.unumber, .cfngpongboxrxfifordptr=parm[17].value.unumber};
        err = ag_drv_ngpon_gearbox_rx_ctl_0_set(&rx_ctl_0);
        break;
    }
    case cli_ngpon_gearbox_rx_ctl_1:
        err = ag_drv_ngpon_gearbox_rx_ctl_1_set(parm[1].value.unumber);
        break;
    case cli_ngpon_gearbox_rx_ctl_2:
        err = ag_drv_ngpon_gearbox_rx_ctl_2_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_ngpon_gearbox_rx_ctl_3:
        err = ag_drv_ngpon_gearbox_rx_ctl_3_set(parm[1].value.unumber, parm[2].value.unumber);
        break;
    case cli_ngpon_gearbox_tx_ctl:
    {
        ngpon_gearbox_tx_ctl tx_ctl = { .cfngpongboxtxen=parm[1].value.unumber, .cfngpongboxtxfifoptrld=parm[2].value.unumber, .cfngpongboxtxfifovldptrld=parm[3].value.unumber, .cfngpongboxtxserdatainv=parm[4].value.unumber, .cfngpongboxtxservldinv=parm[5].value.unumber, .cfngpongboxtxserdataflip=parm[6].value.unumber, .cfngpongboxtxservldflip=parm[7].value.unumber, .cfngpongboxtxfifovldoff=parm[8].value.unumber, .cfngpongboxtxfifodatardptr=parm[9].value.unumber};
...
int bcm_ngpon_gearbox_cli_get(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    case cli_ngpon_gearbox_rx_ctl_2:
    {
        ...
        err = ag_drv_ngpon_gearbox_rx_ctl_2_get(&cfngpongboxrxk28d5rdn, &cfngpongboxrxk28d5rdp);
    ...
    case cli_ngpon_gearbox_rx_ctl_3:
    {
        ...
        err = ag_drv_ngpon_gearbox_rx_ctl_3_get(&cfngpongboxrxd5d7rdn, &cfngpongboxrxd5d7rdp);
    ...
    case cli_ngpon_gearbox_ngpon_gearbox_status:
    {
        ngpon_gearbox_ngpon_gearbox_status ngpon_gearbox_status;
        err = ag_drv_ngpon_gearbox_ngpon_gearbox_status_get(&ngpon_gearbox_status);
        bdmf_session_print(session, "ngponrxgboxcodeerrcntstat = %u (0x%x)\n", ngpon_gearbox_status.ngponrxgboxcodeerrcntstat, ngpon_gearbox_status.ngponrxgboxcodeerrcntstat);
        bdmf_session_print(session, "ngponrxgboxfifoptrcol = %u (0x%x)\n", ngpon_gearbox_status.ngponrxgboxfifoptrcol, ngpon_gearbox_status.ngponrxgboxfifoptrcol);
        bdmf_session_print(session, "ngponrxgboxsyncacq = %u (0x%x)\n", ngpon_gearbox_status.ngponrxgboxsyncacq, ngpon_gearbox_status.ngponrxgboxsyncacq);
        bdmf_session_print(session, "ngponrxgboxfifoptrdelta = %u (0x%x)\n", ngpon_gearbox_status.ngponrxgboxfifoptrdelta, ngpon_gearbox_status.ngponrxgboxfifoptrdelta);
        bdmf_session_print(session, "ngponrxgboxkcnt = %u (0x%x)\n", ngpon_gearbox_status.ngponrxgboxkcnt, ngpon_gearbox_status.ngponrxgboxkcnt);
        bdmf_session_print(session, "ngpontxgboxfifodataptrcol = %u (0x%x)\n", ngpon_gearbox_status.ngpontxgboxfifodataptrcol, ngpon_gearbox_status.ngpontxgboxfifodataptrcol);
        bdmf_session_print(session, "ngponrxgboxstate = %u (0x%x)\n", ngpon_gearbox_status.ngponrxgboxstate, ngpon_gearbox_status.ngponrxgboxstate);
        bdmf_session_print(session, "ngpontxgboxfifovldptrcol = %u (0x%x)\n", ngpon_gearbox_status.ngpontxgboxfifovldptrcol, ngpon_gearbox_status.ngpontxgboxfifovldptrcol);
        break;
    }
    default:
        err = BDMF_ERR_NOT_SUPPORTED;
...
static int bcm_ngpon_gearbox_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        ngpon_gearbox_rx_ctl_0 rx_ctl_0 = {.cfngpongboxrstn=gtmv(m, 1), .cfngpongboxrxen=gtmv(m, 1), .cfngpongboxrxmode=gtmv(m, 1), .cfngpongboxrxswsynchold=gtmv(m, 1), .cfngpongboxrxfifoptrld=gtmv(m, 1), .cfngpongboxrxserdatainv=gtmv(m, 1), .cfngpongboxrxserdataflip=gtmv(m, 1), .cfngpongboxrx20bdataflip=gtmv(m, 1), .cfngpongboxrxfrcmuxval=gtmv(m, 5), .cfngpongboxrxfrcmuxsel=gtmv(m, 1), .cfngpongboxrxoutdataflip=gtmv(m, 1), .cfngpongboxrxfrchunt=gtmv(m, 1), .cfngpongboxrxmaxgoodk=gtmv(m, 3), .cfngpongboxrxfrmk28only=gtmv(m, 1), .cfngpongboxrxmaxbadk=gtmv(m, 3), .cfngpongboxrxptrautolddis=gtmv(m, 1), .cfngpongboxrxfifordptr=gtmv(m, 4)};
        if(!err) bdmf_session_print(session, "ag_drv_ngpon_gearbox_rx_ctl_0_set( %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", rx_ctl_0.cfngpongboxrstn, rx_ctl_0.cfngpongboxrxen, rx_ctl_0.cfngpongboxrxmode, rx_ctl_0.cfngpongboxrxswsynchold, rx_ctl_0.cfngpongboxrxfifoptrld, rx_ctl_0.cfngpongboxrxserdatainv, rx_ctl_0.cfngpongboxrxserdataflip, rx_ctl_0.cfngpongboxrx20bdataflip, rx_ctl_0.cfngpongboxrxfrcmuxval, rx_ctl_0.cfngpongboxrxfrcmuxsel, rx_ctl_0.cfngpongboxrxoutdataflip, rx_ctl_0.cfngpongboxrxfrchunt, rx_ctl_0.cfngpongboxrxmaxgoodk, rx_ctl_0.cfngpongboxrxfrmk28only, rx_ctl_0.cfngpongboxrxmaxbadk, rx_ctl_0.cfngpongboxrxptrautolddis, rx_ctl_0.cfngpongboxrxfifordptr);
        ...
        if(err || rx_ctl_0.cfngpongboxrstn!=gtmv(m, 1) || rx_ctl_0.cfngpongboxrxen!=gtmv(m, 1) || rx_ctl_0.cfngpongboxrxmode!=gtmv(m, 1) || rx_ctl_0.cfngpongboxrxswsynchold!=gtmv(m, 1) || rx_ctl_0.cfngpongboxrxfifoptrld!=gtmv(m, 1) || rx_ctl_0.cfngpongboxrxserdatainv!=gtmv(m, 1) || rx_ctl_0.cfngpongboxrxserdataflip!=gtmv(m, 1) || rx_ctl_0.cfngpongboxrx20bdataflip!=gtmv(m, 1) || rx_ctl_0.cfngpongboxrxfrcmuxval!=gtmv(m, 5) || rx_ctl_0.cfngpongboxrxfrcmuxsel!=gtmv(m, 1) || rx_ctl_0.cfngpongboxrxoutdataflip!=gtmv(m, 1) || rx_ctl_0.cfngpongboxrxfrchunt!=gtmv(m, 1) || rx_ctl_0.cfngpongboxrxmaxgoodk!=gtmv(m, 3) || rx_ctl_0.cfngpongboxrxfrmk28only!=gtmv(m, 1) || rx_ctl_0.cfngpongboxrxmaxbadk!=gtmv(m, 3) || rx_ctl_0.cfngpongboxrxptrautolddis!=gtmv(m, 1) || rx_ctl_0.cfngpongboxrxfifordptr!=gtmv(m, 4))
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_ngpon_gearbox_rx_ctl_2_set( %u %u)\n", cfngpongboxrxk28d5rdn, cfngpongboxrxk28d5rdp);
        if(!err) ag_drv_ngpon_gearbox_rx_ctl_2_set(cfngpongboxrxk28d5rdn, cfngpongboxrxk28d5rdp);
        if(!err) ag_drv_ngpon_gearbox_rx_ctl_2_get( &cfngpongboxrxk28d5rdn, &cfngpongboxrxk28d5rdp);
        if(!err) bdmf_session_print(session, "ag_drv_ngpon_gearbox_rx_ctl_2_get( %u %u)\n", cfngpongboxrxk28d5rdn, cfngpongboxrxk28d5rdp);
        if(err || cfngpongboxrxk28d5rdn!=gtmv(m, 10) || cfngpongboxrxk28d5rdp!=gtmv(m, 10))
            return err ? err : BDMF_ERR_IO;
    }
    {
        uint16_t cfngpongboxrxd5d7rdn=gtmv(m, 10);
        uint16_t cfngpongboxrxd5d7rdp=gtmv(m, 10);
        if(!err) bdmf_session_print(session, "ag_drv_ngpon_gearbox_rx_ctl_3_set( %u %u)\n", cfngpongboxrxd5d7rdn, cfngpongboxrxd5d7rdp);
        if(!err) ag_drv_ngpon_gearbox_rx_ctl_3_set(cfngpongboxrxd5d7rdn, cfngpongboxrxd5d7rdp);
        if(!err) ag_drv_ngpon_gearbox_rx_ctl_3_get( &cfngpongboxrxd5d7rdn, &cfngpongboxrxd5d7rdp);
        if(!err) bdmf_session_print(session, "ag_drv_ngpon_gearbox_rx_ctl_3_get( %u %u)\n", cfngpongboxrxd5d7rdn, cfngpongboxrxd5d7rdp);
        if(err || cfngpongboxrxd5d7rdn!=gtmv(m, 10) || cfngpongboxrxd5d7rdp!=gtmv(m, 10))
            return err ? err : BDMF_ERR_IO;
    }
    {
        ngpon_gearbox_tx_ctl tx_ctl = {.cfngpongboxtxen=gtmv(m, 1), .cfngpongboxtxfifoptrld=gtmv(m, 1), .cfngpongboxtxfifovldptrld=gtmv(m, 1), .cfngpongboxtxserdatainv=gtmv(m, 1), .cfngpongboxtxservldinv=gtmv(m, 1), .cfngpongboxtxserdataflip=gtmv(m, 1), .cfngpongboxtxservldflip=gtmv(m, 1), .cfngpongboxtxfifovldoff=gtmv(m, 5), .cfngpongboxtxfifodatardptr=gtmv(m, 4)};
        if(!err) bdmf_session_print(session, "ag_drv_ngpon_gearbox_tx_ctl_set( %u %u %u %u %u %u %u %u %u)\n", tx_ctl.cfngpongboxtxen, tx_ctl.cfngpongboxtxfifoptrld, tx_ctl.cfngpongboxtxfifovldptrld, tx_ctl.cfngpongboxtxserdatainv, tx_ctl.cfngpongboxtxservldinv, tx_ctl.cfngpongboxtxserdataflip, tx_ctl.cfngpongboxtxservldflip, tx_ctl.cfngpongboxtxfifovldoff, tx_ctl.cfngpongboxtxfifodatardptr);
        ...
        if(err || tx_ctl.cfngpongboxtxen!=gtmv(m, 1) || tx_ctl.cfngpongboxtxfifoptrld!=gtmv(m, 1) || tx_ctl.cfngpongboxtxfifovldptrld!=gtmv(m, 1) || tx_ctl.cfngpongboxtxserdatainv!=gtmv(m, 1) || tx_ctl.cfngpongboxtxservldinv!=gtmv(m, 1) || tx_ctl.cfngpongboxtxserdataflip!=gtmv(m, 1) || tx_ctl.cfngpongboxtxservldflip!=gtmv(m, 1) || tx_ctl.cfngpongboxtxfifovldoff!=gtmv(m, 5) || tx_ctl.cfngpongboxtxfifodatardptr!=gtmv(m, 4))
            return err ? err : BDMF_ERR_IO;
    }
    {
        ngpon_gearbox_ngpon_gearbox_status ngpon_gearbox_status = {.ngponrxgboxcodeerrcntstat=gtmv(m, 14), .ngponrxgboxfifoptrcol=gtmv(m, 1), .ngponrxgboxsyncacq=gtmv(m, 1), .ngponrxgboxfifoptrdelta=gtmv(m, 4), .ngponrxgboxkcnt=gtmv(m, 3), .ngpontxgboxfifodataptrcol=gtmv(m, 1), .ngponrxgboxstate=gtmv(m, 2), .ngpontxgboxfifovldptrcol=gtmv(m, 1)};
        if(!err) ag_drv_ngpon_gearbox_ngpon_gearbox_status_get( &ngpon_gearbox_status);
        if(!err) bdmf_session_print(session, "ag_drv_ngpon_gearbox_ngpon_gearbox_status_get( %u %u %u %u %u %u %u %u)\n", ngpon_gearbox_status.ngponrxgboxcodeerrcntstat, ngpon_gearbox_status.ngponrxgboxfifoptrcol, ngpon_gearbox_status.ngponrxgboxsyncacq, ngpon_gearbox_status.ngponrxgboxfifoptrdelta, ngpon_gearbox_status.ngponrxgboxkcnt, ngpon_gearbox_status.ngpontxgboxfifodataptrcol, ngpon_gearbox_status.ngponrxgboxstate, ngpon_gearbox_status.ngpontxgboxfifovldptrcol);
    }
    return err;
}
...
bdmfmon_handle_t ag_drv_ngpon_gearbox_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            { .name="rx_ctl_0", .val=cli_ngpon_gearbox_rx_ctl_0, .parms=set_rx_ctl_0 },
            { .name="rx_ctl_1", .val=cli_ngpon_gearbox_rx_ctl_1, .parms=set_rx_ctl_1 },
            { .name="rx_ctl_2", .val=cli_ngpon_gearbox_rx_ctl_2, .parms=set_rx_ctl_2 },
            { .name="rx_ctl_3", .val=cli_ngpon_gearbox_rx_ctl_3, .parms=set_rx_ctl_3 },
            { .name="tx_ctl", .val=cli_ngpon_gearbox_tx_ctl, .parms=set_tx_ctl },
            BDMFMON_ENUM_LAST
        };
    ...
    }
    {
        ...
        static bdmfmon_enum_val_t selector_table[] = {
            { .name="rx_ctl_0", .val=cli_ngpon_gearbox_rx_ctl_0, .parms=set_default },
            { .name="rx_ctl_1", .val=cli_ngpon_gearbox_rx_ctl_1, .parms=set_default },
            { .name="rx_ctl_2", .val=cli_ngpon_gearbox_rx_ctl_2, .parms=set_default },
            { .name="rx_ctl_3", .val=cli_ngpon_gearbox_rx_ctl_3, .parms=set_default },
            { .name="tx_ctl", .val=cli_ngpon_gearbox_tx_ctl, .parms=set_default },
            { .name="ngpon_gearbox_status", .val=cli_ngpon_gearbox_ngpon_gearbox_status, .parms=set_default },
            BDMFMON_ENUM_LAST
        };
