...
#if RU_INCLUDE_DESC
    "",
    "DEPRECATED. Indicates the sampling of clock counter, as specified"
    "by cfg_pll_smpl_prd sampling period.",
#endif
...
#if RU_INCLUDE_DESC
    "",
    "DEPRECATED. Interrupt mask, active low.",
#endif
