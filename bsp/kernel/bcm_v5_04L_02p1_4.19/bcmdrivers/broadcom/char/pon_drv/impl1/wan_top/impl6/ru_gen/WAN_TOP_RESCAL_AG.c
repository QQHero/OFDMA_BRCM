...
/******************************************************************************
 * Field: RESCAL_STATUS_0_VALID
 ******************************************************************************/
const ru_field_rec RESCAL_STATUS_0_VALID_FIELD =
{
    "VALID",
#if RU_INCLUDE_DESC
    "VALID",
    ...
    "Reset value is 0x0.",
#endif
    RESCAL_STATUS_0_VALID_FIELD_MASK,
    0,
    RESCAL_STATUS_0_VALID_FIELD_WIDTH,
    RESCAL_STATUS_0_VALID_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: RESCAL_STATUS_0_COMP
 ******************************************************************************/
const ru_field_rec RESCAL_STATUS_0_COMP_FIELD =
{
    "COMP",
#if RU_INCLUDE_DESC
    "COMP",
    ...
    "Reset value is 0x0.",
#endif
    RESCAL_STATUS_0_COMP_FIELD_MASK,
    0,
    RESCAL_STATUS_0_COMP_FIELD_WIDTH,
    RESCAL_STATUS_0_COMP_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: RESCAL_STATUS_0_STATE
 ******************************************************************************/
const ru_field_rec RESCAL_STATUS_0_STATE_FIELD =
{
    "STATE",
#if RU_INCLUDE_DESC
    "STATE",
    ...
    "Reset value is 0x0.",
#endif
    RESCAL_STATUS_0_STATE_FIELD_MASK,
    0,
    RESCAL_STATUS_0_STATE_FIELD_WIDTH,
    RESCAL_STATUS_0_STATE_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: RESCAL_STATUS_0_CTRL_DFS
 ******************************************************************************/
const ru_field_rec RESCAL_STATUS_0_CTRL_DFS_FIELD =
{
    "CTRL_DFS",
#if RU_INCLUDE_DESC
    "CTRL_DFS",
    ...
    "Reset value is 0x0.",
#endif
    RESCAL_STATUS_0_CTRL_DFS_FIELD_MASK,
    0,
    RESCAL_STATUS_0_CTRL_DFS_FIELD_WIDTH,
    RESCAL_STATUS_0_CTRL_DFS_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: RESCAL_STATUS_0_PREV_COMP_CNT
 ******************************************************************************/
const ru_field_rec RESCAL_STATUS_0_PREV_COMP_CNT_FIELD =
{
    "PREV_COMP_CNT",
#if RU_INCLUDE_DESC
    "PREV_COMP_CNT",
    ...
    "Reset value is 0x0.",
#endif
    RESCAL_STATUS_0_PREV_COMP_CNT_FIELD_MASK,
    0,
    RESCAL_STATUS_0_PREV_COMP_CNT_FIELD_WIDTH,
    RESCAL_STATUS_0_PREV_COMP_CNT_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: RESCAL_STATUS_0_PON
 ******************************************************************************/
const ru_field_rec RESCAL_STATUS_0_PON_FIELD =
{
    "PON",
#if RU_INCLUDE_DESC
    "PON",
    ...
    "Reset value is 0x0.",
#endif
    RESCAL_STATUS_0_PON_FIELD_MASK,
    0,
    RESCAL_STATUS_0_PON_FIELD_WIDTH,
    RESCAL_STATUS_0_PON_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
/******************************************************************************
 * Field: RESCAL_STATUS_0_DONE
 ******************************************************************************/
const ru_field_rec RESCAL_STATUS_0_DONE_FIELD =
{
    "DONE",
#if RU_INCLUDE_DESC
    "DONE",
    ...
    "Reset value is 0x0.",
#endif
    RESCAL_STATUS_0_DONE_FIELD_MASK,
    0,
    RESCAL_STATUS_0_DONE_FIELD_WIDTH,
    RESCAL_STATUS_0_DONE_FIELD_SHIFT,
#if RU_INCLUDE_ACCESS
    ru_access_read
#endif
};
...
{
    &RESCAL_STATUS_0_VALID_FIELD,
    &RESCAL_STATUS_0_COMP_FIELD,
    &RESCAL_STATUS_0_STATE_FIELD,
    &RESCAL_STATUS_0_CTRL_DFS_FIELD,
    &RESCAL_STATUS_0_PREV_COMP_CNT_FIELD,
    &RESCAL_STATUS_0_PON_FIELD,
    &RESCAL_STATUS_0_DONE_FIELD,
