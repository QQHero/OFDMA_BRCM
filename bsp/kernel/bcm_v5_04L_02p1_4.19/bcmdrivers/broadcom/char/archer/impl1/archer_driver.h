...
extern const int archer_cpu_affinity_g;
extern const int archer_packet_length_max_g;
extern const int archer_packet_headroom_g;
extern const int archer_skb_tailroom_g;
...
#define ARCHER_RX_ENET(_blog_p) ( (_blog_p)->rx.info.phyHdrType == BLOG_ENETPHY )

#define ARCHER_TX_ENET(_blog_p) ( (_blog_p)->tx.info.phyHdrType == BLOG_ENETPHY )
