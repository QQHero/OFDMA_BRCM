...
static int archer_txdma_getQStats(int queue_id, archer_txq_stats_t *pstats)
{
   return iudma_txq_stats_get(queue_id, pstats);
}
...
void bindXtmHandlers(void)
{
    ...
    xtmHooks.txdmaGetQStats = archer_txdma_getQStats;
