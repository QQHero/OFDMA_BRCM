...
#if defined(CC_SYSPORT_PARSER_CONFIG_DEFAULTS)
#define SYSPORT_PARSER_CONFIG_SRC_MAC_ENABLE           1
#define SYSPORT_PARSER_CONFIG_PCP_ENABLE               1
#define SYSPORT_PARSER_CONFIG_DEI_ENABLE               1
#define SYSPORT_PARSER_CONFIG_VLAN_TPID_0              BLOG_ETH_QINQ1
#define SYSPORT_PARSER_CONFIG_VLAN_TPID_1              BLOG_ETH_QINQ2
#define SYSPORT_PARSER_CONFIG_VLAN_TPID_2              BLOG_ETH_P_8021Q
#define SYSPORT_PARSER_CONFIG_VLAN_TPID_3              BLOG_ETH_P_8021Q
#define SYSPORT_PARSER_CONFIG_UCAST_L2_VLAN_MAX        SYSPORT_RSB_VLAN_TAGS_MAX
#define SYSPORT_PARSER_CONFIG_UCAST_L2_VLAN_CALC_MODE  1
#if defined(CC_SYSPORT_PARSER_V2)
#define SYSPORT_PARSER_CONFIG_UCAST_L2_TOS_UNKNOWN     0xFF
#else
#define SYSPORT_PARSER_CONFIG_UCAST_L2_TOS_UNKNOWN     0
#endif
#define SYSPORT_PARSER_CONFIG_UCAST_L2_TOS_MASK        0xFF
#define SYSPORT_PARSER_CONFIG_UCAST_L3_TOS_MASK        0xFF
#endif
