			...
			case kOidAdslPrivate:
				switch (objId[1]) {
					...
					case kOidAdslPrivDoiGain:
						...
						break;
					case kOidAdslPrivGetnToneRmc:
						pObj = (void *)&globalVar.nTonesRmc;
						objLen = sizeof(globalVar.nTonesRmc);
						break;
					case kOidAdslPrivGetRmcBitAlloc:
						pObj = (void *) globalVar.rmcBitAlloc;
						objLen = sizeof (globalVar.rmcBitAlloc[0]) * globalVar.nTonesGfast;
						break;
					case kOidAdslPrivGetRts:
						pObj = (void *) globalVar.rts;
						objLen = sizeof (globalVar.rts[0]) * globalVar.nTonesGfast;
						break;
#endif
					...
					case kOidAdslPrivGetLineFeatures:
						...
						break;
					case kOidAdslPrivGetLogicalFrameInfo:
						pObj = (void *)&globalVar.logicalFrameCfg;
						objLen = sizeof(globalVar.logicalFrameCfg);
						break;
#endif
					case kOidAdslPrivExtraInfo:
						switch (objId[2]) {
