...
extern void trxbus_register_mac(int bus, int force, int (*insert_cb)(void *opticaldet_desc), int (*remove_cb)(void));
#endif
...
#ifdef CONFIG_BCM_PON
extern int _trx_get_lbe_polarity(void *desc, TRX_SIG_ACTIVE_POLARITY *lbe_polarity_p);

static int trx_detect(void *opticaldet_desc)
{
    TRX_SIG_ACTIVE_POLARITY lbe_polarity = TRX_ACTIVE_HIGH;
