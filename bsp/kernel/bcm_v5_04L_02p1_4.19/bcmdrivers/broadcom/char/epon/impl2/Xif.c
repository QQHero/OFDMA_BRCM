...
U32 XifAllLinkState (void)
    ...
    for (link = 0; link < TkOnuNumTotalLlids; ++link)
        {
...
////////////////////////////////////////////////////////////////////////////////
//extern
void XifXpcsRxInrpMaskSet(const xpcsrx_rx_int_msk *rx_int_msk)
    {
    bdmf_error_t drv_error = BDMF_ERR_OK;

    drv_error += ag_drv_xpcsrx_rx_int_msk_set(rx_int_msk);
    }
...
void XifInit (U8 txOffTimeOffset, BOOL txOffIdle,
    ...
    {
#if !defined(CONFIG_BCM96856) && !defined(CONFIG_BCM963158) || defined(CONFIG_BCM96855)
    xif_sec_ctl sec_ctl;
#endif
    xif_ctl ctl = {0};
