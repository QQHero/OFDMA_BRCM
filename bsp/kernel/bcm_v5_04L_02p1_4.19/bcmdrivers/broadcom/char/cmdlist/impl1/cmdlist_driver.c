...
#if defined(CONFIG_BCM_CMDLIST_XPE) && !defined(XPE_PACKET_MODIFICATION)
#error CONFIG_BCM_CMDLIST_XPE is defined but firmware is built for GPE
#elif defined(CONFIG_BCM_CMDLIST_GPE) && defined(XPE_PACKET_MODIFICATION)
#error CONFIG_BCM_CMDLIST_GPE is defined but firmware is built for XPE
#endif
                         ...
                         cmdlist_brcm_tag_t brcm_tag, int *tx_adjust_p)
{
    ...
    {
        ret = cmdlist_ucast_create_bin(blog_p, target, prependData_p, prependSize,
                                       buffer_pp, brcm_tag, tx_adjust_p);
    }
                            ...
                            cmdlist_brcm_tag_t brcm_tag, int *tx_adjust_p)
{
    ...
    {
        ret = cmdlist_l2_ucast_create_bin(blog_p, target, prependData_p, prependSize,
                                          buffer_pp, brcm_tag, tx_adjust_p);
    }
...
{
    return cmdlist_get_length_bin(data_length_p);
}
...
#if defined(CONFIG_BCM_CMDLIST_GPE)
    {
#if (defined(BCM63158) && !defined(BCM63158_CMDLIST_XPE_SIM)) || defined(BCM63146) || defined(BCM4912) || defined(BCM6813)
