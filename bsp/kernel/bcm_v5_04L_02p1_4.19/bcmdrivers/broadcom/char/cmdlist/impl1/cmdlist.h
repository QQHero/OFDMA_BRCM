...
#if defined(CONFIG_BCM_CMDLIST_GPE)
void gpe_config(int ih_offset, int ih_headroom, int headroom, int target_ddr_supported);
void gpe_init(uint32_t *cmd_list_p, uint32_t cmd_list_length_max,
              uint32_t cmd_list_start_offset);
int gpe_get_length(int *data_length_p);
...
#elif defined(CONFIG_BCM_CMDLIST_SPE)
void spe_init(uint32_t *cmd_list_p, uint32_t cmd_list_length_max,
              uint32_t cmd_list_start_offset);
int spe_get_length(int *data_length_p);
...
#elif defined(CONFIG_BCM_CMDLIST_XPE)
void xpe_init(uint32_t *cmd_list_p, uint32_t cmd_list_length_max,
              uint32_t cmd_list_start_offset);
int xpe_get_length(int *data_length_p);
void xpe_dump(uint32_t *cmd_list_p, int length32);
void xpe_dump_partial(void);
int xpe_cmd_end(void);
#define cmdlist_config_bin(_ih_offset, _ih_headroom, _headroom, _target_ddr_supported)
#define cmdlist_init_bin xpe_init
#define cmdlist_get_length_bin xpe_get_length
#define cmdlist_dump_bin xpe_dump
#define cmdlist_dump_partial_bin xpe_dump_partial
#define cmdlist_cmd_end_bin xpe_cmd_end
#else
