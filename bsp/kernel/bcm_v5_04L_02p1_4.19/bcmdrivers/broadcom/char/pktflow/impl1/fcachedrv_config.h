...
/* Flow cache configured Max number of unicast Flow Entries */
#define FCACHE_CONFIG_MAX_UCAST_FLOW_ENTRIES     (CONFIG_BCM_MAX_UCAST_FLOWS)

/* Define high flow system if more than 4k flow entries */
#if FCACHE_CONFIG_MAX_UCAST_FLOW_ENTRIES > (4*1024)
#define CC_FCACHE_HIGH_FLOW_SYS
#endif

/* Flow cache configured Max number of mcast groups */
#define FCACHE_CONFIG_MAX_MCAST_GROUPS          (CONFIG_BCM_MAX_MCAST_GROUPS)

/* Flow cache configured Max number of clients in a mcast group */
#define FCACHE_CONFIG_MAX_MCAST_CLIENTS_PER_GROUP   (CONFIG_BCM_MAX_MCAST_CLIENTS_PER_GROUP)

/* Flow cache configured Max number of clients system wide */
#define FCACHE_CONFIG_MAX_MCAST_CLIENTS         (CONFIG_BCM_MAX_MCAST_CLIENTS)

/* Flow cache configured Max number of mcast Flow Entries */
/* There is one additional mcast flow entry for each mcast group because of a master flow */
#define FCACHE_CONFIG_MAX_MCAST_FLOW_ENTRIES    (FCACHE_CONFIG_MAX_MCAST_GROUPS + FCACHE_CONFIG_MAX_MCAST_CLIENTS)

/* Flow cache configured Max number of Flow Entries */
#define FCACHE_CONFIG_MAX_FLOW_ENTRIES     (FCACHE_CONFIG_MAX_UCAST_FLOW_ENTRIES + FCACHE_CONFIG_MAX_MCAST_FLOW_ENTRIES)

/* Flow cache configured Max number of FDB Entries */
#define FCACHE_CONFIG_MAX_FDB_ENTRIES     (CONFIG_BCM_MAX_FDB)

/* Flow cache configured Max number of Host Devices */
#define FCACHE_CONFIG_MAX_HOST_DEV_ENTRIES     (CONFIG_BCM_MAX_HOST_DEV)

/* Flow cache configured Max number of Host MAC */
#define FCACHE_CONFIG_MAX_HOST_MAC_ENTRIES     (CONFIG_BCM_MAX_HOST_MAC)
...
#if defined(CC_FCACHE_HIGH_FLOW_SYS)
#define FCACHE_SLICE_MAX_ENT            (CONFIG_BCM_MAX_UCAST_FLOWS>>9) /* Maximum entries per slice */
#else
