 ...
 *
 * $Id: phy_api.h 791912 2020-10-13 12:54:38Z $
 */
...
#define PHY_CAP_SUP_5G			0x00004000	/* 5G supported */
#define PHY_CAP_SUP_6G			0x00080000	/* 6G supported */

/* PHY Capabilities added for ACREV_GE 44 */
#define PHY_CAP_FDCS			0x00008000	/* Supports FDCS */
#define PHY_CAP_11N_TURBO_QAM		0x00010000	/* Supports 11n Turbo QAM */
#define PHY_CAP_HE			0x00020000	/* Supports High Efficieny (802.11ax) */
#define PHY_CAP_11AX_DCM		0x00040000	/* Supports HE (11ax) Dual carrier mode */
...
void wlc_phy_set_shmdefs(phy_info_t *pi, const shmdefs_t *shmdefs);
...
int phy_bss_init(phy_info_t *pi, bool bonlyap, int noise);
...
void phy_machwcap_set(phy_info_t *pi, uint32 machwcap);
int8 phy_preamble_override_get(phy_info_t *pi);
int  phy_hw_state_upd(phy_info_t *pi, bool newstate);
int  phy_hw_clk_state_upd(phy_info_t *pi, bool newstate);
int phy_numofcores(phy_info_t *pi);
