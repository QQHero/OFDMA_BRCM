 ...
 *
 * $Id: phy_ac_mu.c 786653 2020-05-04 18:09:00Z $
 */
 ...
 * register layout.
 */
#if ACCONF_GT(131) || ACCONF_MSK(0xF0E80000) || ACCONF2_MSK(0x700CC)
...
phy_ac_mu_group_set(phy_type_mu_ctx_t *ctx, uint16 mu_group, uint8 user_pos, uint8 is_member)
{
	...
	val = val << shift;
	reg_mask = 0xf << (MU_REG_GROUP_SHIFT * (mu_group % MU_GROUPS_PER_REG));
