 ...
 *
 * $Id: siutils.c 766361 2018-07-31 09:51:01Z $
 */
...
{
	/* XXX
	 * Invalidate iPA Boardflags which is inproperly programmed for previous 4331 Boards
	 *
	 * SROM content is read and stored in pvars in the format "var=value" delimited by \0
	 * For appropriate 4331 boards,
	 * search for extpagain2g and extpagain5g and set value to zero.
	 */
...
#if (!defined(_CFE_) && !defined(_CFEZ_)) || defined(CFG_WL)
	/* XXX chipid for 43221/43231:
	 * 43221/43231 is the same chip as 4322, but has its unique chipid 0xA8D5 programmed in
	 * OTP. However, if both SPROM and OTP are strapped, HW doesn't get the chipid from OTP
	 * so the chipid will read 0x4322. We have to block the driver in this case to prevent
	 * people from buying 43221/43231(cheaper) and use them as 4322(expensive).
	 */
...
#if (!defined(_CFE_) && !defined(_CFEZ_)) || defined(CFG_WL)
		/* XXX WAR: For 4319 wl reboot to work; after reboot bootloader
		 * comes back cleanly.
		 */
...
BCMATTACHFN(si_slave_wrapper_add)(si_t *sih)
{
	...
	/* XXXX - HW4345-1251 - WAR for incorrect EROM base
	 * slave wrapper address in the 4345c0/c1/c2.
	 */
