 ...
 *
 * $Id: d11.h 809675 2022-03-22 05:14:17Z $
 */
...
#define	D11_MBSSID_BCN_TMPL_LEN	 1820	/* max beacon size defined by WFA */
...
#define TX_FIFO_EXT_START	5	/* Index at which extended FIFOs start */
...
#define MCAP1_AVB_MASK		0x00000040	/**< AVB supported */
...
BWL_PRE_PACKED_STRUCT struct d11pktinfo_rev128 {
	...
	uint16	OrderSeq;			/* 26. this pkt's order seq number */
...
BWL_PRE_PACKED_STRUCT struct d11ulmu_txd {
	...
	uint16	rel_cnt;	/* 20 total us/bytes to trigger per uesr */
	...
	uint16	peak_mlen;	/* 25 peak mpdu length */
...
#define D11_ULOTXD_MACTL_MIXBWOP_SHIFT	14
#define D11_ULOTXD_MACTL_MIXBWOP_MASK	0x4000
#define D11_ULOTXD_MACTL_MIXEDBW_SHIFT	15
#define D11_ULOTXD_MACTL_MIXEDBW_MASK	0x8000
...
#define D11_ULOTXD_MACTL1_AIRTIME_SHIFT	3	/* airtime interface */
#define D11_ULOTXD_MACTL1_AIRTIME_MASK	0x0008
...
#define D11_ULOTXD_UCFG_FIXTAGID_MASK		0x0100
...
#define D11_RATE_LINK_MEM_IDX_INVALID		AMT_SIZE_512 /* 0x200 */
...
#ifdef WL_SPP_AMSDU
	C_LTX_SPP_AMSDU_EN_NBIT	= 7,	// AMSDU SPP support
#endif /* WL_SPP_AMSDU */
...
#define D11_ULORMEM_RTCTL_EPOCH_MASK		0x7000
#define D11_ULORMEM_RTCTL_EPOCH_SHIFT		12
...
#define D11_ULORMEM_RTCTL_GET_EPOCH(a)	(((a) & D11_ULORMEM_RTCTL_EPOCH_MASK) >> \
					D11_ULORMEM_RTCTL_EPOCH_SHIFT)
#define D11_ULORMEM_RTCTL_SET_EPOCH(a, v)	((a) = ((a) & ~D11_ULORMEM_RTCTL_EPOCH_MASK) | \
					(((v) << D11_ULORMEM_RTCTL_EPOCH_SHIFT)))
 ...
 * bits 15:9: free bits
 * bit  8  : rts/cts full BW
 * bit  7  : RATE PROBE flag
 * bits 6:4: RATE_EPOCH maintained by ratesel module
 * bits 3:0: rmem_nupd
 */
#define D11_REV128_RCTS_FULL_BW			0x100
#define D11_REV128_RATE_PROBE_FLAG		0x080
#define D11_REV128_RATE_EPOCH_MASK		0x070
#define D11_REV128_RATE_EPOCH_SHIFT		4
#define D11_REV128_RATE_NUPD_MASK		0x00F
 ...
 */
typedef struct tx_status_mactxs tx_status_mactxs_t;
typedef struct tx_status tx_status_t;
typedef struct tx_status_macinfo tx_status_macinfo_t;

/** Tx Status generated by MAC (independent of corerev) TX_STATUS_MACTXS_BYTES */
struct tx_status_mactxs {
	uint32 s1;
	uint32 s2;
	uint32 s3;
	uint32 s4;
...
/** HW MAC generated Tx Status (tx_status_mactxs_t) Accessor Macros */
#define TX_STATUS_MACTXS_S1(_txs)		((_txs)->status.mactxs->s1)
#define TX_STATUS_MACTXS_S2(_txs)		((_txs)->status.mactxs->s2)
#define TX_STATUS_MACTXS_S3(_txs)		((_txs)->status.mactxs->s3)
#define TX_STATUS_MACTXS_S4(_txs)		((_txs)->status.mactxs->s4)
#define TX_STATUS_MACTXS_S5(_txs)		((_txs)->status.mactxs->s5)
#define TX_STATUS_MACTXS_ACK_MAP1(_txs)		((_txs)->status.mactxs->ack_map1)
#define TX_STATUS_MACTXS_ACK_MAP2(_txs)		((_txs)->status.mactxs->ack_map2)
#define TX_STATUS_MACTXS_S8(_txs)		((_txs)->status.mactxs->s8)

#if defined(TX_STATUS_MACTXS_64BYTES)
#define TX_STATUS_MACTXS_S9(_txs)		((_txs)->status.mactxs->s9)
#define TX_STATUS_MACTXS_S10(_txs)		((_txs)->status.mactxs->s10)
#define TX_STATUS_MACTXS_S11(_txs)		((_txs)->status.mactxs->s11)
#define TX_STATUS_MACTXS_S12(_txs)		((_txs)->status.mactxs->s12)
#define TX_STATUS_MACTXS_S13(_txs)		((_txs)->status.mactxs->s13)
#define TX_STATUS_MACTXS_S14(_txs)		((_txs)->status.mactxs->s14)
#define TX_STATUS_MACTXS_S15(_txs)		((_txs)->status.mactxs->s15)
#define TX_STATUS_MACTXS_S16(_txs)		((_txs)->status.mactxs->s16)
#endif /* TX_STATUS_MACTXS_64BYTES */
...
#define TX_STATUS_SUPR_MASK	0x00000001c	/**< suppress status bits (4:2) */
...
#define	TX_STATUS_RTS_RTX_MASK	0x000000f00
#define	TX_STATUS_FRM_RTX_SHIFT	12
#define	TX_STATUS_FRM_RTX_MASK	0x00000f000

/* tx status bytes 2-3 */
#define	TX_STATUS_FID_SHIFT	16
#define	TX_STATUS_FID_MASK	0Xffff0000

/* Tx status bytes 4-5; pkg-1 - s2  */
#define TX_STATUS_SEQ_SHIFT	0
#define TX_STATUS_SEQ_MASK	0x0000ffff
#define	TX_STATUS_PTX_SHIFT	16
#define	TX_STATUS_PTX_MASK	0xffff0000
#define	TX_STATUS_MU_SHIFT	24
#define	TX_STATUS_MU_MASK	0x01000000
#define	TX_STATUS_PTXFLG_SHIFT	31
#define	TX_STATUS_PTXFLG_MASK	0x80000000

#define TX_STATUS_PTXVAL(s2)	(((s2) & TX_STATUS_PTX_MASK) >> TX_STATUS_PTX_SHIFT)
#define TX_STATUS_PTXFLG(s2)	(((s2) & TX_STATUS_PTXFLG_MASK) >> TX_STATUS_PTXFLG_SHIFT)

#define TX_STATUS_PTX(s2, _corerev)	(D11REV_GE((_corerev), 129) ? \
	(TX_STATUS_PTXFLG(s2) ? TX_STATUS_PTXVAL(s2) : 0) : TX_STATUS_PTXVAL(s2))

#define TX_STATUS128_TXDUR_SHIFT	16
#define TX_STATUS128_TXDUR_MASK		0x7fff0000

#define TX_STATUS128_TXDUR(s2)		(TX_STATUS_PTXFLG(s2) ? 0 : \
	(((s2) & TX_STATUS128_TXDUR_MASK) >> TX_STATUS128_TXDUR_SHIFT) << 1)
...
#define TX_STATUS40_TX_MEDIUM_DELAY(txs) \
	(TX_STATUS_MACTXS_S8((txs)) & TX_STATUS40_MEDIUM_DELAY_MASK)
...
#define TX_STATUS64_MU_NSSMCS_MASK	0x0000007f
#define TX_STATUS64_MU_NSSMCS_SHIFT	0
#define TX_STATUS64_MU_GRPSEQ_MASK	0x00001f00
#define TX_STATUS64_MU_GRPSEQ_SHIFT	8
#define TX_STATUS64_MU_SNDSEQ_MASK	0x0000e000
#define TX_STATUS64_MU_SNDSEQ_SHIFT	13
...
#define TX_STATUS64_MU_NSSMCS(s4) ((s4 & TX_STATUS64_MU_NSSMCS_MASK) >> TX_STATUS64_MU_NSSMCS_SHIFT)
#define TX_STATUS64_MU_GRPSEQ(s4) \
	((s4 & TX_STATUS64_MU_GRPSEQ_MASK) >> TX_STATUS64_MU_GRPSEQ_SHIFT)
#define TX_STATUS64_MU_SNDSEQ(s4) \
	((s4 & TX_STATUS64_MU_SNDSEQ_MASK) >> TX_STATUS64_MU_SNDSEQ_SHIFT)

/* MU user info0 txstatus field (s4 b[15:0]) for MU boost */
...
/* MU bit */
#define TX_STATUS128_MU_MASK		0x0080
...
#define TGTXS_EPOCH_MASK	0x0e000000
#define TGTXS_EPOCH_SHIFT	25
#define TGTXS_SP_MASK           0x10000000
#define TGTXS_SP_SHIFT          28
/* s6 */
...
#define TGTXS_ULMM(s5)		(((s5) & TGTXS_ULMM_MASK) >> TGTXS_ULMM_SHIFT)
...
#define TGTXS_EPOCH(s5)		(((s5) & TGTXS_EPOCH_MASK) >> TGTXS_EPOCH_SHIFT)
#define TGTXS_ISSP(s5)		(((s5) & TGTXS_SP_MASK) >> TGTXS_SP_SHIFT)
...
#define AMT_SIZE_512			512	/**< number of AMT entries for corerev >= 132 */
#define AMT_IDX_MAC			63	/**< device MAC */
#define AMT_IDX_BSSID			62	/**< BSSID match */

/* AMT size in case of rate link mem */
#define AMT_IDX_SIZE_11AX		AMT_SIZE_256 /* use as reference also for AMT size>256 */
...
#define AMT_IDX_RSVD_RATE_SIZE		39	/**< reserve upper rate entries for ucode / musched;
...
#define AMT_IDX_DLOFDMA_RSVD_START	(AMT_IDX_ULOFDMA_RSVD_START + AMT_IDX_ULOFDMA_RSVD_SIZE)
...
#define AMT_SIZE(_corerev)	(D11REV_GE((_corerev), 132) ? AMT_SIZE_512 : \
	(D11REV_GE((_corerev), 129) ? AMT_SIZE_256 : \
...
#define MHF3_6G_LPI_MODE	0x2000  /**< ge128, 6g LPI mode */
...
#define MHF6_CBPWAR		0x0400 /** < 6g adaptivity WAR */
...
#define MXHF0_AGGX		0x0080		/* aggx feature */
...
#define MXHF1_OMUTAFWIN		0x0020		/* omu grouping by the same taf window */
...
#define MXHF1_MBS_DISABLE	0x0800		/* 1: disable, 0: enable, grouping across MBSS */
...
#define D11PHYRXSTS_NULL	((d11phyrxsts_t *) NULL)
...
/**< Number of PhyRx Generated Status bytes for corerev >= 129 */
#define D11PHYRXSTS_GE129_PHYRXS_LEN		152

/**< Receive Offset of PhyRx status corerev > 129 */
#define D11PHYRXSTS_RECV_OFFSET			8

#define D11PHYRXSTS_SEQNUM(d11phyrxsts)		((((d11phyrxsts)->seq & 0xf000) >> 4) |	\
							((d11phyrxsts)->seq & 0xff))

#define D11PHYRXSTS_LEN_INVALID(d11phyrxsts)	((d11phyrxsts)->PhyRxStatusLen == (uint16)(-1))

#define D11PHYRXSTS_SEQNUM_MAX			4096	/* 12 bit sequence number */
...
/* per user info for ulmumimo stats (rxstatus bytes v2p6) */
#define PRXS_USER_SNRDELTA_MASK_REV_GE129		0xFC00
#define PRXS_USER_SNRDELTA_REV_GE129(rxs, user)	((D11PHYRXSTS_GE129_ACCESS_VAL(rxs, \
						PhyRxStatus_rem[21 + user*3]) & \
						PRXS_USER_SNRDELTA_MASK_REV_GE129) >> 10)

#define PRXS_USER_PREEMPTED_MASK_REV_GE129		0x0100
#define PRXS_USER_PREEMPTED_REV_GE129(rxs, user)	((D11PHYRXSTS_GE129_ACCESS_VAL(rxs, \
						PhyRxStatus_rem[21 + user*3]) & \
						PRXS_USER_PREEMPTED_MASK_REV_GE129) >> 8)
...
/* uCode M_MY_BSSCOLOR definition */
#define D11_HE_AP_BSSCOLOR_MASK		0x3f	/* bit 0..5 */
#define D11_HE_AP_BSSCOLOR_SHIFT	0
#define D11_HE_AP_BSSCOLOR_DIS_MASK	0x80	/* bit 7 */
#define D11_HE_AP_BSSCOLOR_DIS_SHIFT	7
#define D11_HE_STA_BSSCOLOR_MASK	0x3f00	/* bit 8..13 */
#define D11_HE_STA_BSSCOLOR_SHIFT	8
#define D11_HE_STA_BSSCOLOR_DIS_MASK	0x8000	/* bit 15 */
#define D11_HE_STA_BSSCOLOR_DIS_SHIFT	15
...
#define WATCHDOG_8TU_MAX_EXTRA_LONG_RXFRAME 6 /* ~55 msecs for extra long 11n frames */
...
typedef enum {
	TOF_RX_FTM_NBIT         = 0,
	TOF_SHARED_ANT          = 1,
	TOF_AVB_ACK_ON_NBIT     = 2,    /* Ucode sees next ACK as TOF ACK */
} eTOFFlags;
...
#define D11_TXE_XMTDMA_DBG_CTL_SIGNAL_SHIFT	13
#define D11_TXE_XMTDMA_DBG_CTL_SIGNAL_MASK	0xe000
#define D11_TXE_XMTDMA_DBG_CTL_ENGINE_SHIFT	7
#define D11_TXE_XMTDMA_DBG_CTL_ENGINE_MASK	0x0f80
#define D11_TXE_XMTDMA_DBG_CTL_VAL(signal, engine)	\
				((((engine) << D11_TXE_XMTDMA_DBG_CTL_ENGINE_SHIFT) & \
				D11_TXE_XMTDMA_DBG_CTL_ENGINE_MASK) | \
				(((signal) << D11_TXE_XMTDMA_DBG_CTL_SIGNAL_SHIFT) & \
				D11_TXE_XMTDMA_DBG_CTL_SIGNAL_MASK))
...
#define D11_MAX_DMATX_ENGINES(corerev)	\
	(D11REV_GE((corerev), 132) ? D11_MAX_DMATX_ENGINES_REV132 : \
	(D11REV_GE((corerev), 131) ? D11_MAX_DMATX_ENGINES_REV131 : \
	(D11REV_GE((corerev), 130) ? D11_MAX_DMATX_ENGINES_REV130 : \
	(D11REV_GE((corerev), 129) ? D11_MAX_DMATX_ENGINES_REV129 : \
				     0))))
#define D11_MAX_DMATX_SIGNAL_BMP		7
