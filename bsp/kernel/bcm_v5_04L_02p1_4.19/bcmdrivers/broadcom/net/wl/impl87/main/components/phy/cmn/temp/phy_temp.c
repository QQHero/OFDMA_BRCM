 ...
 *
 * $Id: phy_temp.c 785036 2020-03-11 13:26:19Z $
 */
...
/* vbat functions */
uint8
phy_vbat_sense_read(phy_info_t *pi)
{
...
uint8
phy_vbat_sense_get(phy_info_t *pi)
{
	phy_type_temp_fns_t *fns = pi->tempi->fns;
...
int16
phy_temp_get_override(phy_info_t *pi)
{
...
int16
phy_temp_sense_get(phy_info_t *pi)
{
	phy_type_temp_fns_t *fns = pi->tempi->fns;
...
int16
phy_temp_sense_read(phy_info_t *pi)
{
	phy_type_temp_fns_t *fns = pi->tempi->fns;
...
bool
phy_temp_is_heatedup(phy_info_t *pi)
{
