 ...
 * $Id: phy_type_tof.h 809672 2022-03-22 04:44:16Z $
 */
...
typedef int (*phy_type_chan_freq_response_fn_t)(phy_type_tof_ctx_t *ctx, int len, int nbits,
	bool swap_pn_half, uint32 offset, cint32* H, uint32* Hraw, uint8 core, uint8 sts,
...
typedef int (*phy_type_tof_phyts_setup_fn_t)(phy_type_tof_ctx_t *ctx, bool setup, uint8 role);
typedef int (*phy_type_tof_phyts_read_sc_fn_t)(phy_type_tof_ctx_t *ctx, cint16 *sc_mem);
typedef int (*phy_type_tof_phyts_enable_sc_fn_t)(phy_type_tof_ctx_t *ctx);
typedef int (*phy_type_tof_phyts_pkt_detect_fn_t)(phy_type_tof_ctx_t *ctx, cint16 *sc_mem);
typedef int (*phy_type_tof_phyts_mf_fn_t)(phy_type_tof_ctx_t *ctx, cint16 *sc_mem,
	uint32 *ts, bool mode);
typedef int (*phy_type_tof_phyts_loopback_fn_t)(phy_type_tof_ctx_t *ctx, bool setup);
typedef int (*phy_type_tof_phyts_set_txpwr_fn_t)(phy_type_tof_ctx_t *ctx,
	int8 txpwr_dbm);
typedef int (*phy_type_tof_phyts_get_sc_read_buf_sz_fn_t)(phy_type_tof_ctx_t *ctx,
	uint32 *sc_read_buf_sz);
...
typedef struct {
	...
	phy_type_tof_phyts_setup_fn_t phyts_setup;
	phy_type_tof_phyts_read_sc_fn_t phyts_read_sc;
	phy_type_tof_phyts_enable_sc_fn_t phyts_enable_sc;
	phy_type_tof_phyts_pkt_detect_fn_t phyts_pkt_detect;
	phy_type_tof_phyts_mf_fn_t phyts_mf;
	phy_type_tof_phyts_loopback_fn_t phyts_loopback;
	phy_type_tof_phyts_set_txpwr_fn_t phyts_set_txpwr;
	phy_type_tof_phyts_get_sc_read_buf_sz_fn_t phyts_get_sc_read_buf_sz;
} phy_type_tof_fns_t;
