 ...
 *
 * $Id: phy_dbg_api.h 782932 2020-01-09 10:39:50Z $
 */
 ...
 */
extern void wlc_phy_print_phydbg_regs(phy_info_t *pi);
#endif /* DNG_DBGDUMP */
 ...
 */
int phy_dbg_dump_getlistandsize(phy_info_t *pi, uint8 type);

/*
* phy and radio register binary dump
*/
int phy_dbg_dump_tbls(phy_info_t *pi, uint8 type, uchar *p, int * buf_len, bool fatal_error);
