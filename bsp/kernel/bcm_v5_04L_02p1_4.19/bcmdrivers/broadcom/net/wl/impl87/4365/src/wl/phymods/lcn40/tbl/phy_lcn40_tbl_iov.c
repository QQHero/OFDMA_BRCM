/*
 * LCN40PHY PHYTblInit module implementation - iovar handlers & registration
 *
...
static int
phy_lcn40_tbl_doiovar(void *ctx, uint32 aid,
	void *p, uint plen, void *a, uint alen, uint vsize)
{
	...
	case IOV_GVAL(IOV_PHYTABLE):
		...
		wlc_lcn40phy_read_table(pi, &tab2);
		break;
	...
	case IOV_SVAL(IOV_PHYTABLE):
		...
		wlc_lcn40phy_write_table(pi, &tab2);
		break;
...
int
BCMATTACHFN(phy_lcn40_tbl_register_iovt)(phy_info_t *pi, wlc_iocv_info_t *ii)
{
