 ...
 *
 * $Id: phy_ac_papdcal.h 802962 2021-09-10 22:14:35Z $
 */
...
#define UINT16_LOW_NIBBLE_MASK  ((uint16) 0x000Fu)
#define SAMPLE_PLAY_START_PTR_HIGH_MASK   ((uint16) 0x0F00u)
#define SAMPLE_PLAY_START_PTR_HIGH_SHIFT  8u
#define SAMPLE_PLAY_STOP_PTR_HIGH_MASK    ((uint16) 0xF000u)
#define SAMPLE_PLAY_STOP_PTR_HIGH_SHIFT   12u
...
extern void wlc_phy_get_papd_cal_pwr_acphy(phy_info_t *pi, int8 *targetpwr, int8 *tx_idx,
                                           uint8 core);
extern uint16 phy_ac_papdcal_eps_table_size(phy_info_t *pi, uint8 core);
extern void wlc_phy_txpwr_papd_cal_acphy(phy_info_t *pi);
extern void wlc_phy_tssi_to_power_acphy(phy_info_t *pi);
