 ...
 *
 * $Id: wlc_ie_mgmt.h 797595 2021-04-09 09:24:57Z $
 */
...
extern int wlc_iem_get_tag_build_calc_cb(wlc_info_t *wlc, wlc_iem_tag_t tag,
		wlc_iem_cbe_t *build_cb, wlc_iem_ft_t ft);

extern int wlc_iem_fill_mbssid_tag_list(wlc_info_t *wlc, wlc_bsscfg_t *trans_cfg,
		wlc_bsscfg_t *nontrans_cfg, wlc_iem_calc_data_t *data);
extern void wlc_iem_get_sta_info_vendor_oui(wlc_info_t *wlc, struct scb *scb,
		sta_vendor_oui_t *v_oui);
extern void wlc_iem_store_sta_info_vendor_oui(wlc_info_t *wlc, struct scb *scb,
