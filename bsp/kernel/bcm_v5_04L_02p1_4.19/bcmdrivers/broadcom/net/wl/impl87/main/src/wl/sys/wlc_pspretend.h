 ...
 *
 * $Id: wlc_pspretend.h 803989 2021-10-14 19:10:00Z $
 */
...
bool wlc_pspretend_limit_transit(wlc_pps_info_t *pps, scb_t *scb, int in_transit, bool agg_enab);
bool wlc_pspretend_pkt_retry(wlc_pps_info_t *pps, scb_t *scb, void *pkt, tx_status_t *txs,
	d11txhdr_t *txh);
void wlc_pspretend_rate_reset(wlc_pps_info_t *pps, scb_t *scb, uint8 ac);
bool wlc_pspretend_pkt_relist(wlc_pps_info_t *pps, scb_t *scb, int retry_limit, int txretry);

void wlc_pspretend_scb_ps_off(wlc_pps_info_t *pps, scb_t *scb);

void wlc_pspretend_dotxstatus(wlc_pps_info_t *pps, scb_t *scb, bool pps_recvd_ack);
bool wlc_pspretend_on(wlc_pps_info_t *pps, scb_t *scb, uint8 flags);

void wlc_pspretend_probe_sched(wlc_pps_info_t *pps, scb_t *scb);
...
extern bool wlc_pspretend_pps_retry(wlc_info_t *wlc, scb_t *scb, void *p, tx_status_t *txs);
#endif /* PSPRETEND */
