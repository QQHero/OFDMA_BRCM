 ...
 *
 * $Id: wlc_bcntrim.h 690185 2017-03-15 04:25:18Z $
 */
...
#ifdef DONGLEBUILD
extern void wlc_stf_bcntrim_handle_csa_chanspec(wlc_bcntrim_info_t *bcntrim, wlc_bsscfg_t *bsscfg);
#else
#define wlc_stf_bcntrim_handle_csa_chanspec(a, b) do {} while (0)
#endif /* DONGLEBUILD */
