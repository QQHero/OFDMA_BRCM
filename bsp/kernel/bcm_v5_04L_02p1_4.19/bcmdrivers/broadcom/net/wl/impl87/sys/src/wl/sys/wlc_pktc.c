 ...
 *
 * $Id: wlc_pktc.c 803989 2021-10-14 19:10:00Z $
 */
...
wlc_pktc_sdu_prep_copy(wlc_info_t *wlc, struct scb *scb, void *p, void *n)
{
	uint8 *dot3lsh;
...
void BCMFASTPATH
wlc_pktc_sdu_prep(wlc_info_t *wlc, struct scb *scb, void *p, void *n)
{
	struct ether_header *eh;

	wlc_pktc_sdu_prep_copy(wlc, scb, p, n);
