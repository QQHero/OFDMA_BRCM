 ...
 *
 * $Id: wlc_pwrstats.h 780917 2019-11-06 12:00:48Z $
 */
...
#define WL_PWRSTATS_INFO_1_ARGS(str, p1)
#define WL_PWRSTATS_INFO_STR_0_ARGS(str)
...
extern int wlc_pwrstats_get_active_dur(wlc_pwrstats_info_t *ps, uint8 *destptr, int destlen);
extern int wlc_pwrstats_get_radio(wlc_info_t *wlc, void *arg, uint16 len, uint8 *buf);
