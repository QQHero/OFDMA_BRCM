 ...
 *
 * $Id: phy_papdcal.h 802962 2021-09-10 22:14:35Z $
 */
...
int phy_papdcal_get_wbpapd_gctrl(phy_info_t *pi, int32* wbpapd_gctrl);
int phy_papdcal_set_wbpapd_gctrl(phy_info_t *pi, int32 wbpapd_gctrl);
int phy_papdcal_get_wbpapd_multitbl(phy_info_t *pi, int32* wbpapd_multitbl);
int phy_papdcal_set_wbpapd_multitbl(phy_info_t *pi, int32 wbpapd_multitbl);
int phy_papdcal_get_wbpapd_sampcapt(phy_info_t *pi, int32* wbpapd_sampcapt);
int phy_papdcal_set_wbpapd_sampcapt(phy_info_t *pi, int32 wbpapd_sampcapt);
int phy_papdcal_get_peak_psd_limit(phy_info_t *pi, int32* peak_psd_limit);
int phy_papdcal_set_peak_psd_limit(phy_info_t *pi, int32 peak_psd_limit);
#endif
