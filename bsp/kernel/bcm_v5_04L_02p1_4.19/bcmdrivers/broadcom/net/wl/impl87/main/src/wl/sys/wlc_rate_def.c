 ...
 *
 * $Id: wlc_rate_def.c 790787 2020-09-03 01:18:31Z $
 */
...
const wlc_rateset_t cck_ofdm_mimo_rates = {
	...
	HE_CAP_MAX_MCS_MAP_0_11_NSS4,	/* HE Tx mcs nss set for the BW 80Mhz */
	HE_CAP_MAX_MCS_MAP_0_11_NSS4,	/* HE Rx mcs nss set for the BW 80Mhz */
	HE_CAP_MAX_MCS_NONE_ALL,	/* HE Tx mcs nss set for the BW 160Mhz */
	HE_CAP_MAX_MCS_NONE_ALL,	/* HE Rx mcs nss set for the BW 160Mhz */
	HE_CAP_MAX_MCS_NONE_ALL,	/* HE Tx mcs nss set for the BW 80p80Mhz */
	HE_CAP_MAX_MCS_NONE_ALL		/* HE Rx mcs nss set for the BW 80p80Mhz */
};
...
const wlc_rateset_t cck_ofdm_rates = {
	...
	VHT_PROP_MCS_MAP_NONE_ALL,	/* prop vht mcs nss bit map */
	HE_CAP_MAX_MCS_NONE_ALL,	/* HE Tx mcs nss set for the BW 80Mhz */
	HE_CAP_MAX_MCS_NONE_ALL,	/* HE Rx mcs nss set for the BW 80Mhz */
	HE_CAP_MAX_MCS_NONE_ALL,	/* HE Tx mcs nss set for the BW 160Mhz */
	HE_CAP_MAX_MCS_NONE_ALL,	/* HE Rx mcs nss set for the BW 160Mhz */
	HE_CAP_MAX_MCS_NONE_ALL,	/* HE Tx mcs nss set for the BW 80p80Mhz */
	HE_CAP_MAX_MCS_NONE_ALL		/* HE Rx mcs nss set for the BW 80p80Mhz */
