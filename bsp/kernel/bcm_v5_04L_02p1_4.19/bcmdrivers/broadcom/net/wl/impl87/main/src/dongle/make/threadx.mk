...
THREADX_DFLAGS	+= -DTHREADX_BTCM_STACK
# This is defined by default in cm3 port
...
RTOS_OBJECTS += threadx.o threadx_osl_ext.o threadx_timer.o threadx_low_power.o
ifeq ($(TARGET_ARCH),arm)
	RTOS_OBJECTS  += threadx_arm.o
endif

EXTRA_DFLAGS += $(THREADX_DFLAGS)
EXTRA_DFLAGS += -DTHREADX
EXTRA_DFLAGS += -DIRQMODE_SHARED_STACK

vpath %.c $(SRCBASE)/dongle/rte
vpath %.c $(SRCBASE)/dongle/threadx/wl
ifeq ($(TARGET_CPU),cm3)
vpath %.c $(SRCBASE)/../components/threadx/cortex-m3/gnu
vpath %.S $(SRCBASE)/../components/threadx/cortex-m3/gnu
endif
ifeq ($(TARGET_CPU),cr4)
vpath %.c $(SRCBASE)/../components/threadx/cortex-r4/gnu
vpath %.S $(SRCBASE)/../components/threadx/cortex-r4/gnu
endif
ifeq ($(TARGET_CPU),ca7)
vpath %.c $(SRCBASE)/../components/threadx/cortex-a7/gnu
vpath %.S $(SRCBASE)/../components/threadx/cortex-a7/gnu
endif

EXTRA_IFLAGS += -I$(SRCBASE)/dongle/rte
ifeq ($(TARGET_CPU),cm3)
EXTRA_IFLAGS += -I$(SRCBASE)/../components/threadx/cortex-m3/gnu
endif
ifeq ($(TARGET_CPU),cr4)
EXTRA_IFLAGS += -I$(SRCBASE)/../components/threadx/cortex-r4/gnu
endif
ifeq ($(TARGET_CPU),ca7)
EXTRA_IFLAGS += -I$(SRCBASE)/../components/threadx/cortex-a7/gnu
endif
