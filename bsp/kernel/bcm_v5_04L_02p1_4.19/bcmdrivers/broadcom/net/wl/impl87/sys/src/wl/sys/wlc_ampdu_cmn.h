 ...
 *
 * $Id: wlc_ampdu_cmn.h 804524 2021-11-02 07:52:42Z $
*/
...
enum {
	...
	AMPDU_11VHT	= 2,
	AMPDU_11HE	= 3,
	AMPDU_UNKNOWN	= AMPDU_NONE
};

/* move to wlioctl.h */
#define AMPDU_MAX_MCS	31		/**< we don't deal with mcs 32 */
#define AMPDU_MAX_VHT	48		/**< VHT rate 0-9 + prop 10-11, 4 streams for now */
#define AMPDU_MAX_HE	48		/**< HE rate 0-11, 4 streams */
#define	AMPDU_MAX_HE_GI	4		/**< HE guard interval count */
...
#define AMPDU_PPDU_FT_SU	0
#define AMPDU_PPDU_FT_VHTMU	1 /**< VHT MUMIMO */
#define AMPDU_PPDU_FT_HEMMU	2 /**< HE MUMIMO */
#define AMPDU_PPDU_FT_HEOMU	3 /**< HE MU OFDMA */
#define AMPDU_PPDU_FT_HEMOM	4 /**< HE MUMIMO + OFDMA */
#define AMPDU_PPDU_FT_MAX	5

#define AMPDU_PPDU_FT(txmu, mutype) ((txmu) ? mutype + AMPDU_PPDU_FT_VHTMU : 0)
...
extern void *wlc_send_bar(wlc_info_t *wlc, struct scb *scb, uint8 tid,
	uint16 start_seq, uint16 cf_policy, bool *blocked);
