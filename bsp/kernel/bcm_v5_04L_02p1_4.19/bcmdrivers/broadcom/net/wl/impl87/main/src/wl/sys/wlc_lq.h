 ...
 *
 * $Id: wlc_lq.h 797487 2021-04-06 06:33:36Z $
 */
...
extern int td_em_chanim_get_stats_cb(chanim_info_t *c_info, wl_chanim_stats_t* iob, int *len, int cnt);
#endif
...
int8 wlc_lq_chanim_phy_noise(wlc_info_t *wlc);
