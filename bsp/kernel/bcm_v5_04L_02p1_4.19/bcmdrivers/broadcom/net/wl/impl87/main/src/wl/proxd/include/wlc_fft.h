 ...
 *
 * $Id: wlc_fft.h 790849 2020-09-04 16:21:01Z $
 */
#ifndef _wlc_fft_h
#define _wlc_fft_h
...
extern void tof_retrieve_thresh(void* pparams, uint16* bitflip_thresh, uint16* snr_thresh);
extern int tof_find_window(void *pparams, uint32 *pW, uint32 *pWr, uint32 max, int *pmax,
		int *wzero, int *wpos, int mask, int rx, bool longwin_en, uint32 *thresh,
