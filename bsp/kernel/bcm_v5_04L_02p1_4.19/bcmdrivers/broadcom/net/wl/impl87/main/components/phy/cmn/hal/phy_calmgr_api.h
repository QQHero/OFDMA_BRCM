...
int phy_calmgr_init(phy_info_t *pi);
int phy_calmgr_enable_initcal(phy_info_t *pi, bool initcal);
...
int phy_calmgr_set_glacial_timer(phy_info_t *pi, uint period);
uint32 phy_calmgr_get_cal_dur(phy_info_t *pi);
