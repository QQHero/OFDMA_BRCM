 ...
 *
 * $Id: phy_ac_radio.h 803340 2021-09-24 08:53:03Z $
 */
...
struct phy_ac_radio_info {
	...
	int32	wbcal_afediv_ratio; /* bit 0-5: nad, bit 8-13: nda */

	/* 6715: Need to make tiapu = 1 for FF(-40) rxiqcal stability, +1 for coverity */
	uint16 tia_cfg1_ovr[PHY_CORE_MAX+1], tia_reg7[PHY_CORE_MAX+1];
...
extern void wlc_phy_radio2069_check_vco_cal_acphy(phy_info_t *pi);
...
extern void wlc_phy_radio20708_tx2cal_normal_adc_rate(phy_info_t *pi, bool use_ovr,
	bool is_lowrate_mode);
extern void wlc_phy_radio20708_hssmpl_buffer_setup(phy_info_t *pi, uint16 p,
	uint16 q, uint16 max_val);
extern void wlc_phy_radio20708_hs_loopback(phy_info_t *pi, bool swap_ab, uint16 DepthCount);

extern void wlc_phy_radio20709_afe_div_ratio(phy_info_t *pi, uint8 use_ovr);
extern void wlc_phy_radio20710_afe_div_ratio(phy_info_t *pi, uint8 use_ovr, uint8 dac_rate_mode,
		bool wbcal);
...
extern void wlc_phy_radio20708_refdoubler_delay_cal(phy_info_t *pi);
...
#endif /* WLTEST */
int phy_ac_get_wbcal_afediv_ratio(phy_ac_radio_info_t *radioi, int32 *ret_val);
int phy_ac_set_wbcal_afediv_ratio(phy_ac_radio_info_t *radioi, int32 set_val);
