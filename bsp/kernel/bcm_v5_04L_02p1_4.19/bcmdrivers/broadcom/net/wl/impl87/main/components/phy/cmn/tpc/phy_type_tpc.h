 ...
 *
 * $Id: phy_type_tpc.h 785011 2020-03-10 22:27:57Z $
 */
...
typedef struct phy_tpc_data {
	...
	/* ptr to RL/BL power offsets as ucode ULTPC input */
	ppr_ru_offset_t* ru_pwroffset;
	...
	bool	phy_ultpc_ppr_dis; /* override */
