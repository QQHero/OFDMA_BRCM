 ...
 *
 * $Id: wlc_esp.h 803989 2021-10-14 19:10:00Z $
 *
 */
...
#define CHAN_UTIL_DIFF_THRESH 10
...
extern uint8 wlc_esp_ie_calc_len_with_dynamic_list(wlc_esp_info_t *esp);
extern int wlc_esp_write_esp_element(wlc_info_t *wlc, uint8 *cp, uint buf_len);
