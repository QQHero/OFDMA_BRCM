 ...
 *
 * $Id: wlc_amsdu.h 804042 2021-10-18 10:05:35Z $
*/
...
extern int32 wlc_amsdu_pktc_deagg_hw(amsdu_info_t *ami, void **pp, wlc_rfc_t *rfc,
        uint16 *index, bool *chained_sendup, struct scb *scb, uint16 sec_offset, uint16 fc);
...
extern uint32 wlc_amsdu_msdu_cnt(osl_t *osh, void *p);

extern uint8 wlc_amsdu_agg_attempt(amsdu_info_t *ami, struct scb *scb, struct pktq *pktq, void *p,
