 ...
 *
 * $Id: wlc_wds.h 803018 2021-09-14 08:39:29Z $
*/
...
#endif /* WLCSA */
extern void wlc_wds_scb_switch_queue(wlc_info_t *wlc, wlc_bsscfg_t *cfg, wlc_txq_info_t *new_q);
...
#endif /* DWDS */
#ifdef WL_HAPD_WDS
extern bool wlc_wds_is_legacy_wds_sta(wlc_info_t *wlc, struct ether_addr *remote_mac);
extern void wlc_wds_reset_link_flag(wlc_info_t *wlc, struct scb *scb);
extern bool wlc_wds_check_association(wlc_info_t *wlc, struct scb *scb);
#endif /* WL_HAPD_WDS */
...
#define wlc_wds_scb_switch_queue(a, b, c) do {} while (0)
...
#define wlc_wds_is_legacy_wds_sta(a, b) do {} while (0)
#define wlc_wds_reset_link_flag(a, b) do {} while (0)
#define wlc_wds_check_association(a, b) do {} while (0)
#endif /* !WDS */
