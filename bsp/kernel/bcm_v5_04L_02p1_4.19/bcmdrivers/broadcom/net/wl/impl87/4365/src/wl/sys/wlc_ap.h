 ...
 *
 * $Id: wlc_ap.h 798477 2021-05-05 04:31:53Z $
 */
#ifndef _WLC_AP_H_
#define _WLC_AP_H_
...
extern void wlc_ap_process_assocreq(wlc_ap_info_t *ap, wlc_bsscfg_t *bsscfg,
	struct dot11_management_header *hdr, uint8 *body, uint body_len, struct scb *scb,
	wlc_d11rxhdr_t *wrxh, bool short_preamble);
...
#define wlc_ap_process_assocreq(a, b, c, d, e, f, g, h) do {} while (0)
