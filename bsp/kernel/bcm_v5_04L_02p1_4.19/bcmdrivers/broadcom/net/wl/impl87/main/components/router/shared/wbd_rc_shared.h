...
extern void wbd_unset_self_fbt_nvrams(char *prefix);

/* Unset peer fbt nvrams for this BSS & ap_name */
extern void wbd_unset_peer_fbt_nvrams(char *ap_name);
 ...
 */
extern uint32 wbd_unset_nonactive_peer_fbt_nvrams(char *prefix, char *old_fbt_aps,
	char *new_fbt_aps);

/* DeInitialize FBT NVRAMs for this BSS on Downstream AP */
extern uint32 wbd_dap_deinit_fbt_nvram_config(char *prefix);

/* Unset fbt NVRAMs for this BSS */
extern void wbd_unset_fbt(char *prefix);
...
extern int wbd_strong_sta_identification(struct ether_addr *sta_mac,
	wbd_strong_sta_metrics_t *sta_stats, wbd_strong_sta_policy_t *thresholds);
