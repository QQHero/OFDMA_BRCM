...
static int get_he_rate_identifier(int he_mcs_index);
static int get_he_ss1_mode_identifier(int tx_expansion, exp_mode_t mode);
static int get_he_ss2_mode_identifier(int tx_expansion, exp_mode_t mode);
static int get_he_ss3_mode_identifier(int tx_expansion, exp_mode_t mode);
static int get_he_ss4_mode_identifier(int tx_expansion, exp_mode_t mode);
...
enum {
	HE_SS1_MODE_ID_NONE = 0,
	HE_SS1_MODE_ID_CDD1,
	HE_SS1_MODE_ID_CDD2,
	HE_SS1_MODE_ID_CDD3,
	HE_SS1_MODE_ID_TXBF1,
	HE_SS1_MODE_ID_TXBF2,
	HE_SS1_MODE_ID_TXBF3,
	HE_SS1_MODE_ID_MAX
};

enum {
	HE_SS2_MODE_ID_NONE = 0,
	HE_SS2_MODE_ID_SPEXP1,
	HE_SS2_MODE_ID_SPEXP2,
	HE_SS2_MODE_ID_TXBF0,
	HE_SS2_MODE_ID_TXBF1,
	HE_SS2_MODE_ID_TXBF2,
	HE_SS2_MODE_ID_MAX
};

enum {
	HE_SS3_MODE_ID_NONE = 0,
	HE_SS3_MODE_ID_SPEXP1,
	HE_SS3_MODE_ID_TXBF0,
	HE_SS3_MODE_ID_TXBF1,
	HE_SS3_MODE_ID_MAX
};

enum {
	HE_SS4_MODE_ID_NONE = 0,
	HE_SS4_MODE_ID_TXBF0,
	HE_SS4_MODE_ID_MAX
};
...
const char *clm_rate_group_labels[] = {
	...
	"HE_LUB0_11SS2",
	"HE_LUB0_11SS1_CDD2",
	"HE_LUB0_11SS2_SPEXP1",
	"HE_LUB0_11SS3",
	"HE_LUB0_11SS1_CDD3",
	"HE_LUB0_11SS2_SPEXP2",
	"HE_LUB0_11SS3_SPEXP1",
	"HE_LUB0_11SS4",
	"HE_LUB0_11SS1_TXBF1",
	"HE_LUB0_11SS2_TXBF0",
	"HE_LUB0_11SS1_TXBF2",
...
int he_ss1_reg_rate_map[HE_RATE_INDEX_MAX][HE_SS1_MODE_ID_MAX] = {
	{HE0SS1, HE0SS1_CDD1, HE0SS1_CDD2, HE0SS1_CDD3, HE0SS1_TXBF1, HE0SS1_TXBF2, HE0SS1_TXBF3},
	{HE1SS1, HE1SS1_CDD1, HE1SS1_CDD2, HE1SS1_CDD3, HE1SS1_TXBF1, HE1SS1_TXBF2, HE1SS1_TXBF3},
	{HE2SS1, HE2SS1_CDD1, HE2SS1_CDD2, HE2SS1_CDD3, HE2SS1_TXBF1, HE2SS1_TXBF2, HE2SS1_TXBF3},
	{HE3SS1, HE3SS1_CDD1, HE3SS1_CDD2, HE3SS1_CDD3, HE3SS1_TXBF1, HE3SS1_TXBF2, HE3SS1_TXBF3},
	{HE4SS1, HE4SS1_CDD1, HE4SS1_CDD2, HE4SS1_CDD3, HE4SS1_TXBF1, HE4SS1_TXBF2, HE4SS1_TXBF3},
	{HE5SS1, HE5SS1_CDD1, HE5SS1_CDD2, HE5SS1_CDD3, HE5SS1_TXBF1, HE5SS1_TXBF2, HE5SS1_TXBF3},
	{HE6SS1, HE6SS1_CDD1, HE6SS1_CDD2, HE6SS1_CDD3, HE6SS1_TXBF1, HE6SS1_TXBF2, HE6SS1_TXBF3},
	{HE7SS1, HE7SS1_CDD1, HE7SS1_CDD2, HE7SS1_CDD3, HE7SS1_TXBF1, HE7SS1_TXBF2, HE7SS1_TXBF3},
	{HE8SS1, HE8SS1_CDD1, HE8SS1_CDD2, HE8SS1_CDD3, HE8SS1_TXBF1, HE8SS1_TXBF2, HE8SS1_TXBF3},
	{HE9SS1, HE9SS1_CDD1, HE9SS1_CDD2, HE9SS1_CDD3, HE9SS1_TXBF1, HE9SS1_TXBF2, HE9SS1_TXBF3},
	{HE10SS1, HE10SS1_CDD1, HE10SS1_CDD2, HE10SS1_CDD3, HE10SS1_TXBF1, HE10SS1_TXBF2, HE10SS1_TXBF3},
	{HE11SS1, HE11SS1_CDD1, HE11SS1_CDD2, HE11SS1_CDD3, HE11SS1_TXBF1, HE11SS1_TXBF2, HE11SS1_TXBF3},
};

int he_ss2_reg_rate_map[HE_RATE_INDEX_MAX][HE_SS2_MODE_ID_MAX] = {
	{HE0SS2, HE0SS2_SPEXP1, HE0SS2_SPEXP2, HE0SS2_TXBF0, HE0SS2_TXBF1, HE0SS2_TXBF2},
	{HE1SS2, HE1SS2_SPEXP1, HE1SS2_SPEXP2, HE1SS2_TXBF0, HE1SS2_TXBF1, HE1SS2_TXBF2},
	{HE2SS2, HE2SS2_SPEXP1, HE2SS2_SPEXP2, HE2SS2_TXBF0, HE2SS2_TXBF1, HE2SS2_TXBF2},
	{HE3SS2, HE3SS2_SPEXP1, HE3SS2_SPEXP2, HE3SS2_TXBF0, HE3SS2_TXBF1, HE3SS2_TXBF2},
	{HE4SS2, HE4SS2_SPEXP1, HE4SS2_SPEXP2, HE4SS2_TXBF0, HE4SS2_TXBF1, HE4SS2_TXBF2},
	{HE5SS2, HE5SS2_SPEXP1, HE5SS2_SPEXP2, HE5SS2_TXBF0, HE5SS2_TXBF1, HE5SS2_TXBF2},
	{HE6SS2, HE6SS2_SPEXP1, HE6SS2_SPEXP2, HE6SS2_TXBF0, HE6SS2_TXBF1, HE6SS2_TXBF2},
	{HE7SS2, HE7SS2_SPEXP1, HE7SS2_SPEXP2, HE7SS2_TXBF0, HE7SS2_TXBF1, HE7SS2_TXBF2},
	{HE8SS2, HE8SS2_SPEXP1, HE8SS2_SPEXP2, HE8SS2_TXBF0, HE8SS2_TXBF1, HE8SS2_TXBF2},
	{HE9SS2, HE9SS2_SPEXP1, HE9SS2_SPEXP2, HE9SS2_TXBF0, HE9SS2_TXBF1, HE9SS2_TXBF2},
	{HE10SS2, HE10SS2_SPEXP1, HE10SS2_SPEXP2, HE10SS2_TXBF0, HE10SS2_TXBF1, HE10SS2_TXBF2},
	{HE11SS2, HE11SS2_SPEXP1, HE11SS2_SPEXP2, HE11SS2_TXBF0, HE11SS2_TXBF1, HE11SS2_TXBF2},
};

int he_ss3_reg_rate_map[HE_RATE_INDEX_MAX][HE_SS3_MODE_ID_MAX] = {
	{HE0SS3, HE0SS3_SPEXP1, HE0SS3_TXBF0, HE0SS3_TXBF1},
	{HE1SS3, HE1SS3_SPEXP1, HE1SS3_TXBF0, HE1SS3_TXBF1},
	{HE2SS3, HE2SS3_SPEXP1, HE2SS3_TXBF0, HE2SS3_TXBF1},
	{HE3SS3, HE3SS3_SPEXP1, HE3SS3_TXBF0, HE3SS3_TXBF1},
	{HE4SS3, HE4SS3_SPEXP1, HE4SS3_TXBF0, HE4SS3_TXBF1},
	{HE5SS3, HE5SS3_SPEXP1, HE5SS3_TXBF0, HE5SS3_TXBF1},
	{HE6SS3, HE6SS3_SPEXP1, HE6SS3_TXBF0, HE6SS3_TXBF1},
	{HE7SS3, HE7SS3_SPEXP1, HE7SS3_TXBF0, HE7SS3_TXBF1},
	{HE8SS3, HE8SS3_SPEXP1, HE8SS3_TXBF0, HE8SS3_TXBF1},
	{HE9SS3, HE9SS3_SPEXP1, HE9SS3_TXBF0, HE9SS3_TXBF1},
	{HE10SS3, HE10SS3_SPEXP1, HE10SS3_TXBF0, HE10SS3_TXBF1},
	{HE11SS3, HE11SS3_SPEXP1, HE11SS3_TXBF0, HE11SS3_TXBF1},
};

int he_ss4_reg_rate_map[HE_RATE_INDEX_MAX][HE_SS4_MODE_ID_MAX] = {
	{HE0SS4, HE0SS4_TXBF0},
	{HE1SS4, HE1SS4_TXBF0},
	{HE2SS4, HE2SS4_TXBF0},
	{HE3SS4, HE3SS4_TXBF0},
	...
	{HE8SS4, HE8SS4_TXBF0},
	{HE9SS4, HE9SS4_TXBF0},
	{HE10SS4, HE10SS4_TXBF0},
	{HE11SS4, HE11SS4_TXBF0},
};
...
get_reg_rate_index_from_ratespec(int ratespec)
{
	...
	if (encode == WL_RSPEC_ENCODE_RATE) {
		...
		uint mcs = (ratespec & WL_RSPEC_HE_MCS_MASK);
		uint nss = (ratespec & WL_RSPEC_HE_NSS_MASK) >> WL_RSPEC_HE_NSS_SHIFT;
		rate_index = get_he_reg_rate_index(mcs, nss, txexp, expmode);
	}
...
reg_rate_index_t
get_he_reg_rate_index(int mcs, int nss, int tx_expansion, exp_mode_t expmode)
{
	reg_rate_index_t rate_index = NO_RATE;
	int rate_id = get_he_rate_identifier(mcs);

	if (nss == 1) {
		rate_index = he_ss1_reg_rate_map[rate_id][get_he_ss1_mode_identifier(tx_expansion, expmode)];
	} else if (nss == 2) {
		rate_index = he_ss2_reg_rate_map[rate_id][get_he_ss2_mode_identifier(tx_expansion, expmode)];
	} else if (nss == 3) {
		rate_index = he_ss3_reg_rate_map[rate_id][get_he_ss3_mode_identifier(tx_expansion, expmode)];
	} else if (nss == 4) {
		rate_index = he_ss4_reg_rate_map[rate_id][get_he_ss4_mode_identifier(tx_expansion, expmode)];
	}
...
static int
get_he_rate_identifier(int he_mcs_index)
{
	int rate_index = 0;

	if (he_mcs_index >= HE_RATE_INDEX_0 && he_mcs_index < HE_RATE_INDEX_MAX) {
		rate_index = he_mcs_index;
	} else {
		fprintf(stderr, "ERROR: Bad he mcs spec: %d\n", he_mcs_index);
	}
	return rate_index;
}

static int
get_he_ss1_mode_identifier(int tx_expansion, exp_mode_t expmode)
{
	int mode_identifier = 0;
	...
	if (tx_expansion == 0) {
		...
		{
			case EXP_MODE_ID_DEF:
				mode_identifier = HE_SS1_MODE_ID_NONE;
				break;
			default:
				fprintf(stderr, "ERROR: Bad he ss1 mode: %d, expansion mode %s\n", tx_expansion,
						get_mode_name(expmode));
				break;
		}
	} else if (tx_expansion == 1) {
		...
		{
			case EXP_MODE_ID_DEF:
				mode_identifier = HE_SS1_MODE_ID_CDD1;
				break;
			case EXP_MODE_ID_TXBF:
				mode_identifier = HE_SS1_MODE_ID_TXBF1;
				break;
			default:
				fprintf(stderr, "ERROR: Bad he ss1 mode: %d, expansion mode %s\n", tx_expansion,
						get_mode_name(expmode));
		...
		{
			case EXP_MODE_ID_DEF:
				mode_identifier = HE_SS1_MODE_ID_CDD2;
				break;
			case EXP_MODE_ID_TXBF:
				mode_identifier = HE_SS1_MODE_ID_TXBF2;
				break;
			default:
				fprintf(stderr, "ERROR: Bad he ss1 mode: %d, expansion mode %s\n", tx_expansion,
						get_mode_name(expmode));
		...
		{
			case EXP_MODE_ID_DEF:
				mode_identifier = HE_SS1_MODE_ID_CDD3;
				break;
			case EXP_MODE_ID_TXBF:
				mode_identifier = HE_SS1_MODE_ID_TXBF3;
				break;
			default:
				fprintf(stderr, "ERROR: Bad he ss1 mode: %d, expansion mode %s\n", tx_expansion,
						get_mode_name(expmode));
...
static int
get_he_ss2_mode_identifier(int tx_expansion, exp_mode_t expmode)
{
	int mode_identifier = 0;
	...
	if (tx_expansion == 0) {
		...
		{
		case EXP_MODE_ID_DEF:
			mode_identifier = HE_SS2_MODE_ID_NONE;
			break;
		case EXP_MODE_ID_TXBF:
			mode_identifier = HE_SS2_MODE_ID_TXBF0;
			break;
		default:
			fprintf(stderr, "ERROR: Bad he ss2 mode: %d, expansion mode %s\n", tx_expansion,
				get_mode_name(expmode));
			break;
		}
	} else if (tx_expansion == 1) {
		...
		{
		case EXP_MODE_ID_DEF:
			mode_identifier = HE_SS2_MODE_ID_SPEXP1;
			break;
		case EXP_MODE_ID_TXBF:
			mode_identifier = HE_SS2_MODE_ID_TXBF1;
			break;
		default:
			fprintf(stderr, "ERROR: Bad he ss2 mode: %d, expansion mode %s\n", tx_expansion,
				  get_mode_name(expmode));
		...
		{
		case EXP_MODE_ID_DEF:
			mode_identifier = HE_SS2_MODE_ID_SPEXP2;
			break;
		case EXP_MODE_ID_TXBF:
			mode_identifier = HE_SS2_MODE_ID_TXBF2;
			break;
		default:
			fprintf(stderr, "ERROR: Bad he ss2 mode: %d, expansion mode %s\n", tx_expansion,
				  get_mode_name(expmode));
...
static int
get_he_ss3_mode_identifier(int tx_expansion, exp_mode_t expmode)
{
	int mode_identifier = 0;
	...
	if (tx_expansion == 0) {
		...
		{
		case EXP_MODE_ID_DEF:
			mode_identifier = HE_SS3_MODE_ID_NONE;
			break;
		case EXP_MODE_ID_TXBF:
			mode_identifier = HE_SS3_MODE_ID_TXBF0;
			break;
		default:
			fprintf(stderr, "ERROR: Bad he ss3 mode: %d, expansion mode: %s\n", tx_expansion
					, get_mode_name(expmode));
			break;
		}
	} else if (tx_expansion == 1) {
		...
		{
		case EXP_MODE_ID_DEF:
			mode_identifier = HE_SS3_MODE_ID_SPEXP1;
			break;
		case EXP_MODE_ID_TXBF:
			mode_identifier = HE_SS3_MODE_ID_TXBF1;
			break;
		default:
			fprintf(stderr, "ERROR: Bad he ss3 mode: %d, expansion mode: %s\n", tx_expansion
					, get_mode_name(expmode));
		...
		fprintf(stderr, "ERROR: Bad he ss3 mode: %d, expansion: %s\n", tx_expansion,
			   get_mode_name(expmode));
	}
...
static int
get_he_ss4_mode_identifier(int tx_expansion, exp_mode_t expmode)
{
	int mode_identifier = 0;
	...
	if (tx_expansion == 0) {
		...
		{
		case EXP_MODE_ID_DEF:
			mode_identifier = HE_SS4_MODE_ID_NONE;
			break;
		case EXP_MODE_ID_TXBF:
			mode_identifier = HE_SS4_MODE_ID_TXBF0;
			break;
		default:
			fprintf(stderr, "ERROR: Bad he ss4 mode: %d, expansion mode: %s\n", tx_expansion
					, get_mode_name(expmode));
			break;
		}
	} else {
		fprintf(stderr, "ERROR: Bad he ss4 mode: %d, expansion: %s\n", tx_expansion,
			   get_mode_name(expmode));
	}
