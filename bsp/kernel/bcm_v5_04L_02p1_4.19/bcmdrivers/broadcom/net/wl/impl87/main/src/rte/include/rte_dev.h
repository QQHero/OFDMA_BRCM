 ...
 *
 * $Id: rte_dev.h 794653 2021-01-14 08:56:19Z $
 */
...
/* Device entry points */
struct hnd_dev_ops {
	void *(*probe)(hnd_dev_t *dev, volatile void *regs, uint bus,
	...
	/* SCB - Flow ring Linkup */
	int (*flowring_link_update)(hnd_dev_t *dev, uint16 ringid, uint8 tid, uint8* da, uint8 op,
		uint8** tcb_state, uint16* scb_flowid, uint8* mode);
};
...
struct hnd_dev {
	...
	void		*commondata;
	void		*pdev;
	void		*priv;			/**< used to e.g. store wlif */
};
