 ...
 *
 * $Id: wlc_tpc.h 780755 2019-11-01 22:02:07Z $
*/
...
#include <phy_api.h>	/* provides: phy_tx_targets_per_core_t */
...
/* common queries for txpwr related info */
extern int wlc_tpc_get_txpwrs(wlc_info_t *wlc, ratespec_t rspec, txpwr204080_t *pwrs);
extern int wlc_tpc_get_target_offset(wlc_info_t *wlc, ratespec_t rspec, uint8 *offset);
/* Function to retrieve Tx power target per core for the giving rate spec */
extern int wlc_tpc_get_tx_target_per_core(wlc_info_t *wlc, ratespec_t rspec,
...
#define wlc_tpc_get_pwr_cap_min(tpc) 0
#endif /* !WLTPC */
