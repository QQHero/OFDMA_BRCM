 ...
 *
 * $Id: threadx_arm.c 804053 2021-10-18 16:20:23Z $
 */
...
/*
 * Define the symbols needed to support GCC stack protector.
 * NOT to be mistaken with threadx stack protection
 */
#ifdef DONGLEBUILD
...
{
	__stack_chk_guard = 0xa5a5a5a5;
}
void __stack_chk_fail(void)
{
	printf("stack-protector: Dongle stack is corrupted\n");
}
#endif /* DONGLEBUILD */
