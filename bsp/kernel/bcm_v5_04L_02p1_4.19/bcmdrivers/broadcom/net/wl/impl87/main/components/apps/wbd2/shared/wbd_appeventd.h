 ...
 *
 * $Id: wbd_appeventd.h 783904 2020-02-12 08:54:21Z $
 */
...
/*
 * Routine to controller detected event from wbd to appeventd.
 * Params:
 * @evt: Event id
 * @device_id: Controller device al mac.
 */
extern void wbd_appevetd_controller_detected(int evt, struct ether_addr *device_id);
