...
#define	EPI_VERSION		17, 10, 188, 75

#define	EPI_VERSION_NUM		0x110abc4b
...
#if defined(WLTEST)
#define	EPI_VERSION_STR		"17.10.188.75 (r811021 WLTEST)" EPI_CUSTOM_VER
#elif defined(BCMDBG)
#define	EPI_VERSION_STR		"17.10.188.75 (r811021 BCMDBG)" EPI_CUSTOM_VER
#else
#define	EPI_VERSION_STR		"17.10.188.75 (r811021)" EPI_CUSTOM_VER
#endif
