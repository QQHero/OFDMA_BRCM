 ...
 *
 * $Id: wlc_ie_mgmt_types.h 785259 2020-03-18 11:40:09Z $
 */
...
#include <bcmutils.h>
#include <wlc_types.h>
#include <ethernet.h>	/* to get wlc_wrxh_t in d11.h */
#include <d11.h>
...
struct wlc_iem_cbparm {
	uint8 bandunit;	/* band to which the frame will be sent. See WLC_xG_INDEX */
	bool ht;	/* include ht components */
	bool vht;	/* include vht components */
	bool he;	/* include he components */
 ...
 *
 * For meta data (wrxh, plcp, hdr, body, etc), users (caller and callbacks) must be in an agreement
 * as to when and where they are available.
 */
