 ...
 *
 * $Id: wlc_bs_data.h 786299 2020-04-23 08:47:44Z $
 */
...
struct wlc_bs_data_counters {
	...
	uint32 txbw;           /* v2 only : bw in use */
	uint32 txmcs;          /* v2 only : mcs in use */
	uint32 txnss;          /* v2 only : nss in use */
};
