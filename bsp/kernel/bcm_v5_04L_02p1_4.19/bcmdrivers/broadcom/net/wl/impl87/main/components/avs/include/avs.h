...
int avs_tracking_switch(avs_context_t *avs, bool tracking);
...
int avs_set_dac(avs_context_t *avs, uint value);
int avs_set_vnominal(avs_context_t *avs, uint value);
int avs_set_vlocalfit(avs_context_t *avs, uint value);
int avs_dump_osccnt(avs_context_t *avs);
int avs_set_trace(avs_context_t *avs, uint value);
int avs_set_flags(avs_context_t *avs, uint value);
