...
/* 6G subband 0 LNA1 and Gm Gain dB table for 47622 */
int8 BCMATTACHDATA(lna12_gain_tbl_6gs0_20704rX)[2][N_LNA12_GAINS] = {
	{-9, -3, 3, 9, 15, 15, -8}, /* LNA1 Table */
	{0, 0, 0, 0}          /* Gm Table */
};

/* 6G subband 1 LNA1 and Gm Gain dB table for 47622 */
int8 BCMATTACHDATA(lna12_gain_tbl_6gs1_20704rX)[2][N_LNA12_GAINS] = {
	{-9, -3, 3, 9, 15, 15, -8}, /* LNA1 Table */
	{0, 0, 0, 0}          /* Gm Table */
};

/* 6G subband 2 LNA1 and Gm Gain dB table for 47622 */
int8 BCMATTACHDATA(lna12_gain_tbl_6gs2_20704rX)[2][N_LNA12_GAINS] = {
	{-11, -5, 1, 7, 13, 13, -8}, /* LNA1 Table */
	{0, 0, 0, 0}          /* Gm Table */
};

/* 6G subband 3 LNA1 and Gm Gain dB table for 47622 */
int8 BCMATTACHDATA(lna12_gain_tbl_6gs3_20704rX)[2][N_LNA12_GAINS] = {
	{-12, -8, -2, 4, 10, 10, -8}, /* LNA1 Table */
	{0, 0, 0, 0}          /* Gm Table */
};

/* 6G subband 4 LNA1 and Gm Gain dB table for 47622 */
int8 BCMATTACHDATA(lna12_gain_tbl_6gs4_20704rX)[2][N_LNA12_GAINS] = {
	{-12, -8, -2, 4, 10, 10, -8}, /* LNA1 Table */
	{0, 0, 0, 0}          /* Gm Table */
};

/* 6G subband 5 LNA1 and Gm Gain dB table for 47622 */
int8 BCMATTACHDATA(lna12_gain_tbl_6gs5_20704rX)[2][N_LNA12_GAINS] = {
	{-15, -9, -3, 3, 9, 9, -8}, /* LNA1 Table */
	{0, 0, 0, 0}          /* Gm Table */
};

/* 6G subband 6 LNA1 and Gm Gain dB table for 47622 */
int8 BCMATTACHDATA(lna12_gain_tbl_6gs6_20704rX)[2][N_LNA12_GAINS] = {
	{-16, -10, -4, 2, 8, 8, -8}, /* LNA1 Table */
	{0, 0, 0, 0}          /* Gm Table */
};
...
uint8 BCMATTACHDATA(lna1_rout_map_2g_20704rX_elna)[N_LNA12_GAINS] = { 9, 9, 9, 9, 9, 9, 9};
uint8 BCMATTACHDATA(lna1_gain_map_2g_20704rX_elna)[N_LNA12_GAINS] = {  3,  4,  5,  6, 7, 7, 6};
...
uint8 BCMATTACHDATA(lna1_rout_map_6gs0_20704rX)[N_LNA12_GAINS] = { 10,  9, 7, 7, 7, 7, 11 };
uint8 BCMATTACHDATA(lna1_gain_map_6gs0_20704rX)[N_LNA12_GAINS] = {  2,  3, 4, 5, 6, 6, 6  };
uint8 BCMATTACHDATA(lna1_rout_map_6gs1_20704rX)[N_LNA12_GAINS] = { 10,  7, 0, 0, 0, 0, 11 };
uint8 BCMATTACHDATA(lna1_gain_map_6gs1_20704rX)[N_LNA12_GAINS] = {  2,  3, 4, 5, 6, 6, 6  };
uint8 BCMATTACHDATA(lna1_rout_map_6gs2_20704rX)[N_LNA12_GAINS] = { 11,  9, 5, 0, 0, 0, 11 };
uint8 BCMATTACHDATA(lna1_gain_map_6gs2_20704rX)[N_LNA12_GAINS] = {  2,  3, 4, 5, 6, 6, 6  };
uint8 BCMATTACHDATA(lna1_rout_map_6gs3_20704rX)[N_LNA12_GAINS] = { 11, 10, 6, 5, 0, 0, 11 };
uint8 BCMATTACHDATA(lna1_gain_map_6gs3_20704rX)[N_LNA12_GAINS] = {  2,  3, 4, 5, 6, 6, 6  };
uint8 BCMATTACHDATA(lna1_rout_map_6gs4_20704rX)[N_LNA12_GAINS] = { 11, 10, 6, 5, 0, 0, 11 };
uint8 BCMATTACHDATA(lna1_gain_map_6gs4_20704rX)[N_LNA12_GAINS] = {  2,  3, 4, 5, 6, 6, 6  };
uint8 BCMATTACHDATA(lna1_rout_map_6gs5_20704rX)[N_LNA12_GAINS] = { 11, 10, 6, 5, 0, 0, 11 };
uint8 BCMATTACHDATA(lna1_gain_map_6gs5_20704rX)[N_LNA12_GAINS] = {  2,  3, 4, 5, 6, 6, 6  };
uint8 BCMATTACHDATA(lna1_rout_map_6gs6_20704rX)[N_LNA12_GAINS] = { 11, 10, 6, 5, 0, 0, 11 };
uint8 BCMATTACHDATA(lna1_gain_map_6gs6_20704rX)[N_LNA12_GAINS] = {  2,  3, 4, 5, 6, 6, 6  };
