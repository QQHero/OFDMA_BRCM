 ...
 *
 * $Id: phy_type_papdcal.h 802962 2021-09-10 22:14:35Z $
 */
...
typedef struct {
	...
	phy_type_papdcal_get_var_fn_t get_wbpapd_gctrl;
	phy_type_papdcal_set_int32_fn_t set_wbpapd_gctrl;
	phy_type_papdcal_get_var_fn_t get_wbpapd_multitbl;
	phy_type_papdcal_set_int32_fn_t set_wbpapd_multitbl;
	phy_type_papdcal_get_var_fn_t get_wbpapd_sampcapt;
	phy_type_papdcal_set_int32_fn_t set_wbpapd_sampcapt;
	phy_type_papdcal_get_var_fn_t get_peak_psd_limit;
	phy_type_papdcal_set_int32_fn_t set_peak_psd_limit;
