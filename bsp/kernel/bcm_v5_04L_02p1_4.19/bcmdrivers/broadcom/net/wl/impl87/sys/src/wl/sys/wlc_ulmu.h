 ...
 *
 * $Id: wlc_ulmu.h 803989 2021-10-14 19:10:00Z $
 */
...
#define ULMU_TRIG_FIFO			TX_ATIM_FIFO
...
extern uint16 BCMFASTPATH wlc_ulmu_taf_get_qlen(void *ulmuh, void *scbh, void *tidh, uint32 ts);
extern bool   BCMFASTPATH wlc_ulmu_taf_update(void *ulmuh, void *scbh, void *tidh, uint32 ts);
...
extern uint32 wlc_ulmu_pend_trig_cnt(wlc_ulmu_info_t *ulmu, struct scb* scb);
#ifdef WL11AX
extern void wlc_ulmu_scb_bw_upd(wlc_info_t *wlc, scb_t *scb, uint8 bw);
extern void wlc_ulmu_evaluate_admission(wlc_ulmu_info_t *ulmu, scb_t *scb);
#else
#define wlc_ulmu_scb_bw_upd(wlc, scb, bw) (0)
#define wlc_ulmu_evaluate_admission(ulmu, scb)
#endif /* WL11AX */
#endif /* _wlc_ulmu_h_ */
