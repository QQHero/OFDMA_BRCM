# Makefile for hndrte based 43684c0 full ram Image
#
...
WLCONFFILE	:= wlconfig_rte_43684c0_dev
WLTUNEFILE	:= wltunable_rte_43684c0.h
...
ifeq ($(call opt,hwa),1)
	# HWA Core Rev 130
	EXTRA_DFLAGS    += -DHWACONF=0x00000004

	# Must be in MODE 4
	WL_SPLITRX_MODE	:= 4

	# 43684C0 uses HWA2.1 SW Driver revision
	BCMHWA := 130
...
# Do not enable the Event pool for 43684c0
...
ifeq ($(call opt,cu),1)
# HND CPU Utilization Tool for Threadx. When activated, disable ARM LowPowerMode
