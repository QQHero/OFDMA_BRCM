 ...
 *
 * $Id: wlc_monitor.h 770937 2019-01-09 01:35:20Z $
 */
...
extern struct ether_addr* wlc_monitor_get_align_ea(wlc_monitor_info_t *pmoninfo);
#ifdef WLTXMONITOR
extern void wlc_tx_monitor(wlc_info_t *wlc, d11txhdr_t *txh, tx_status_t *txs, void *p,
                    struct wlc_if *wlcif);
#endif
