...
#
# $Id: validate_gpl.sh 726155 2017-10-11 18:52:06Z $
#
...
pattern='UNPUBLISHED PROPRIETARY SOURCE CODE of Broadcom|This program is the proprietary software of Broadcom'
grep --exclude-dir=opensource -l -r -E "$pattern" "$1/" > $TMP
nongpl=$?
