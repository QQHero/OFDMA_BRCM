 ...
 *
 * $Id: wlc_addrmatch.h 785970 2020-04-11 14:45:03Z $
 */
...
typedef enum {
	...
	C_ADDR_DEFKEY_NBIT		= 3,	// Is WEP default key valid
	C_ADDR_MESHCCA_GE128_NBIT	= 4,	// CCA_MESH capability for AX chip
	C_ADDR_BFIIDX_LT128_NBIT	= 4,	// index into M_BFI_BLK
	C_ADDR_BFIIDX_LT128_LB		= 7,	// last bit
	C_ADDR_MONITOR_NBIT		= 10,	// Monitor other STA
	C_ADDR_ACKMCAST_NBIT		= 11,	// ACK B/Mcast from this TA
	C_ADDR_BFCAP_LT128_NBIT		= 12,	// Beamforming
	C_ADDR_MESHCCA_LT128_NBIT	= 13,	// CCA_MESH capability for AC chip
} eAddressBitmapDefinitions;
#define C_ADDR_BFIIDX_LT128_BSZ        (C_ADDR_BFIIDX_LT128_LB - C_ADDR_BFIIDX_LT128_NBIT + 1)
