 ...
 *
 * $Id: airiq_app.c 809259 2022-03-10 16:25:50Z $
 */
...
#define MAX_IF                     3
char cfg_ifname[MAX_IF][IFNAMSIZ];
int  cfg_ifcount      = 0;
int  cfg_2gidx        = 0;
int  cfg_5gidx        = 0;
bool cfg_verbose      = 0;
...
#define MAX_SCAN_CHAN_COUNT 14
typedef struct {
	int count;
	int chan3x3;
	chanspec_t channels[MAX_SCAN_CHAN_COUNT];
} scan_chan_t;

#define CHANNELS_24GHZ_40MHZ_COUNT     4

#define BW20(channel)  CHBW_CHSPEC(WL_CHANSPEC_BW_20, (channel))
...
scan_chan_t chan_lut_24GHz_40MHz_rev65[] = {
	{
		...
		.count = 3,
		.chan3x3 = 3,
		.channels = {BW40(3), BW40(9), BW40(14)}
	},
	{
		/* 4/40 = 2L/6U */
		.count = 4,
		.chan3x3 = 4,
		.channels = {BW40(15), BW40(4), BW40(11), BW40(14)}
	},
	{
		/* 5/40 = 3L/7U */
		.count = 4,
		.chan3x3 = 5,
		.channels = {BW40(15), BW40(5), BW40(11), BW40(14)}
	},
	{
		/* 6/40 = 4L/8U */
		.count = 4,
		.chan3x3 = 6,
		.channels = {BW40(1), BW40(6), BW40(11), BW40(14)}
	},
	{
		/* 7/40 = 5L/9U */
		.count = 4,
		.chan3x3 = 7,
		.channels = {BW40(2), BW40(7), BW40(12), BW40(14)}
	},
	{
		/* 8/40 = 6L/10U */
		.count = 3,
		.chan3x3 = 8,
		.channels = {BW40(3), BW40(8), BW40(14)}
	},
	{
		/* 9/40 = 7L/11U */
		.count = 3,
	...
	},
	{
		...
		.count = 3,
		.chan3x3 = 10,
		.channels = {BW40(3), BW40(10), BW40(14)}
	},
	{
		/* 11/40 = 9L/13U */
		.count = 3,
		.chan3x3 = 11,
		.channels = {BW40(3), BW40(6), BW40(11)}
	},
	{
		/* NULL termination */
		.count = 0,
...
scan_chan_t chan_lut_24GHz_40MHz_rev128[] = {
	{
		...
		.count = 2,
		.chan3x3 = 3,
		.channels = {BW80(3), BW80(14)}
	},
	{
		/* 4/40 = 2L/6U */
		.count = 2,
		.chan3x3 = 4,
		.channels = {BW80(4), BW80(14)}
	},
	{
		/* 5/40 = 3L/7U */
		.count = 2,
		.chan3x3 = 5,
		.channels = {BW80(5), BW80(14)}
	},
	{
		/* 6/40 = 4L/8U */
		.count = 2,
		.chan3x3 = 6,
		.channels = {BW80(6), BW80(14)}
	},
	{
		/* 7/40 = 5L/9U */
		.count = 2,
		.chan3x3 = 7,
		.channels = {BW80(7), BW20(14)}
	},
	{
		/* 8/40 = 6L/10U */
		.count = 2,
		.chan3x3 = 8,
		.channels = {BW20(1), BW80(8)}
	},
	{
		/* 9/40 = 7L/11U */
		.count = 2,
		.chan3x3 = 9,
		.channels = {BW20(1), BW80(9)}
	},
	{
		/* 10/40 = 8L/12U */
		.count = 2,
		.chan3x3 = 10,
		.channels = {BW40(1), BW80(10)}
	},
	{
		/* 11/40 = 9L/13U */
		.count = 2,
		.chan3x3 = 11,
		.channels = {BW20(1), BW80(11)}
	},
	{
		/* NULL termination */
		.count = 0,
...
scan_chan_t chan_lut_24GHz_20MHz_rev65[] = {
	{
		...
		.count = 12,
		.chan3x3 = 1,
		.channels = {BW20(1), BW20(4), BW20(5), BW20(6),
			     BW20(7), BW20(8), BW20(9), BW20(10),
			     BW20(11), BW20(12), BW20(13), BW20(14) }
	},
	{
		/* 2/20  */
		.count = 12,
		.chan3x3 = 2,
		.channels = {BW20(15), BW20(2), BW20(5), BW20(6),
			     BW20(7), BW20(8), BW20(9), BW20(10),
			     BW20(11), BW20(12), BW20(13), BW20(14) }
	},
	{
		...
		.count = 11,
		.chan3x3 = 3,
		.channels = {BW20(15), BW20(3), BW20(6),
			     BW20(7), BW20(8), BW20(9), BW20(10),
			     BW20(11), BW20(12), BW20(13), BW20(14) }
	},
	{
		...
		.count = 10,
		.chan3x3 = 4,
		.channels = {BW20(1), BW20(4), BW20(7), BW20(8), BW20(9), BW20(10),
			     BW20(11), BW20(12), BW20(13), BW20(14) }
	},
	{
		/* 5/20  */
		.count = 10,
		.chan3x3 = 5,
		.channels = {BW20(1), BW20(2), BW20(5), BW20(8), BW20(9), BW20(10),
			     BW20(11), BW20(12), BW20(13), BW20(14) }
	},
	{
		/* 6/20  */
		.count = 10,
		.chan3x3 = 6,
		.channels = {BW20(1), BW20(2), BW20(3), BW20(6), BW20(9), BW20(10),
			     BW20(11), BW20(12), BW20(13), BW20(14) }
	},
	{
		/* 7/20  */
		.count = 10,
		.chan3x3 = 7,
		.channels = {BW20(1), BW20(2), BW20(3), BW20(4), BW20(7), BW20(10),
			     BW20(11), BW20(12), BW20(13), BW20(14) }
	},
	{
		/* 8/20  */
		.count = 10,
		.chan3x3 = 8,
		.channels = {BW20(1), BW20(2), BW20(3), BW20(4), BW20(5), BW20(8),
			     BW20(11), BW20(12), BW20(13), BW20(14) }
	},
	{
		/* 9/20  */
		.count = 10,
		.chan3x3 = 9,
		.channels = {BW20(1), BW20(2), BW20(3), BW20(4), BW20(5), BW20(6),
			     BW20(9), BW20(12), BW20(13), BW20(14) }
	},
	{
		/* 10/20  */
		.count = 10,
		.chan3x3 = 10,
		.channels = {BW20(1), BW20(2), BW20(3), BW20(4), BW20(5), BW20(6),
			     BW20(7), BW20(10), BW20(13), BW20(14) }
	},
	{
		/* 11/20  */
		.count = 10,
	...
	},
	{
		...
		.chan3x3 = 13,
		.channels = {BW20(1), BW20(2), BW20(3), BW20(4), BW20(5), BW20(6),
			     BW20(7), BW20(8), BW20(9), BW20(10), BW20(13) }
	},
	{
		/* 14/20  */
		.count = 12,
		.chan3x3 = 14,
		.channels = {BW20(1), BW20(2), BW20(3), BW20(4), BW20(5), BW20(6),
			     BW20(7), BW20(8), BW20(9), BW20(10), BW20(11), BW20(14) }
	},
...
scan_chan_t chan_lut_24GHz_20MHz_rev128[] = {
	...
	},
	{
		...
		.count = 3,
		.chan3x3 = 8,
		.channels = {BW20(1), BW80(8), BW20(14)}
	},
	{
		/* 9/20  */
		.count = 2,
	...
	},
	{
		...
		.count = 2,
		.chan3x3 = 12,
		.channels = {BW40(1), BW80(12)}
	},
	{
		/* 13/20  */
		.count = 2,
		.chan3x3 = 13,
		.channels = {BW40(1), BW80(13)}
	},
	{
		/* 14/20  */
		.count = 2,
...
const scan_chan_t *lookup_24GHz_scan(int chan, int corerev, int bw)
{
	int i = 0;
	scan_chan_t  (*chan_lut_24GHz_ptr)[];

	if(( corerev < 128) && (bw == WL_CHANSPEC_BW_20))
		chan_lut_24GHz_ptr = &chan_lut_24GHz_20MHz_rev65;
	else if(( corerev < 128) && (bw == WL_CHANSPEC_BW_40))
		chan_lut_24GHz_ptr = &chan_lut_24GHz_40MHz_rev65;
	else if(( corerev >= 128) && (bw == WL_CHANSPEC_BW_20))
		chan_lut_24GHz_ptr = &chan_lut_24GHz_20MHz_rev128;
	else if(( corerev >= 128) && (bw == WL_CHANSPEC_BW_40))
		chan_lut_24GHz_ptr = &chan_lut_24GHz_40MHz_rev128;
	else // Default
		chan_lut_24GHz_ptr = &chan_lut_24GHz_20MHz_rev128;

	/* 0 terminated list */
	while ((*chan_lut_24GHz_ptr)[i].count) {
		if ((*chan_lut_24GHz_ptr)[i].chan3x3 == chan) {
			return &((*chan_lut_24GHz_ptr)[i]);
		}
		i++;
	}
	return NULL;
...
void Usage(void)
{
	...
	printf("if there are no extra arguments after -i  [INTERFACE_NAME]] and\n");
	printf("if an nvram varable [INTERFACE_NAME]_airiq_parameter exists it will be used as the arguments \n");
	printf("Otherwise the arguments specified in the commnand line will be used.\n");
	...
	printf("-home               Used to specify a single scan channel on the home channel. \n");
	...
	printf("dwell time: 1000ms; capture time: 10ms; capture interval: default\n");
	printf("    <airiq_app -i eth2 -d 1000 -c 10  -home>\n\n");
	...
	printf("                                                Units: Microseconds. Default value: 100 us.\n");
	printf("-ch                                             Used to specify a single scan channel in the 5GHz band\n");
	printf("-home                                           Used to scan ONLY the home channel. \n");
	printf("-p [IPADDR]                                     Set the IP address of airiq_service server. The default\n");
	printf("                                                to 127.0.0.1 for local connection\n");
	printf("-h or -help                                     Display the command line help text.\n");
	printf("\n");
...
int FindDefaultInterface()
{
	...
	while (fgets(buf, sizeof(buf), fp)) {
		...
		ifname[IFNAMSIZ-1] = '\0'; // null terminate
...
void ConfigureSWSAScanParam3p1(airiq_config_t *pParam, airiq_scan_specs_t *scanspec)
{
	BSA_UINT32 cnt = 0;
	BSA_UINT32 i;
/*  */
...
/*  */
	...
	if (bband) {
		if (scan_chanspec) {
			...
			pParam->core_config[cnt]         = core;
			cnt++;
		} else if ((chan3x3 > 14) && (scanspec->revinfo.corerev >= 128) && (phy_mode == PHYMODE_3x3_1x1 ) ) {
			/* if scanning 2G band on the 5G radio we dont need to care about interference from 3x3 channel*/
			...
			if (phy_mode == PHYMODE_3x3_1x1 ) {
				...
				for (i = 0; i < s->count; i++) {
					pParam->chanspec_list[cnt]       = s->channels[i];
					if(CHSPEC_BW(s->channels[i])  == WL_CHANSPEC_BW_80) {
						pParam->dwell_interval_ms[cnt]   = longdwell*2;
						pParam->capture_count[cnt]       = longfftcnt;
					}else {
						pParam->dwell_interval_ms[cnt]   = shortdwell;
				...
				/* wrong phy mode for this function*/
				fprintf(stderr, "ConfigureSWSAScanParam3p1 called with phymode = %d/40\n", phy_mode);
				exit(-1);
			}
		} else if (bw == WL_CHANSPEC_BW_40) {
			if (phy_mode == PHYMODE_3x3_1x1 ) {
...
void ConfigureSWSAScanParam(airiq_config_t *pParam, airiq_scan_specs_t *scanspec)
{
	...
	BSA_UINT32 i;
/*  */
        int channels_24GHz_40MHz[CHANNELS_24GHZ_40MHZ_COUNT] = {3,6,9,11};
	BSA_UINT16 longdwell        = scanspec->longdwell;
	BSA_UINT16 longfftcnt       = scanspec->longfftcnt;
	BSA_UINT16 shortdwell       = scanspec->shortdwell;
	BSA_UINT16 shortfftcnt      = scanspec->shortfftcnt;
...
/*  */
	...
	if (aband) {
		if (scan_chanspec) {
			...
			// force a band scan to 80Mhz only for 5G channels
			pParam->chanspec_list[cnt]       = 42  | WL_CHANSPEC_BW_80 | WL_CHANSPEC_BAND_5G;
			pParam->dwell_interval_ms[cnt]   = shortdwell;
			pParam->capture_interval_us[cnt] = capture_interval;
			pParam->capture_count[cnt]       = shortfftcnt;
...
int DoSwsaScan(airiq_config_t *airiqScanConfig, struct ifreq *if_req, int homescan)
{
	...
	if ( up ) {
		if (homescan) {
			int chanspec;
			/* Check chanspec and reconfigure airiqScanConfig */
			...
			airiqScanConfig->chanspec_list[0] = chanspec;
			airiqScanConfig->chanspec_cnt = 1;
		...
		do {
			...
			if (ret) {
				...
				pthread_mutex_unlock(&gScanMutex);
				req.tv_sec  = 1;
				req.tv_nsec = 0;
				nanosleep(&req, &req);
				/* require lock again after waking up */
				pthread_mutex_lock(&gScanMutex);
			}
		} while (ret);
...
void ComputeScanSpecs(airiq_scan_req_t *scanreq, airiq_scan_specs_t *scanspecs)
{
	...
	if (scanreq->revinfo.corerev == 56) {
		...
		// TODO: need to add 80Mhz scan support for 2.4Ghz
	...
	if (scanreq->homescan) {
		...
		scanspecs->scan_chanspec = (chanspec_t)chanspec_int;
		if (CHSPEC_IS5G(chanspec_int)) {
			scanspecs->aband = 1;
			scanspecs->bband = 0;
		} else  if (CHSPEC_IS2G(chanspec_int)) {
			scanspecs->bband = 1;
			scanspecs->aband = 0;
		}
	}
...
void StartUserControlledSWSAScanning(int ifcnt, airiq_scan_req_t *scanreqs)
{
	...
	for (i = 0; i < cfg_ifcount; i++) {
		...
		if (scanreqs[i].phy_mode == PHYMODE_3x3_1x1 && scanreqs[i].core == 3) {
			ConfigureSWSAScanParam3p1(&airiqScanConfig[i], &scanspec[i]);
		} else {
...
#define MAX_CHANSPEC_STR_LEN 128
#define MAX_ARGS 25
int main(int argc, char*argv[])
{
	...
	for (i = 1; i < argc; i++) {
		...
		if (strcmp(myargv[i], "-i") == 0) {
			if ((i + 1) < argc) {
				if (myargv[i + 1][0] != '-') {
					PRINTF_VERBOSE("CLI: myargv[%d] = %s val=%s\n", i, myargv[i], myargv[i + 1]);
					i++;
					strncpy(scanreqs[cfg_ifcount].ifname, myargv[i], IFNAMSIZ);
					scanreqs[cfg_ifcount].ifname[IFNAMSIZ - 1] = '\0'; // null terminate
			...
			strncpy(scanreqs[cfg_ifcount].if_req.ifr_name, scanreqs[cfg_ifcount].ifname, IFNAMSIZ-1);
			scanreqs[cfg_ifcount].if_req.ifr_name[IFNAMSIZ-1] = '\0';
			...
			cfg_ifcount++;
			/*get nvram airiq parametrs if it exists*/
                        snprintf(temp, 512, "%s_airiq_parameter", scanreqs[ifidx].ifname);
                        if(((NvramVal = nvram_get(temp)) != NULL) && (argc  == 3))
                        {
				fprintf(stderr, "Using airiq_app parameter specified in  %s nvram variable.\n",temp);
				fprintf(stderr, "Executing : airiq_app -i %s %s \n",scanreqs[ifidx].ifname, NvramVal);

				k = i+1;
				for(tok = strtok(NvramVal, " "); (tok != NULL) && (k < MAX_ARGS); tok = strtok( NULL, " ")) {
					myargv[k] = tok;
					argc++;
					k++;
				}
		...
		if (strcmp(myargv[i], "-d") == 0) {
			if ((i + 1) < argc) {
				if (myargv[i + 1][0] != '-') {
					PRINTF_VERBOSE("CLI: myargv[%d] = %s val=%s\n", i, myargv[i], myargv[i + 1]);
					i++;
					scanreqs[ifidx].dwell_time = atoi(myargv[i]);
		...
		if (strcmp(myargv[i], "-c") == 0) {
			if ((i + 1) < argc) {
				if (myargv[i + 1][0] != '-') {
					PRINTF_VERBOSE("CLI: myargv[%d] = %s val=%s\n", i, myargv[i], myargv[i + 1]);
					i++;
					scanreqs[ifidx].capture_time = atoi(myargv[i]);
		...
		if (strcmp(myargv[i], "-ch") == 0) {
			if ((i + 1) < argc) {
				if (myargv[i + 1][0] != '-') {
					int chanspec;
					char argstr[MAX_CHANSPEC_STR_LEN];
					PRINTF_VERBOSE("CLI: myargv[%d] = %s val=%s\n", i, myargv[i], myargv[i + 1]);

					strncpy(argstr, myargv[i + 1], MAX_CHANSPEC_STR_LEN-1);
					argstr[MAX_CHANSPEC_STR_LEN-1] = '\0'; // null terminate

					i++;

					chanspec = wf_chspec_aton(argstr);
					if (chanspec == 0 && !strncmp(myargv[i], "7/80", 4)) {
		...
		if (strcmp(myargv[i], "-b") == 0) {
			scanreqs[ifidx].bband = 1;
			PRINTF_VERBOSE("CLI: myargv[%d] = %s\n", i, myargv[i]);
			continue;
		}
		if (strcmp(myargv[i], "-a") == 0) {
			scanreqs[ifidx].aband = 1;
			PRINTF_VERBOSE("CLI: myargv[%d] = %s\n", i, myargv[i]);
			continue;
		}
		if (strcmp(myargv[i], "-home") == 0) {
			scanreqs[ifidx].homescan = 1;
			PRINTF_VERBOSE("CLI: myargv[%d] = %s\n", i, myargv[i]);
			continue;
		}
		if (strcmp(myargv[i], "-core") == 0) {
			if ((i + 1) < argc) {
				if (myargv[i + 1][0] != '-') {
					PRINTF_VERBOSE("CLI: myargv[%d] = %s val=%s\n", i, myargv[i], myargv[i + 1]);
					i++;
					scanreqs[ifidx].core = atoi(myargv[i]);
		...
		if (strcmp(myargv[i], "-phy_mode") == 0) {
			if ((i + 1) < argc) {
				if (myargv[i + 1][0] != '-') {
					PRINTF_VERBOSE("CLI: myargv[%d] = %s val=%s\n", i, myargv[i], myargv[i + 1]);
					i++;
					if ((strcmp(myargv[i], "4x4") == 0)) {
		...
		if (strcmp(myargv[i], "-int") == 0) {
			if ((i + 1) < argc) {
				if (myargv[i + 1][0] != '-') {
					PRINTF_VERBOSE("CLI: myargv[%d] = %s val=%s\n", i, myargv[i], myargv[i + 1]);
					i++;
					scanreqs[ifidx].capture_interval = atoi(myargv[i]);
		...
		if (strcmp(myargv[i], "-v") == 0) {
			cfg_verbose = 1;
			PRINTF_VERBOSE("CLI: myargv[%d] = %s\n", i, myargv[i]);
			continue;
		}
		if (strcmp(myargv[i], "-print_events") == 0) {
			cfg_print_events = EVENT_MASK_ALL;
			PRINTF_VERBOSE("CLI: myargv[%d] = %s\n", i, myargv[i]);
			continue;
		}
		if (strcmp(myargv[i], "-p") == 0) {
			if ((i + 1) < argc) {
				if (myargv[i + 1][0] != '-') {
					PRINTF_VERBOSE("CLI: myargv[%d] = %s val=%s\n", i, myargv[i], myargv[i + 1]);
					i++;
					strncpy(host, myargv[i], sizeof(host));
					host[sizeof(host) - 1] = '\0';
				}
			}
			continue;
		}
		if (strcmp(myargv[i], "-log") == 0) {
			if ((i + 1) < argc) {
				if (myargv[i + 1][0] != '-') {
					PRINTF_VERBOSE("CLI: myargv[%d] = %s val=%s\n", i, myargv[i], myargv[i + 1]);
					i++;
					strncpy(LogFilename, myargv[i], sizeof(LogFilename)-1);
				} else {
		...
		if (strcmp(myargv[i], "-logtime") == 0) {
			if ((i + 1) < argc) {
				if (myargv[i + 1][0] != '-') {
					PRINTF_VERBOSE("CLI: myargv[%d] = %s val=%s\n", i, myargv[i], myargv[i + 1]);
					i++;
					gLogSeconds = atoi(myargv[i]);
					if (gLogSeconds <= 0) {
		...
		if (strcmp(myargv[i], "-curssithr") == 0) {
			if ((i + 1) < argc) {
				if (myargv[i + 1][0] != '-') {
					PRINTF_VERBOSE("CLI: myargv[%d] = %s val=%s\n", i, myargv[i], myargv[i + 1]);
					i++;
					CuRssiThrDbm = atoi(myargv[i]);
					if (CuRssiThrDbm <= 0) {
		...
		if (strcmp(myargv[i], "-cuwifidetsnr") == 0) {
			if ((i + 1) < argc) {
				if (myargv[i + 1][0] != '-') {
					PRINTF_VERBOSE("CLI: myargv[%d] = %s val=%s\n", i, myargv[i], myargv[i + 1]);
					i++;
					CuWifiDetSnr = atoi(myargv[i]);
					if (CuWifiDetSnr <= 0) {
		...
		if (strcmp(myargv[i], "-trsw") == 0) {
			trsw_enable = TRUE;
			continue;
		}
		/* Check for help options */
		if ((strcmp(myargv[i], "-h") == 0) || (strcmp(myargv[i], "-help") == 0)) {
			Usage();
	...
	if (gLogEventMask) {
		...
		*/
		...
		/*Adjust Wi-Fi Utilization desense  threshold from noise floor*/
		if(trsw_enable) {
			OptionData.CuWifiDesenseThr = 100;
			status = BsaSetSpecanOption(DevHandle, BSA_SPECAN_OPTION_CU_WIFI_DESENSE_THR, &OptionData);
			if (status != BSA_SUCCESS) {
				fprintf(stderr, "could not set  Wi-Fi Utilization desense  threshold.(TRSW enabled) status=%d\n",
					status);
			}
...
int LTEU_Main(int argc, char*argv[])
{
	...
	bzero(&if_req, sizeof(struct ifreq));
	strncpy(if_req.ifr_name, cfg_ifname_lteu, IFNAMSIZ-1);
