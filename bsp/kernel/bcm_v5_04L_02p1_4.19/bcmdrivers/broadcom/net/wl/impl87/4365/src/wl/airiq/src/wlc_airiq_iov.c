 ...
 *
 * $Id: wlc_airiq_iov.c 768460 2018-10-15 23:51:08Z $
 *
 */
...
enum {
	...
	IOV_AIRIQ_THROTTLE_THR1	         = 0x26,
	IOV_AIRIQ_THROTTLE_THR2	         = 0x27,
	IOV_AIRIQ_THROTTLE_MAXSCAN1      = 0x28,
	IOV_AIRIQ_THROTTLE_MAXSCAN2      = 0x29,
...
const bcm_iovar_t airiq_iovars[] = {
	{ "airiq_scanning",
	IOV_AIRIQ_SCANNING, (0), IOVT_UINT16, 0
	},
	{ "airiq_scan",
	IOV_AIRIQ_SCAN,	(0), IOVT_BUFFER, sizeof(airiq_config_t)
	},
	{ "airiq_home_scan",
	IOV_AIRIQ_HOME_SCAN, (0), IOVT_UINT32, 0
	},
	{ "airiq_scan_abort",
	IOV_AIRIQ_SCAN_ABORT, (0), IOVT_UINT16, 0
	},
	{ "airiq_gain_table_24ghz",
	IOV_AIRIQ_GAIN_TABLE_24GHZ,	(0), IOVT_BUFFER, sizeof(airiq_gain_table_t)
	},
	{ "airiq_gain_table_5ghz",
	IOV_AIRIQ_GAIN_TABLE_5GHZ, (0), IOVT_BUFFER, sizeof(airiq_gain_table_t)
	},
	{ "airiq_gain",
	IOV_AIRIQ_GAIN,	(0), IOVT_BUFFER, sizeof(airiq_gain_t)
	},
	{ "airiq_scan_cpu",
	IOV_AIRIQ_SCAN_CPU,	(0), IOVT_INT32, 0
	},
	{ "airiq_measure_cpu",
	IOV_AIRIQ_MEASURE_CPU, (0), IOVT_UINT32, 0
	},
	{ "airiq_fft_reduction",
	IOV_AIRIQ_FFT_REDUCTION, (0), IOVT_UINT32, 0
	},
	{ "airiq_scan_scale",
	IOV_AIRIQ_SCAN_SCALE, (0), IOVT_UINT32, 0
	},
	{ "airiq_sirq_thr",
	IOV_AIRIQ_SIRQ_THR,	(0), IOVT_UINT32, 0
	},
	{ "airiq_idle_thr",
	IOV_AIRIQ_IDLE_THR,	(0), IOVT_UINT32, 0
	},
	{ "airiq_cts2self",
	IOV_AIRIQ_CTS2SELF,	(0), IOVT_UINT32, 0
	},
	{ "airiq_scanmute",
	IOV_AIRIQ_SCANMUTE,	(0), IOVT_UINT32, 0
	},
	{ "airiq_core",
	IOV_AIRIQ_CORE,	(0), IOVT_UINT32, 0
	},
	{ "airiq_throttle_threshold1",
	IOV_AIRIQ_THROTTLE_THR1, (0), IOVT_UINT32, 0
	},
	{ "airiq_throttle_threshold2",
	IOV_AIRIQ_THROTTLE_THR2, (0), IOVT_UINT32, 0
	},
	{ "airiq_throttle_maxscan1",
	IOV_AIRIQ_THROTTLE_MAXSCAN1, (0), IOVT_UINT32, 0
	},
	{ "airiq_throttle_maxscan2",
	IOV_AIRIQ_THROTTLE_MAXSCAN2, (0), IOVT_UINT32, 0
	},
#ifdef WLOFFLD
	{ "airiq_offload",
	IOV_AIRIQ_OFFLOAD, (0), IOVT_UINT32, 0
	},
	{ "airiq_ol_cmd",
	IOV_AIRIQ_OFFLOAD_CMD, (0), IOVT_BUFFER, 0
	},
#endif /* WLOFFLD */
#ifdef BCMDBG
#ifdef WLOFFLD
	{ "airiq_olt_len",
	IOV_AIRIQ_OFFLOAD_TPUT_LEN,	(0), IOVT_UINT32, 0
	},
	{ "airiq_olt_cnt",
	IOV_AIRIQ_OFFLOAD_TPUT_CNT,	(0), IOVT_UINT32, 0
	},
	{ "airiq_ol_test",
	IOV_AIRIQ_OFFLOAD_TPUT_TEST, (0), IOVT_UINT32, 0
	},
#endif /* WLOFFLD */
#endif /* BCMDBG */
	{ "airiq_mangain",
	IOV_AIRIQ_MANGAIN, (0), IOVT_UINT32, 0
	},
#if defined(BCMDBG) || defined(WLTEST)
	{ "airiq_txtone",
	IOV_AIRIQ_TXTONE, (0), IOVT_INT32, 0
	},
	{ "airiq_3p1",
	IOV_AIRIQ_3P1, (0), IOVT_UINT16, 0
	},
#endif /* BCMDBG || WLTEST */
	{ "lte_u_scan_config",
	IOV_LTE_U_SCAN_CONFIG, (0), IOVT_BUFFER, sizeof(airiq_config_t)
	},
	{ "lte_u_detector_config",
	IOV_LTE_U_DETECTOR_CONFIG, (0), IOVT_BUFFER, sizeof(lte_u_detector_config_t)
	},
	{ "lte_u_scan_start",
	IOV_LTE_U_SCAN_START, (0), IOVT_UINT16, 0
	},
	{ "lte_u_scan_abort",
	IOV_LTE_U_SCAN_ABORT, (0), IOVT_UINT16, 0
	},
	{ "lte_u_debug_capture",
	IOV_LTE_U_DEBUG_CAPTURE, (0), IOVT_UINT32, 0
	},
	{ "lte_u_aging_interval",
	IOV_LTE_U_AGING_INTERVAL, (0), IOVT_UINT32, 0 },
	{ NULL, 0, 0, 0, 0 }
};

/* Handling AIRIQ related iovars */
int
airiq_doiovar(void *hdl, const bcm_iovar_t *vi, uint32 actionid, const char *name,
	void *p, uint plen, void *arg, int alen, int vsize, struct wlc_if *wlcif)
{
	...
	case IOV_SVAL(IOV_AIRIQ_TXTONE):
	{
		if (int_val == 0) {
			...
			wlc_phy_tx_tone_acphy(pi, freq_khz, ACPHY_RXCAL_TONEAMP, 0, 0, FALSE);
	...
	case IOV_GVAL(IOV_AIRIQ_3P1):
	{
		phy_info_t *pi;

		pi = (phy_info_t*)WLC_PI(airiqh->wlc);

		*ret_int_ptr = pi->radio_chanspec_sc;
		break;
	}
	case IOV_SVAL(IOV_AIRIQ_3P1):
	{
		phy_info_t *pi;
	...
	case IOV_GVAL(IOV_LTE_U_AGING_INTERVAL):
		*ret_int_ptr = airiqh->lte_u_aging_interval;
		break;
	case IOV_SVAL(IOV_AIRIQ_THROTTLE_THR1):
		airiqh->throttle_thr1  = (uint32)int_val;
		break;
	case IOV_GVAL(IOV_AIRIQ_THROTTLE_THR1):
		*ret_int_ptr = airiqh->throttle_thr1;
		break;
	case IOV_SVAL(IOV_AIRIQ_THROTTLE_THR2):
		airiqh->throttle_thr2  = (uint32)int_val;
		break;
	case IOV_GVAL(IOV_AIRIQ_THROTTLE_THR2):
		*ret_int_ptr = airiqh->throttle_thr2;
		break;
	case IOV_SVAL(IOV_AIRIQ_THROTTLE_MAXSCAN1):
		airiqh->throttle_maxscan1  = (uint32)int_val;
		break;
	case IOV_GVAL(IOV_AIRIQ_THROTTLE_MAXSCAN1):
		*ret_int_ptr = airiqh->throttle_maxscan1;
		break;
	case IOV_SVAL(IOV_AIRIQ_THROTTLE_MAXSCAN2):
		airiqh->throttle_maxscan2  = (uint32)int_val;
		break;
	case IOV_GVAL(IOV_AIRIQ_THROTTLE_MAXSCAN2):
		*ret_int_ptr = airiqh->throttle_maxscan2;
		break;
