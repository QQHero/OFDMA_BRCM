 ...
 *
 * $Id: rte_osl.h 794660 2021-01-14 09:56:11Z $
 */
...
/** Register M2M service with OSH */
#define OSH_SETM2M(osh, m2mh)   (osh)->m2m = (m2mh)
#define OSH_GETM2M(osh)	        (osh)->m2m
...
#define OSL_CACHE_FLUSH(va, len)	cpu_flush_dcache_range(va, len)
#else
...
#define	DMA_SYNC(osh, pa, size, direction)	({BCM_REFERENCE(pa); BCM_REFERENCE(size);})
