 ...
 *
 * $Id: wlc_wnm.h 791496 2020-09-29 13:16:33Z $
 */
...
extern int wlc_wnm_send_color_collision_frame(wlc_info_t *wlc, wlc_bsscfg_t *bsscfg, scb_t *scb,
...
extern int wlc_wnm_bss_pref_score_rssi(wlc_bsscfg_t *cfg, wlc_bss_info_t *bi, int8 rssi,
	uint32 *score);
extern void wlc_wnm_process_join_trgts_bsstrans(wlc_wnm_info_t *wnm, wlc_bsscfg_t *cfg,
...
extern int wlc_wnm_notif_req_send(wlc_wnm_info_t *wnm, wlc_bsscfg_t *bsscfg, struct scb *scb,
	uint8 type, uint8 *sub_elem_buf, uint16 se_buf_len);
extern bool wlc_wnm_maxidle_upd_reqd(wlc_info_t *wlc, struct scb *scb);
