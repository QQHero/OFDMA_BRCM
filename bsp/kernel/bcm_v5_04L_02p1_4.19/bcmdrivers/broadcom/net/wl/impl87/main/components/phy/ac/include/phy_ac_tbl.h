 ...
 *
 * $Id: phy_ac_tbl.h 809672 2022-03-22 04:44:16Z $
 */
...
extern void wlc_phy_table_clrbit_acphy(phy_info_t *pi, uint32 id, uint32 offset,
	uint32 width, uint32 mask);
extern void phy_ac_tbl_rfseq_write(phy_info_t *pi, uint8 len, uint16 offset, const uint16 *data);
extern void phy_ac_tbl_rfseq_read(phy_info_t *pi, uint8 len, uint16 offset, uint16 *data);
