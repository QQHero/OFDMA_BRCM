 ...
 *
 * $Id: wlc_stats.c 676803 2016-12-24 20:04:01Z $
 */
...
static const bcm_iovar_t wlc_stats_iovars[] = {
	{"bcnlenhist", IOV_STATS_BCNS_INFO, (0), 0, IOVT_BUFFER, 0},
	{NULL, 0, 0, 0, 0, 0}
};
...
static int
wlc_stats_doiovar(void *hdl, uint32 actionid,
	void *p, uint plen, void *arg, uint alen, uint vsize,
	struct wlc_if *wlcif);
