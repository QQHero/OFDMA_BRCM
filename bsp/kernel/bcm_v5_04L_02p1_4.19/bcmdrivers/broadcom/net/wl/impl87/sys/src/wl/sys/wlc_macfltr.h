 ...
 *
 * $Id: wlc_macfltr.h 783106 2020-01-14 09:13:36Z $
 */
...
extern int wlc_macfltr_dump_get(wlc_macfltr_info_t *mfi, wlc_bsscfg_t *cfg,
	fltr_list_t *fltrlist, uint len);
extern int wlc_macfltr_dump_reset(wlc_macfltr_info_t *mfi, wlc_bsscfg_t *cfg,
	fltr_list_t *fltrlist, uint len);
#ifdef WLPROBRESP_MAC_FILTER
extern void wlc_macfltr_probcount_incr(wlc_macfltr_info_t *mfi,
	wlc_bsscfg_t *cfg, const struct ether_addr *addr);
#endif /* WLPROBRESP_MAC_FILTER */
#ifdef WLAUTHRESP_MAC_FILTER
extern void wlc_macfltr_authcount_incr(wlc_macfltr_info_t *mfi,
	wlc_bsscfg_t *cfg, const struct ether_addr *addr);
#endif /* WLAUTHRESP_MAC_FILTER */
#endif /* WLC_MACFLTR_STATS */
int wlc_macfltr_list_set(wlc_macfltr_info_t *mfi, wlc_bsscfg_t *cfg,
	struct maclist *maclist, uint len);
int wlc_macfltr_list_get(wlc_macfltr_info_t *mfi, wlc_bsscfg_t *cfg,
	struct maclist *maclist, uint len);
