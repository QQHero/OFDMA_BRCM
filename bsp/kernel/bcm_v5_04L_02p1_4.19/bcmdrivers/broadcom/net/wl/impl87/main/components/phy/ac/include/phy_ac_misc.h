 ...
 *
 * $Id: phy_ac_misc.h 798314 2021-04-29 09:19:09Z $
 */
...
enum tx_tone_iqcal_mode_e {
	TX_TONE_IQCAL_MODE_OFF = 0,
	TX_TONE_IQCAL_MODE_ON =	1
};

#define STOPPLAYBACK_W_CCA_RESET 0
#define STOPPLAYBACK_WO_CCA_RESET 1
int wlc_phy_tx_tone_acphy(phy_info_t *pi, int32 f_kHz, uint16 max_val,
	enum tx_tone_iqcal_mode_e mode, bool modify_bbmult);
