 ...
 */
/*
 * $Id: wl_mdns_main.c 708017 2017-06-29 14:11:45Z $
 *
 * mdns_sd_main.c
 *
 ...
 * Instead, the 'DNS' service is offered by distributed computing. See multicast DNS draft RFC.
 * @brief
 * The firmware must act as a responsible mDNS responder as described in great detail in the RFC.
 ...
 * - not respond if the answer it would give is already in the answer section and the RR TTL is over
 *   half the original TTL
