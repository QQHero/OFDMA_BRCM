 ...
 *
 * $Id: wlc_mfp.h 802590 2021-09-01 10:45:39Z $
 *
...
#define WLC_MFP_SA_QUERY_MAX_TIMEOUTS 4
/* wlc module support */
...
bool wlc_mfp_extract_igtk(wlc_mfp_info_t *mfp, wlc_bsscfg_t *bsscfg,
	eapol_header_t* eapol);

/* insert igtk in eapol and adjust data_len (offset in/out)
 * and return added length
 */
int wlc_mfp_insert_igtk(wlc_mfp_info_t *mfp,
...
/* Allocate a pkt and set MFP flag if necessary. */
...
/* get last received assoc comeback time from TIE */
uint32 wlc_mfp_get_assoc_comeback_time(wlc_mfp_info_t *mfp, scb_t *scb);
