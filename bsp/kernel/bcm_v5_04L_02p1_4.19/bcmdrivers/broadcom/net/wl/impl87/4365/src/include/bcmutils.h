 ...
 *
 * $Id: bcmutils.h 801952 2021-08-10 09:03:35Z $
 */
...
#define BCM_MAC_RXCPL_PAD_BITS			3
...
typedef struct rxcpl_id {
	...
	uint32		PAD : BCM_MAC_RXCPL_PAD_BITS;
...
/* format/print */
	...
	defined(BCMDBG_DUMP) || defined(DBG_PHYTXERR)
