 ...
 *
 * $Id: phy_type_rxgcrs.h 783210 2020-01-17 09:09:45Z $
 */
...
typedef int (*phy_type_rxgcrs_phydump_phycal_rx_min_fn_t)(phy_type_rxgcrs_ctx_t *ctx,
	struct bcmstrbuf *b);
typedef int (*phy_type_rxgcrs_force_tr2t_fn_t)(phy_type_rxgcrs_ctx_t *ctx,
	bool force);
...
typedef struct {
	...
	phy_type_rxgcrs_force_tr2t_fn_t		force_tr2t;
