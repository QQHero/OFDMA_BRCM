 ...
 *
 * $Id: phy_ac_tpc_iov.c 785036 2020-03-11 13:26:19Z $
 */
...
static const bcm_iovar_t phy_ac_tpc_iovars[] = {
	...
	{"phy_ultpc_ppr_dis", IOV_PHY_ULTPC_PPR_DIS, (IOVF_SET_DOWN), 0,
	IOVT_INT8, 0},
#endif
	{NULL, 0, 0, 0, 0, 0}
};
	...
	void *p, uint plen, void *a, uint alen, uint vsize, struct wlc_if *wlcif)
{
	...
	case IOV_SVAL(IOV_OVRINITBASEIDX):
		...
		break;
	case IOV_GVAL(IOV_PHY_ULTPC_PPR_DIS):
		*ret_int_ptr = pi->tpci->data->phy_ultpc_ppr_dis;
		break;
	case IOV_SVAL(IOV_PHY_ULTPC_PPR_DIS):
		pi->tpci->data->phy_ultpc_ppr_dis = (bool)int_val;
		break;
#endif
