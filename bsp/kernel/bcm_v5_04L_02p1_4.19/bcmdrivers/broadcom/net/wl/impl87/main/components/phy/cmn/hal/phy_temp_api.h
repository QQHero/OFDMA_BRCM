...
uint8 phy_vbat_sense_read(phy_info_t *pi);
uint8 phy_vbat_sense_get(phy_info_t *pi);
int16 phy_temp_sense_get(phy_info_t *pi);
int16 phy_temp_sense_read(phy_info_t *pi);
bool phy_temp_is_heatedup(phy_info_t *pi);

#if defined(BCMDBG) || defined(WLTEST) || defined(TEMPSENSE_OVERRIDE)
int16 phy_temp_get_override(phy_info_t *pi);
#endif /* BCMDBG || WLTEST */
