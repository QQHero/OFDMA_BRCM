 ...
 *
 * $Id: pdftmpvt.h 809675 2022-03-22 05:14:17Z $
 */
...
#define FTM_TRACE(_args) WL_INFORM(_args)
#define FTM_ERR(_args) WL_ERROR(_args)
#define FTM_LOG_TSF_ARG(_tsf64) (uint32)((_tsf64) >> 32), (uint32)((_tsf64) & 0xffffffff)

#ifdef BCMDBG
#define FTM_DEBUG_OPT(_ftm, _opt) (((_ftm)->config != NULL) && ((_ftm)->config->debug & (_opt)))
...
#define FTM_BSSCFG_OPTION_BIT(_bsscfg, _opt) (\
	((_bsscfg)->_idx * FTM_BSSCFG_NUM_OPTIONS) + (_opt))
...
#define FTM_AVB_TS(_flags) (((_flags) & WL_PROXD_FLAG_AVB_TS) != 0)
...
#define FTM_EVENT_ALLOC_SIZE(_data_len, _num_tlvs) (OFFSETOF(wl_proxd_event_t, tlvs) + \
	BCM_XTLV_SIZE_FOR_TLVS((_data_len), ((uint32)(_num_tlvs)), FTM_XTLV_OPTIONS))
...
#define FTM_SEP_SAMPCAP_160M 7000u
#define FTM_SEP_SAMPCAP_80M 4000u
#define FTM_SEP_SAMPCAP_40M 2000u /* TBD */
#define FTM_SEP_SAMPCAP_20M 1500u /* TBD */
#define FTM_SEP_SEQ_EN	3600u
#define FTM_SEP_CM3	1400u
#ifdef TOF_DEFAULT_USE_MULTICORE
#define FTM_SEP_160M	6000u
#define FTM_SEP_80M	3100u
#define FTM_SEP_40M	1700u
#define FTM_SEP_20M	500u
#else
#define FTM_SEP_160M	3000u
...
void pdftm_end_sched(pdftm_t *ftm);
