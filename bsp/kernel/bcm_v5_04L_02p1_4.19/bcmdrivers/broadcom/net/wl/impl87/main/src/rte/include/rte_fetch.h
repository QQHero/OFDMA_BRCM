 ...
 *
 * $Id: rte_fetch.h 794017 2020-12-17 06:11:31Z $
 */
...
typedef void (*bus_flush_cb_t)(void *arg);

struct fetch_module_info {
	struct pktpool *pool;
	bus_dispatch_cb_t cb;
	bus_dispatch_cb_t alt_cb;
	bus_flush_cb_t	flush_cb;
	void *arg;
};
