 ...
 *
 * $Id: wlc_wet_tunnel.c 781112 2019-11-12 02:08:37Z $
 */
...
static int wet_tunnel_doiovar(void *hdl, uint32 actionid,
...
static int
wet_tunnel_doiovar(void *hdl, uint32 actionid,
	void *p, uint plen, void *a, uint alen, uint vsize, struct wlc_if *wlcif)
{
	...
	struct scb *scb, struct wlc_if *wlcif, void *sdu)
{
	 ...
	 */
	if ((tmp = PKTGET(osh, wlc->txhroff + totlen, TRUE)) != NULL) {
		PKTPULL(osh, tmp, wlc->txhroff);
