 ...
 *
 * $Id: phy_misc_api.h 785036 2020-03-11 13:26:19Z $
 */
...
void phy_misc_set_ldpc_override(phy_info_t *pi, bool ldpc);
int phy_misc_set_lo_gain_nbcal(phy_info_t *pi, bool lo_gain);
int phy_misc_set_filt_war(phy_info_t *pi, bool filt_war);
bool phy_misc_get_filt_war(phy_info_t *pi);
int phy_misc_tkip_rifs_war(phy_info_t *pi, uint8 rifs);
/* ******************** */
void wlc_phy_set_deaf(phy_info_t *pi, bool user_flag);
void wlc_phy_clear_deaf(phy_info_t *pi, bool user_flag);
#ifdef ATE_BUILD
void wlc_phy_gpaio(phy_info_t *pi, wl_gpaio_option_t option, int core);
#endif /* ATE_BUILD */
void wlc_phy_hold_upd(phy_info_t *pi, mbool id, bool val);
void wlc_phy_mute_upd(phy_info_t *pi, bool val, mbool flags);
bool wlc_phy_ismuted(phy_info_t *pi);
