...
#ifndef _WLC_PHYTBL_20709_H_
#define _WLC_PHYTBL_20709_H_
...
typedef struct _chan_info_radio20709_rffe_2G {
	/* 2G tuning data */
...
} chan_info_radio20709_rffe_2G_t;

typedef struct _chan_info_radio20709_rffe_5G {
	/* 5G tuning data */
	uint8 RFP0_logen_reg1_logen_mix_ctune;
	uint8 RF0_logen_core_reg3_logen_lc_ctune;
	uint8 RF1_logen_core_reg3_logen_lc_ctune;
...
} chan_info_radio20709_rffe_5G_t;

typedef struct _chan_info_radio20709_rffe {
	uint16 channel;
	uint16 freq;
	union {
		/* In this union, make sure the largest struct is at the top. */
		chan_info_radio20709_rffe_5G_t val_5G;
		chan_info_radio20709_rffe_2G_t val_2G;
	} u;
} chan_info_radio20709_rffe_t;
...
extern const radio_20xx_dumpregs_t dumpregs_20709_rev0[];
#endif

/* Radio referred values tables */
extern const radio_20xx_prefregs_t prefregs_20709_rev0[];
...
extern uint8 BCMATTACHDATA(lna1_gain_map_5g_20709r0)[N_LNA12_GAINS];
extern int8 BCMATTACHDATA(gainlimit_tbl_20709r0)[RXGAIN_CONF_ELEMENTS][MAX_RX_GAINS_PER_ELEM];
extern int8 BCMATTACHDATA(tia_gain_tbl_20709r0)[N_TIA_GAINS];
extern int8 BCMATTACHDATA(tia_gainbits_tbl_20709r0)[N_TIA_GAINS];
extern int8 BCMATTACHDATA(biq01_gain_tbl_20709r0)[2][N_BIQ01_GAINS];
extern int8 BCMATTACHDATA(biq01_gainbits_tbl_20709r0)[2][N_BIQ01_GAINS];

#endif	/* _WLC_PHYTBL_20709_H_ */
