 ...
 *
 * $Id: wlc_cntry.h 779981 2019-10-11 12:16:31Z $
*/
...
extern const char * wlc_get_country_string(wlc_cntry_info_t *cm);
...
extern int wlc_populate_ccode_info(wlc_info_t *wlc, void *arg, uint len);

extern void wlc_country_clear_locales(wlc_cntry_info_t *cm);
...
#define wlc_populate_ccode_info(wlc, arg, len) BCME_ERROR

#define wlc_cntry_set_default(cm, country_abbrev) do {} while (0)

#define wlc_country_clear_locales(cm) do {} while (0)
