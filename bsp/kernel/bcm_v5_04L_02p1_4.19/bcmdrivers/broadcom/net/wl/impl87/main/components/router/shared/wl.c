 ...
 *
 * $Id: wl.c 794786 2021-01-18 22:03:49Z $
 */
#include <typedefs.h>
#include <string.h>
#include <stdio.h>
...
/*
 * get named & bss indexed driver variable to int value
 */
int
dhd_bssiovar_getint(char *ifname, char *iovar, int bssidx, int *pval)
{
	int ret;

	ret = dhd_bssiovar_get(ifname, iovar, bssidx, pval, sizeof(int));
	return ret;
}
#endif /* __CONFIG_DHDAP__ */
