 ...
 *
 * $Id: wlc_phy_shim.h 809675 2022-03-22 05:14:17Z $
 */
...
#if defined(WL_PSMR1)
extern void wlapi_bmac_write_shm1(wlc_phy_shim_info_t *physhim, uint offset, uint16 v);
#else /* WL_PSMR1 */
#define wlapi_bmac_write_shm1(a, b, c) do {} while (0)
#endif /* WL_PSMR1 */
...
extern uint32 wlapi_get_svmp_addr_hwsch_cmd_log(wlc_phy_shim_info_t *physhim);
extern uint32 wlapi_get_svmp_addr_hwsch_v2m_buf(wlc_phy_shim_info_t *physhim);
...
void wlapi_set_sc_sz(wlc_phy_shim_info_t *physhim, uint32 sc_sz);
void wlapi_get_sc_info(wlc_phy_shim_info_t *physhim, uint32 *sc_start, uint32 *sc_sz);
...
extern void wlapi_set_cts_txcoremask(wlc_phy_shim_info_t *physhim, uint16 *mask);
extern void wlapi_get_cts_txcoremask(wlc_phy_shim_info_t *physhim, uint16 *mask);
