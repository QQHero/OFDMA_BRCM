 ...
 *
 * $Id: ieee1905.h 808790 2022-02-28 05:09:13Z $
 */
...
#define I5_CONFIG_FLAG_MCHAN            0x00000080  /* Multi channel enabled or not */
...
#define MAP_POLICY_TYPE_FLAG_BACKHAUL_BSS   0x40  /* Backhaul BSS Config Policy Received */
...
/* Profile 2 Error Code based on TS policy */
typedef struct {
  dll_t			node;
  map_p2_err_codes_t    err_code;
  unsigned char bssid[IEEE1905_MAC_ADDR_LEN];
} ieee1905_err_code_t;
...
typedef struct {
  ...
  ieee1905_glist_t no_err_code_list;	/* List of ieee1905_err_code_list type objects */
#endif /* MULTIAPR2 */
...
#define	MAP_BSSINFO_BRCM_VS_FBT_TLV		0x2	/* Vendor Specific TLV for FBT data */
 ...
 *
 */
typedef void ieee1905_recv_channel_selection_response(unsigned char *al_mac, unsigned char *interface_mac,
 ...
 *
 * @param al_mac  al_mac of the device to which Backhaul STA Capability Query message to be sent
 *
 * @return        status of the call. 0 Success. Non Zero Failure
 */
int ieee1905_send_backhaul_sta_capability_query(unsigned char *al_mac);
#endif /* MULTIAPR2 */
