...
struct dhd_gdb_bus_ops_s {
	uint16 (*read_u16)(struct dhd_bus *bus, uint32 offset);
	uint32 (*read_u32)(struct dhd_bus *bus, uint32 offset);
	void   (*write_u32)(struct dhd_bus *bus, uint32 offset, uint32 val);
};
