 ...
 *
 * $Id: phy_utils_status.c 671526 2016-11-22 08:37:30Z $
 */
...
phy_utils_get_time_usec(phy_info_t *pi)
{
	...
	time_lo = R_REG(GENERIC_PHY_INFO(pi)->osh, D11_TSFTimerLow(pi));
	time_hi = R_REG(GENERIC_PHY_INFO(pi)->osh, D11_TSFTimerHigh(pi));
