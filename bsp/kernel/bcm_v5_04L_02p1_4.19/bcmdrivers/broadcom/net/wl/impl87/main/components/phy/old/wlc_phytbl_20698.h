...
/* obtain the correct radio tuning table */
uint32 phy_get_chan_tune_tbl_20698(phy_info_t *pi, chanspec_band_t band,
...
extern int8 BCMATTACHDATA(lna12_gain_tbl_5g_20698r3)[2][N_LNA12_GAINS];
extern int8 BCMATTACHDATA(lna12_gain_tbl_6g_20698r3)[2][N_LNA12_GAINS];
extern uint8 BCMATTACHDATA(lna1_rout_map_56g_20698r3)[N_LNA12_GAINS];
extern uint8 BCMATTACHDATA(lna1_gain_map_56g_20698r3)[N_LNA12_GAINS];
