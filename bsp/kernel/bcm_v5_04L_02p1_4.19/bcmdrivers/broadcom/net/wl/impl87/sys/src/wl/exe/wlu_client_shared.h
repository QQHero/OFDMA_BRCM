 ...
 *
 * $Id: wlu_client_shared.h 810548 2022-04-08 18:58:00Z $
 */
...
extern int
rwl_queryinformation_fe(void *wl, int cmd, void* input_buf, uint32 *input_len,
int debug, int rem_ioctl_select);
extern int
rwl_setinformation_fe(void *wl, int cmd, void* buf, uint32 *len, int debug,
