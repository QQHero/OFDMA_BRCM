 ...
 *
 * $Id: phy_cmn.h 690566 2017-03-16 23:31:01Z $
 */
...
/* Slice up/down state param APIs */
uint phy_get_sliceupstate(phy_cmn_info_t *ci);
int phy_set_sliceupstate(phy_cmn_info_t *ci, uint sliceidx, bool up);
