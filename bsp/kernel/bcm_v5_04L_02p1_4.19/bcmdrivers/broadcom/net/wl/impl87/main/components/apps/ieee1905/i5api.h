...
typedef enum t_i5_api_cmd_name
{
  ...
  I5_API_CMD_SEND_CAPI,
#if defined(MULTIAPR2)
  I5_API_CMD_SEND_CHSCAN,
  I5_API_CMD_SEND_CAC_REQUEST,
  I5_API_CMD_SEND_CAC_TERMINATION,
  I5_API_CMD_ASSOC_DISALLOW,
#endif /* MULTIAPR2 */
#endif /* MULTIAP */
} t_I5_API_CMD_NAME;
...
typedef struct t_i5_api_ch_scan_req
{
  t_I5_API_GOLDEN_NODE_SEND_MSG msgInfo;
  unsigned char                 type;
} t_I5_API_CH_SCAN_REQ;

typedef struct t_i5_api_cac_request
{
  t_I5_API_GOLDEN_NODE_SEND_MSG msgInfo;
  unsigned char                 count;
  unsigned char			params[1];
} t_I5_API_CAC_REQUEST;

typedef struct t_i5_api_cac_termination
{
  t_I5_API_GOLDEN_NODE_SEND_MSG msgInfo;
  unsigned char                 count;
  unsigned char			params[1];
} t_I5_API_CAC_TERMINATION;

typedef struct t_i5_api_assoc_disallow_req
{
  /* Note : BSSID will be stored in msgInfo.macAddr */
  t_I5_API_GOLDEN_NODE_SEND_MSG msgInfo;
  unsigned char                 reason; /* 0 means allow association */
} t_I5_API_ASSOC_DISALLOW_REQ;
#endif /* MULTIAP */
