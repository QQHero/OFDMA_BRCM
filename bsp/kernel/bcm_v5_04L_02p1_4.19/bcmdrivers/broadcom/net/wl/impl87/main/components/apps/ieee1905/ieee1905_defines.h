 ...
 *
 * $Id: ieee1905_defines.h 802219 2021-08-19 12:04:20Z $
 */
...
#define I5_MAX_VLAN_IFNAME  (I5_MAX_IFNAME + 1 + 5 + 1) /* format is ifname.vlanid. So, ifname
                                                         * length + 1 for dot + VLAN ID(max 65535
                                                         * + 1 (NULL char)
                                                         */
...
#define I5_MEDIA_TYPE_WIFI_AX      0x0108
...
#define IEEE1905_MAX_DFS_CHANNELS		32
