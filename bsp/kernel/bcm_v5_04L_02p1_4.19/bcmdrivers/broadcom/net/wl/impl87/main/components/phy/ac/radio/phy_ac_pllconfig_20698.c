...
#define PRINT_PLL_CONFIG_20698(pll_struct, offset) \
	printf("%s = %u\n", #offset, (pll_struct->reg_field_val[IDX_20698_##offset]))

#define PLL_CONFIG_20698_VAL_ENTRY(pll_struct, offset, val) \
	pll_struct->reg_field_val[IDX_20698_##offset] = val

#define PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll_struct, pll_num, offset, reg, fld) \
	pll_struct->reg_addr[IDX_20698_##offset] = RADIO_PLLREG_20698(pi, reg, pll_num); \
	pll_struct->reg_field_mask[IDX_20698_##offset] = \
			RF_##20698##_##reg##_##fld##_MASK(pi->pubpi->radiorev); \
	pll_struct->reg_field_shift[IDX_20698_##offset] = \
...
typedef enum {
	...
	IDX_20698_OVR_RFPLL_VCOCAL_OFFSETIN,
	IDX_20698_OVR_RFPLL_VCOCAL_RST_N,
	IDX_20698_OVR_RFPLL_VCOCAL_COUPLINGIN,
	IDX_20698_OVR_RFPLL_VCOCAL_XTALCOUNT,
	IDX_20698_OVR_RFPLL_VCOCAL_DELTAPLLVAL,
	IDX_20698_OVR_RFPLL_FRCT_WILD_BASE,
	IDX_20698_SEL_BAND,
	IDX_20698_RFPLL_VCOCAL_DELAYEND,
	IDX_20698_RFPLL_VCOCAL_DELAYSTARTCOLD,
	IDX_20698_RFPLL_VCOCAL_DELAYSTARTWARM,
	IDX_20698_RFPLL_VCOCAL_XTALCOUNT,
	IDX_20698_RFPLL_VCOCAL_CALCAPRBMODE,
	IDX_20698_RFPLL_VCOCAL_DELTAPLLVAL,
	IDX_20698_RFPLL_VCOCAL_ERRORTHRES,
	IDX_20698_RFPLL_VCOCAL_INITCAPA,
	IDX_20698_RFPLL_VCOCAL_INITCAPB,
	IDX_20698_RFPLL_VCOCAL_NORMCOUNTLEFT,
	IDX_20698_RFPLL_VCOCAL_NORMCOUNTRIGHT,
	IDX_20698_RFPLL_VCOCAL_PAUSECNT,
	IDX_20698_RFPLL_VCOCAL_ROUNDLSB,
	IDX_20698_RFPLL_VCOCAL_UPDATESEL,
	IDX_20698_RFPLL_VCOCAL_TESTVCOCNT,
	IDX_20698_RFPLL_VCOCAL_FAST_SETTLE_OVR,
	IDX_20698_RFPLL_VCOCAL_FAST_SETTLE_OVRVAL,
	IDX_20698_RFPLL_VCOCAL_FORCE_VCTRL_OVR,
	IDX_20698_RFPLL_VCOCAL_FORCE_VCTRL_OVRVAL,
	IDX_20698_RFPLL_VCOCAL_TARGETCOUNTBASE,
	IDX_20698_RFPLL_VCOCAL_TARGETCOUNTCENTER,
	IDX_20698_RFPLL_VCOCAL_OFFSETIN,
	IDX_20698_RFPLL_VCOCAL_SLOPEIN,
	IDX_20698_RFPLL_VCOCAL_FASTSWITCH,
	IDX_20698_RFPLL_VCOCAL_FIXMSB,
	IDX_20698_RFPLL_VCOCAL_FOURTHMESEN,
	IDX_20698_RFPLL_VCO_CAP_MODE,
	IDX_20698_RFPLL_VCOCAL_PLL_VAL,
	IDX_20698_RFPLL_VCOCAL_FORCE_CAPS_OVR,
	IDX_20698_RFPLL_VCOCAL_FORCE_CAPS_OVRVAL,
	IDX_20698_RFPLL_FRCT_WILD_BASE_HIGH,
	IDX_20698_RFPLL_FRCT_WILD_BASE_LOW,
	IDX_20698_RFPLL_VCO_CVAR,
	IDX_20698_RFPLL_VCO_ALC_REF_CTRL,
	IDX_20698_RFPLL_VCO_BIAS_MODE,
	IDX_20698_RFPLL_VCO_TEMPCO_DCADJ,
	IDX_20698_RFPLL_VCO_TEMPCO,
	IDX_20698_RFPLL_LF_LF_R2,
	IDX_20698_RFPLL_LF_LF_R3,
	IDX_20698_RFPLL_LF_LF_RS_CM,
	IDX_20698_RFPLL_LF_LF_RF_CM,
	IDX_20698_RFPLL_LF_LF_C1,
	IDX_20698_RFPLL_LF_LF_C2,
	IDX_20698_RFPLL_LF_LF_C3,
	IDX_20698_RFPLL_LF_LF_C4,
	IDX_20698_RFPLL_CP_IOFF,
	IDX_20698_RFPLL_CP_KPD_SCALE,
	IDX_20698_RFPLL_VCO_PREFER,
	IDX_20698_RFPLL_VCO_CORE1_EN,
	IDX_20698_RFPLL_VCO_CORE2_EN,
	IDX_20698_RFPLL_VCOCAL_ENABLECOUPLING,
	IDX_20698_RFPLL_VCOCAL_COUPLINGMODE,
	IDX_20698_RFPLL_VCOCAL_SWAPVCO12,
	IDX_20698_RFPLL_VCOCAL_MIDCODESEL,
	IDX_20698_RFPLL_VCOCAL_SECONDMESEN,
	IDX_20698_RFPLL_VCOCAL_UPDATESELCOUP,
	IDX_20698_RFPLL_VCOCAL_COUPLTHRES,
	IDX_20698_RFPLL_VCOCAL_COUPLTHRES2,
	IDX_20698_RFPLL_VCOCAL_COUPLINGIN,
	IDX_20698_RFPLL_VCOCAL_FORCE_CAPS2_OVR,
	IDX_20698_RFPLL_VCOCAL_FORCE_CAPS2_OVRVAL,
	IDX_20698_RFPLL_VCOCAL_FORCE_AUX1_OVR,
	IDX_20698_RFPLL_VCOCAL_FORCE_AUX1_OVRVAL,
	IDX_20698_RFPLL_VCOCAL_FORCE_AUX2_OVR,
	IDX_20698_RFPLL_VCOCAL_FORCE_AUX2_OVRVAL,
	PLL_CONFIG_20698_ARRAY_SIZE
} pll_config_20698_offset_t;

static void phy_ac_radio20698_write_pll_config(phy_info_t *pi, pll_config_20698_tbl_t *pll,
		uint8 pllcore);
                            ...
                            uint8 logen_mode)
{
	...
	ac_mode = 1;
	// 6G spur channels
	if ((chan_freq == 6155) || (chan_freq == 6265) || (chan_freq == 6805)) {
		if (pll_num == 0) {
			MOD_RADIO_PLLREG_20698(pi, XTAL3, 0, xtal_pfd_drive_p, 15);
			if (chan_freq == 6155) {
				MOD_RADIO_PLLREG_20698(pi, XTAL3, 0, xtal_pfd_drive_n, 15);
			} else if (chan_freq == 6805) {
				MOD_RADIO_PLLREG_20698(pi, XTAL3, 0, xtal_pfd_drive_n, 0);
			} else {
				MOD_RADIO_PLLREG_20698(pi, XTAL3, 0, xtal_pfd_drive_n, 13);
			}
		}
		if (chan_freq == 6155) {
			MOD_RADIO_PLLREG_20698(pi, PLL_HVLDO3, pll_num,
				ldo_1p8_ldo_VCO_vout_sel, 15);
			MOD_RADIO_PLLREG_20698(pi, PLL_REFDOUBLER3, pll_num,
				RefDoublerbuf_rstrg, 12);
			MOD_RADIO_PLLREG_20698(pi, PLL_REFDOUBLER3, pll_num,
				RefDoublerbuf_fstrg, 12);
			if (pll_num == 0) {
				MOD_RADIO_PLLREG_20698(pi, XTAL1, 0, xtal_LDO_Vctrl, 2);
				MOD_RADIO_PLLREG_20698(pi, PLL_REFDOUBLER1, 0,
					RefDoubler_ldo_1p0_vout_sel, 7);
			}
		} else if (chan_freq == 6265) {
			MOD_RADIO_PLLREG_20698(pi, PLL_HVLDO3, pll_num,
				ldo_1p8_ldo_VCO_vout_sel, 11);
			MOD_RADIO_PLLREG_20698(pi, PLL_REFDOUBLER3, pll_num,
				RefDoublerbuf_rstrg, 15);
			MOD_RADIO_PLLREG_20698(pi, PLL_REFDOUBLER3, pll_num,
				RefDoublerbuf_fstrg, 15);
			if (pll_num == 0) {
				MOD_RADIO_PLLREG_20698(pi, XTAL1, 0, xtal_LDO_Vctrl, 0);
				MOD_RADIO_PLLREG_20698(pi, PLL_REFDOUBLER1, 0,
					RefDoubler_ldo_1p0_vout_sel, 7);
			}
		} else {
			MOD_RADIO_PLLREG_20698(pi, PLL_HVLDO3, pll_num,
				ldo_1p8_ldo_VCO_vout_sel, 15);
			MOD_RADIO_PLLREG_20698(pi, PLL_REFDOUBLER3, pll_num,
				RefDoublerbuf_rstrg, 6);
			MOD_RADIO_PLLREG_20698(pi, PLL_REFDOUBLER3, pll_num,
				RefDoublerbuf_fstrg, 6);
			if (pll_num == 0) {
				MOD_RADIO_PLLREG_20698(pi, XTAL1, 0, xtal_LDO_Vctrl, 2);
				MOD_RADIO_PLLREG_20698(pi, PLL_REFDOUBLER1, 0,
					RefDoubler_ldo_1p0_vout_sel, 6);
			}
		}
		if (pll_num == 0) {
			if (chan_freq == 6265) {
				MOD_RADIO_PLLREG_20698(pi, XTAL2, 0, xtal_cmos_pg_ctrl0, 0);
			} else if (chan_freq == 6155) {
				MOD_RADIO_PLLREG_20698(pi, XTAL2, 0, xtal_cmos_pg_ctrl0, 4);
			} else {
				MOD_RADIO_PLLREG_20698(pi, XTAL2, 0, xtal_cmos_pg_ctrl0, 6);
			}
		}
	} else {
		if (pll_num == 0) {
			if ((chan_freq == 6695) || (chan_freq == 6915)) {
				MOD_RADIO_PLLREG_20698(pi, XTAL3, 0, xtal_pfd_drive_p, 15);
				MOD_RADIO_PLLREG_20698(pi, XTAL3, 0, xtal_pfd_drive_n, 13);
				MOD_RADIO_PLLREG_20698(pi, XTAL1, 0, xtal_LDO_Vctrl, 2);
			} else {
				MOD_RADIO_PLLREG_20698(pi, XTAL3, 0, xtal_pfd_drive_p, 0);
				MOD_RADIO_PLLREG_20698(pi, XTAL3, 0, xtal_pfd_drive_n, 0);
				MOD_RADIO_PLLREG_20698(pi, XTAL1, 0, xtal_LDO_Vctrl, 0);
			}
		}
		MOD_RADIO_PLLREG_20698(pi, PLL_HVLDO3, pll_num, ldo_1p8_ldo_VCO_vout_sel, 11);
		MOD_RADIO_PLLREG_20698(pi, PLL_REFDOUBLER3, pll_num, RefDoublerbuf_rstrg, 15);
		MOD_RADIO_PLLREG_20698(pi, PLL_REFDOUBLER3, pll_num, RefDoublerbuf_fstrg, 15);
		if (pll_num == 0) {
			MOD_RADIO_PLLREG_20698(pi, PLL_REFDOUBLER1, 0,
				RefDoubler_ldo_1p0_vout_sel, 7);
			MOD_RADIO_PLLREG_20698(pi, XTAL2, 0, xtal_cmos_pg_ctrl0, 0);
	...
	if ((chan_freq >= 6100) || (chan_freq == 5995)) {
		MOD_RADIO_PLLREG_20698(pi, LOGEN_REG0, pll_num, logen_pu, 0);
	} else {
		MOD_RADIO_PLLREG_20698(pi, LOGEN_REG0, pll_num, logen_pu, 1);
	}
	MOD_RADIO_PLLREG_20698(pi, LOGEN_REG0, pll_num, logen_vcobuf_pu, 1);
...
BCMATTACHFN(phy_ac_radio20698_populate_pll_config_tbl)(phy_info_t *pi)
{
	...
	if ((pll->reg_field_shift =
		phy_malloc(pi, (sizeof(uint8) * PLL_CONFIG_20698_ARRAY_SIZE))) == NULL) {
	...
	/* Register addresses */
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, OVR_RFPLL_VCOCAL_SLOPEIN, PLL_VCOCAL_OVR1,
			ovr_rfpll_vcocal_slopeIn);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, OVR_RFPLL_VCOCAL_OFFSETIN, PLL_VCOCAL_OVR1,
			ovr_rfpll_vcocal_offsetIn);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, OVR_RFPLL_VCOCAL_RST_N, PLL_VCOCAL_OVR1,
			ovr_rfpll_vcocal_rst_n);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, OVR_RFPLL_VCOCAL_COUPLINGIN, PLL_VCOCAL_OVR1,
			ovr_rfpll_vcocal_couplingIn);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, OVR_RFPLL_VCOCAL_XTALCOUNT, PLL_VCOCAL_OVR1,
			ovr_rfpll_vcocal_XtalCount);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, OVR_RFPLL_VCOCAL_DELTAPLLVAL, PLL_VCOCAL_OVR1,
			ovr_rfpll_vcocal_DeltaPllVal);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, OVR_RFPLL_FRCT_WILD_BASE, PLL_OVR1,
			ovr_rfpll_frct_wild_base);

	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, SEL_BAND, PLL_MUXSELECT_LINE,
			sel_band);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_DELAYEND, PLL_VCOCAL18,
			rfpll_vcocal_DelayEnd);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_DELAYSTARTCOLD, PLL_VCOCAL3,
			rfpll_vcocal_DelayStartCold);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_DELAYSTARTWARM, PLL_VCOCAL4,
			rfpll_vcocal_DelayStartWarm);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_XTALCOUNT, PLL_VCOCAL7,
			rfpll_vcocal_XtalCount);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_CALCAPRBMODE, PLL_VCOCAL7,
			rfpll_vcocal_CalCapRBMode);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_DELTAPLLVAL, PLL_VCOCAL8,
			rfpll_vcocal_DeltaPllVal);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_ERRORTHRES, PLL_VCOCAL20,
			rfpll_vcocal_ErrorThres);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_INITCAPA, PLL_VCOCAL12,
			rfpll_vcocal_InitCapA);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_INITCAPB, PLL_VCOCAL13,
			rfpll_vcocal_InitCapB);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_NORMCOUNTLEFT, PLL_VCOCAL10,
			rfpll_vcocal_NormCountLeft);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_NORMCOUNTRIGHT, PLL_VCOCAL11,
			rfpll_vcocal_NormCountRight);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_PAUSECNT, PLL_VCOCAL19,
			rfpll_vcocal_PauseCnt);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_ROUNDLSB, PLL_VCOCAL1,
			rfpll_vcocal_RoundLSB);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_UPDATESEL, PLL_VCOCAL1,
			rfpll_vcocal_UpdateSel);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_TESTVCOCNT, PLL_VCOCAL1,
			rfpll_vcocal_testVcoCnt);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FAST_SETTLE_OVR, PLL_VCOCAL1,
			rfpll_vcocal_fast_settle_ovr);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FAST_SETTLE_OVRVAL, PLL_VCOCAL1,
			rfpll_vcocal_fast_settle_ovrVal);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FORCE_VCTRL_OVR, PLL_VCOCAL1,
			rfpll_vcocal_force_vctrl_ovr);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FORCE_VCTRL_OVRVAL, PLL_VCOCAL1,
			rfpll_vcocal_force_vctrl_ovrVal);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_TARGETCOUNTBASE, PLL_VCOCAL6,
			rfpll_vcocal_TargetCountBase);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_TARGETCOUNTCENTER, PLL_VCOCAL9,
			rfpll_vcocal_TargetCountCenter);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_OFFSETIN, PLL_VCOCAL17,
			rfpll_vcocal_offsetIn);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_SLOPEIN, PLL_VCOCAL15,
			rfpll_vcocal_slopeIn);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FASTSWITCH, PLL_VCOCAL1,
			rfpll_vcocal_FastSwitch);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FIXMSB, PLL_VCOCAL1,
			rfpll_vcocal_FixMSB);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FOURTHMESEN, PLL_VCOCAL1,
			rfpll_vcocal_FourthMesEn);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCO_CAP_MODE, PLL_VCO2,
			rfpll_vco_cap_mode);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_PLL_VAL, PLL_VCOCAL5,
			rfpll_vcocal_pll_val);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FORCE_CAPS_OVR, PLL_VCOCAL2,
			rfpll_vcocal_force_caps_ovr);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FORCE_CAPS_OVRVAL, PLL_VCOCAL2,
			rfpll_vcocal_force_caps_ovrVal);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_FRCT_WILD_BASE_HIGH, PLL_FRCT2,
			rfpll_frct_wild_base_high);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_FRCT_WILD_BASE_LOW, PLL_FRCT3,
			rfpll_frct_wild_base_low);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCO_CVAR, PLL_VCO2,
			rfpll_vco_cvar);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCO_ALC_REF_CTRL, PLL_VCO6,
			rfpll_vco_ALC_ref_ctrl);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCO_BIAS_MODE, PLL_VCO6,
			rfpll_vco_bias_mode);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCO_TEMPCO_DCADJ, PLL_VCO5,
			rfpll_vco_tempco_dcadj);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCO_TEMPCO, PLL_VCO4,
			rfpll_vco_tempco);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_LF_LF_R2,
		PLL_LF4, rfpll_lf_lf_r2);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_LF_LF_R3,
		PLL_LF5, rfpll_lf_lf_r3);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_LF_LF_RS_CM,
		PLL_LF7, rfpll_lf_lf_rs_cm);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_LF_LF_RF_CM,
		PLL_LF7, rfpll_lf_lf_rf_cm);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_LF_LF_C1,
		PLL_LF2, rfpll_lf_lf_c1);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_LF_LF_C2,
		PLL_LF2, rfpll_lf_lf_c2);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_LF_LF_C3,
		PLL_LF3, rfpll_lf_lf_c3);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_LF_LF_C4,
		PLL_LF3, rfpll_lf_lf_c4);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_CP_IOFF,
		PLL_CP4, rfpll_cp_ioff);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_CP_KPD_SCALE,
		PLL_CP4, rfpll_cp_kpd_scale);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCO_PREFER, PLL_VCO7,
		rfpll_vco_prefer);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCO_CORE1_EN, PLL_VCO7,
		rfpll_vco_core1_en);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCO_CORE2_EN, PLL_VCO7,
		rfpll_vco_core2_en);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_ENABLECOUPLING,
		PLL_VCOCAL24, rfpll_vcocal_enableCoupling);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_COUPLINGMODE,
		PLL_VCOCAL24, rfpll_vcocal_couplingMode);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_SWAPVCO12,
		PLL_VCOCAL24, rfpll_vcocal_swapVco12);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_MIDCODESEL,
		PLL_VCOCAL24, rfpll_vcocal_MidCodeSel);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_SECONDMESEN,
		PLL_VCOCAL24, rfpll_vcocal_SecondMesEn);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_UPDATESELCOUP,
		PLL_VCOCAL24, rfpll_vcocal_UpdateSelCoup);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_COUPLTHRES,
		PLL_VCOCAL26, rfpll_vcocal_CouplThres);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_COUPLTHRES2,
		PLL_VCOCAL26, rfpll_vcocal_CouplThres2);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_COUPLINGIN,
		PLL_VCOCAL25, rfpll_vcocal_couplingIn);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FORCE_CAPS2_OVR,
		PLL_VCOCAL21, rfpll_vcocal_force_caps2_ovr);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FORCE_CAPS2_OVRVAL,
		PLL_VCOCAL21, rfpll_vcocal_force_caps2_ovrVal);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FORCE_AUX1_OVR,
		PLL_VCOCAL22, rfpll_vcocal_force_aux1_ovr);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FORCE_AUX1_OVRVAL,
		PLL_VCOCAL22, rfpll_vcocal_force_aux1_ovrVal);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FORCE_AUX2_OVR,
		PLL_VCOCAL23, rfpll_vcocal_force_aux2_ovr);
	PLL_CONFIG_20698_REG_INFO_ENTRY(pi, pll, 0, RFPLL_VCOCAL_FORCE_AUX2_OVRVAL,
...
static void
phy_ac_radio20698_write_pll_config(phy_info_t *pi, pll_config_20698_tbl_t *pll, uint8 pllcore)
{
	uint16 *reg_val;
	uint16 *reg_addr;
	uint16 *reg_mask;
	...
	for (i = 0; i < PLL_CONFIG_20698_ARRAY_SIZE; i++) {
		if (pllcore) {
			phy_utils_mod_radioreg(pi, (reg_addr[i] | 0x0200), reg_mask[i],
				(reg_val[i] << reg_shift[i]));
		} else {
			phy_utils_mod_radioreg(pi, reg_addr[i], reg_mask[i],
				(reg_val[i] << reg_shift[i]));
		}
	}
}
...
static void
BCMATTACHFN(phy_ac_radio20698_pll_config_const_calc)(phy_info_t *pi, pll_config_20698_tbl_t *pll)
{
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_DELAYEND,
			(uint16)math_fp_round_64(temp_64, NF16));

	/* <0.8.24> * <0.16.16> -> <0.16.16> */
	temp_64 = math_fp_mult_64(xtal_fx, RFPLL_VCOCAL_DELAYSTARTCOLD_FX, NF24, NF16, NF16);
	/* round(0.16.16, 16) -> <0.32.0> */
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_DELAYSTARTCOLD,
			(uint16)math_fp_round_64(temp_64, NF16));

	/* <0.8.24> * <0.16.16> -> <0.16.16> */
	temp_64 = math_fp_mult_64(xtal_fx, RFPLL_VCOCAL_DELAYSTARTWARM_FX, NF24, NF16, NF16);
	/* round(0.16.16, 16) -> <0.32.0> */
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_DELAYSTARTWARM,
			(uint16)math_fp_round_64(temp_64, NF16));

	/* <0.8.24> * <0.16.16> -> <0.16.16> */
	temp_64 = math_fp_mult_64(xtal_fx, RFPLL_VCOCAL_PAUSECNT_FX, NF24, NF16, NF16);
	/* round(0.16.16, 16) -> <0.32.0> */
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_PAUSECNT,
			(uint16)math_fp_round_64(temp_64, NF16));

	/* ------------------------------------------------------------------- */
	/* Put other register values to structure */
	PLL_CONFIG_20698_VAL_ENTRY(pll, OVR_RFPLL_VCOCAL_SLOPEIN, 1);
	PLL_CONFIG_20698_VAL_ENTRY(pll, OVR_RFPLL_VCOCAL_OFFSETIN, 1);
	PLL_CONFIG_20698_VAL_ENTRY(pll, OVR_RFPLL_VCOCAL_RST_N, 1);
	PLL_CONFIG_20698_VAL_ENTRY(pll, OVR_RFPLL_VCOCAL_COUPLINGIN, 1);
	PLL_CONFIG_20698_VAL_ENTRY(pll, OVR_RFPLL_VCOCAL_XTALCOUNT, 1);
	PLL_CONFIG_20698_VAL_ENTRY(pll, OVR_RFPLL_VCOCAL_DELTAPLLVAL, 1);
	PLL_CONFIG_20698_VAL_ENTRY(pll, OVR_RFPLL_FRCT_WILD_BASE, 1);
	PLL_CONFIG_20698_VAL_ENTRY(pll, SEL_BAND, 3);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_TARGETCOUNTBASE, RFPLL_VCOCAL_TARGETCOUNTBASE);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_OFFSETIN, RFPLL_VCOCAL_OFFSETIN);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_SLOPEIN, RFPLL_VCOCAL_SLOPEIN_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_UPDATESEL, RFPLL_VCOCAL_UPDATESEL_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_CALCAPRBMODE, RFPLL_VCOCAL_CALCAPRBMODE_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_FASTSWITCH, RFPLL_VCOCAL_FASTSWITCH_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_FIXMSB, RFPLL_VCOCAL_FIXMSB_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_FOURTHMESEN, RFPLL_VCOCAL_FOURTHMESEN_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_TESTVCOCNT, RFPLL_VCOCAL_TESTVCOCNT_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_FAST_SETTLE_OVR,
		RFPLL_VCOCAL_FAST_SETTLE_OVR_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_FAST_SETTLE_OVRVAL,
		RFPLL_VCOCAL_FAST_SETTLE_OVRVAL_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_FORCE_VCTRL_OVR,
		RFPLL_VCOCAL_FORCE_VCTRL_OVR_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_FORCE_VCTRL_OVRVAL,
		RFPLL_VCOCAL_FORCE_VCTRL_OVRVAL_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_TARGETCOUNTBASE,
		RFPLL_VCOCAL_TARGETCOUNTBASE_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_COUPLINGMODE,
		RFPLL_VCOCAL_COUPLINGMODE_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_SWAPVCO12,
		RFPLL_VCOCAL_SWAPVCO12_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_COUPLTHRES,
		RFPLL_VCOCAL_COUPLTHRES_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_SECONDMESEN,
		RFPLL_VCOCAL_SECONDMESEN_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_UPDATESELCOUP,
		RFPLL_VCOCAL_UPDATESELCOUP_DEC);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_COUPLINGIN,
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCO_CAP_MODE, RFPLL_VCO_CAP_MODE_DEC);
}
	...
	uint8 ac_mode, pll_config_20698_tbl_t *pll, bool adj_state)
{
	...
	uint16 rfpll_vco_cap_mode_dec = 0;
	...
	vco_freq_fx = math_fp_mult_64(
		...
		((lo_freq >= 6100) || (lo_freq == 5995))? CONST_1_OVER_2_FX :
	...
	*/
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_XTALCOUNT,
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_DELTAPLLVAL,
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_ERRORTHRES, rfpll_vcocal_ErrorThres);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_INITCAPA, rfpll_vcocal_InitCapA);
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_NORMCOUNTLEFT,
			rfpll_vcocal_NormCountLeft);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_NORMCOUNTRIGHT,
			rfpll_vcocal_NormCountRight);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_COUPLTHRES2,
			rfpll_vcocal_CouplThres2_dec);

	/* <0.32.0> - <0.32.0> -> <0.32.0> */
	// pll->rfpll_vcocal_RoundLSB = 12 - VCO_CAL_CAP_BITS;
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_ROUNDLSB, (12 - VCO_CAL_CAP_BITS));
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_TARGETCOUNTCENTER,
			rfpll_vcocal_TargetCountCenter_dec);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_PLL_VAL, (uint16)lo_freq);
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_ENABLECOUPLING,
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_MIDCODESEL, rfpll_vcocal_MidCodeSel_dec);
	/* ------------------------------------------------------------------- */
	/* VCO register */
	/* ------------------------------------------------------------------- */
	if (enable_coupled_VCO == 1) {
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCO_PREFER,
		rfpll_vco_prefer_dec);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCO_CORE1_EN,
		rfpll_vco_core1_en_dec);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCO_CORE2_EN,
		rfpll_vco_core2_en_dec);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_FORCE_CAPS_OVR,
		rfpll_vcocal_force_caps_ovr_dec);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_FORCE_CAPS_OVRVAL,
		rfpll_vcocal_force_caps_ovrval_dec);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_FORCE_CAPS2_OVR,
		rfpll_vcocal_force_caps2_ovr_dec);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCOCAL_FORCE_CAPS2_OVRVAL,
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_FRCT_WILD_BASE_HIGH,
			(uint16)(temp_32 & 0xFFFF));
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_FRCT_WILD_BASE_LOW,
	...
	} else if (lo_freq == 5995) {
		loop_band = 360;
	} else if (lo_freq == 6155) {
		loop_band = 450;
	} else if (lo_freq == 6265) {
		loop_band = 200;
	} else if (lo_freq == 6805) {
		loop_band = 320;
	}
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCO_CVAR, rfpll_vco_cvar_dec);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCO_ALC_REF_CTRL, rfpll_vco_ALC_ref_ctrl_dec);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCO_BIAS_MODE, rfpll_vco_bias_mode_dec);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCO_TEMPCO_DCADJ, rfpll_vco_tempco_dcadj_dec);
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_VCO_TEMPCO, rfpll_vco_tempco_dec);

	if (lo_freq == 5995) {
		rfpll_vco_cap_mode_dec = 1;
	} else {
		rfpll_vco_cap_mode_dec = 0;
	}
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_LF_LF_R2, rfpll_lf_lf_r2_ideal);

	/* rfpll_lf_lf_r3 */
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_LF_LF_R3, rfpll_lf_lf_r2_ideal);
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_LF_LF_RS_CM, rfpll_lf_lf_rs_cm_ideal);
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_LF_LF_RF_CM, rfpll_lf_lf_rf_cm_ideal);
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_LF_LF_C1, rfpll_lf_lf_c1_ideal);
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_LF_LF_C2, rfpll_lf_lf_c2_ideal);
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_LF_LF_C3, rfpll_lf_lf_c3_ideal);
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_LF_LF_C4, rfpll_lf_lf_c4_ideal);
	...
	rfpll_cp_kpd_scale_ideal = (uint16)(LIMIT((int32)rfpll_cp_kpd_scale_dec_fx,
			0, 127));
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_CP_KPD_SCALE, rfpll_cp_kpd_scale_ideal);
	...
	PLL_CONFIG_20698_VAL_ENTRY(pll, RFPLL_CP_IOFF, rfpll_cp_ioff_ideal);
	/* ------------------------------------------------------------------- */

#if DBG_PLL != 0
		print_pll_config_20698(pll, lo_freq, loop_band, icp_fx);
#endif /* DBG_PLL */
}

#if DBG_PLL != 0
static void
print_pll_config_20698(pll_config_20698_tbl_t *pll, uint32 lo_freq, uint32 loop_bw, uint32 icp_fx)
{
	printf("------------------------------------------------------------\n");
	printf("\nLO_Freq = %d MHz\n", lo_freq);
	...
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_DELAYEND);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_DELAYSTARTCOLD);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_DELAYSTARTWARM);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_XTALCOUNT);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_DELTAPLLVAL);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_ERRORTHRES);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FASTSWITCH);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FIXMSB);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FOURTHMESEN);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_INITCAPA);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_INITCAPB);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_NORMCOUNTLEFT);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_NORMCOUNTRIGHT);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_PAUSECNT);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_ROUNDLSB);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_TARGETCOUNTBASE);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_TARGETCOUNTCENTER);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_OFFSETIN);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_PLL_VAL);

	printf("\nother VCOCAL register (not channel/XTAL dependent):\n");
	printf("------------------------------------------------------------\n");
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_SLOPEIN);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_UPDATESEL);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_CALCAPRBMODE);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_TESTVCOCNT);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FORCE_CAPS_OVR);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FORCE_CAPS_OVRVAL);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FAST_SETTLE_OVR);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FAST_SETTLE_OVRVAL);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FORCE_VCTRL_OVR);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FORCE_VCTRL_OVRVAL);

	printf("\nVCOCAL register (required by coupled VCOs):\n");
	printf("------------------------------------------------------------\n");
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_ENABLECOUPLING);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_COUPLINGMODE);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_SWAPVCO12);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_MIDCODESEL);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_COUPLTHRES);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_COUPLTHRES2);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_SECONDMESEN);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_UPDATESELCOUP);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_COUPLINGIN);

	printf("\nVCOCAL register (optional for coupled VCOs):\n");
	printf("------------------------------------------------------------\n");
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FORCE_CAPS2_OVR);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FORCE_CAPS2_OVRVAL);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FORCE_AUX1_OVR);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FORCE_AUX1_OVRVAL);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FORCE_AUX2_OVR);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCOCAL_FORCE_AUX2_OVRVAL);

	printf("\nVCO register:\n");
	printf("------------------------------------------------------------\n");
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCO_CORE1_EN);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCO_CORE2_EN);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCO_PREFER);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCO_CAP_MODE);

	printf("\nFract-N (Sigma-Delta) register:\n");
	printf("------------------------------------------------------------\n");
	PRINT_PLL_CONFIG_20698(pll, RFPLL_FRCT_WILD_BASE_HIGH);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_FRCT_WILD_BASE_LOW);

	printf("\nVCO Register (11n vs 11ac mode):\n");
	printf("------------------------------------------------------------\n");
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCO_CVAR);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCO_ALC_REF_CTRL);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCO_BIAS_MODE);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCO_TEMPCO_DCADJ);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_VCO_TEMPCO);

	printf("\nCP and Loop Filter register:\n");
	printf("------------------------------------------------------------\n");
	PRINT_PLL_CONFIG_20698(pll, RFPLL_LF_LF_R2);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_LF_LF_R3);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_LF_LF_RS_CM);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_LF_LF_RF_CM);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_LF_LF_C1);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_LF_LF_C2);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_LF_LF_C3);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_LF_LF_C4);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_CP_KPD_SCALE);
	PRINT_PLL_CONFIG_20698(pll, RFPLL_CP_IOFF);
}
#endif /* DBG_PLL */
