 ...
 *
 * $Id: wlc_ie_mgmt_lib.h 695681 2017-04-21 15:34:08Z $
 */
...
#define WLC_IEM_ID_INVALID	0xffff
...
/*
 * Get IE ID with extension from IE. Returns WLC_IEM_ID_INVALID if the IE is an extended ID
 * with an invalid TLV length.
 *
 * 'ie' points to ie from which the (extended) element ID is to be determined.
 */
extern wlc_iem_tag_t wlc_iem_get_id(uint8 *ie);
