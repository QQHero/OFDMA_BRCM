 ...
 *
 * $Id: phy_rxspur.c 783949 2020-02-13 09:58:24Z $
 */
...
void
phy_rxspur_change_block_bbpll(phy_info_t *pi, bool block, bool going_down)
{
...
void
phy_rxspur_change_bbpll(phy_info_t *pi)
{
	phy_type_rxspur_fns_t *fns = pi->rxspuri->fns;
