...
#endif
{
	...
	MFREE(osh, temp, NVRAM_ARRAY_MAXSIZE);
}
...
BCMATTACHFN(nvram_init)(void *si)
{
	...
	/* PR54462: FlashType bits are floating in 4329A0 wlbga package and show
	 * value as 0x1, 0x5 or 0x7 randomly.  As there is no flash in 4329 we
	 * switch to FLASH_NONE option.
	 */
