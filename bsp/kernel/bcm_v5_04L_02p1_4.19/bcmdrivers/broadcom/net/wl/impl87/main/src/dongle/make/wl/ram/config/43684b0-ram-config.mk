...
BASE_FW_IMAGE		:= pcie-splitrx-mfp-pktctx-amsdutx-ampduretry-ringer-txbf-hostpmac-dhdhdr-avs-cu-vasip-ampduhostreorder-murx-wrr-sae-swprbrsp-iapp

# FDAP features
FDAP_MFG_FEATURES	:= fdap-mbss-wl11k-wl11u-wnm-chanim-bgdfs-cevent-pspretend-stamon-fbt-osen-obss-dbwsw-mbo-mutx-oce-cca-ccamesh-map-splitassoc-led-slvradar-memallocstats-dpp-dtpc-hme-m2m-mbx-csi
...
# DATAPATH feature:
DATAPATH_FEATURES	:= cfp-hwa-hwaall-idma
...
TARGET_OPTIONS_config_pcie_fdap_release_monitor		:= $(TARGET_OPTIONS_config_pcie_fdap_release_nondp)-splitrxmode2-atm
TARGET_OPTIONS_config_pcie_fdap_release_hostdpi		:= $(BASE_FW_IMAGE)-$(FDAP_FEATURES)-$(DATAPATH_FEATURES)-$(FDAP_RELEASE_FEATURES)-hostdpi
...
TARGET_OPTIONS_config_pcie_fdap_internal_hostdpi	:= $(BASE_FW_IMAGE)-$(FDAP_FEATURES)-$(DATAPATH_FEATURES)-$(MFGTEST_FEATURES)-$(INTERNAL_FEATURES)-hostdpi
TARGET_OPTIONS_config_pcie_fdap_internal_6g		:= $(BASE_FW_IMAGE)-$(FDAP_FEATURES)-$(DATAPATH_FEATURES)-$(MFGTEST_FEATURES)-$(INTERNAL_FEATURES)-6g
...
TARGET_OPTIONS_config_sdio_ate				:= sdio-ate-dump-fdap-txbf
