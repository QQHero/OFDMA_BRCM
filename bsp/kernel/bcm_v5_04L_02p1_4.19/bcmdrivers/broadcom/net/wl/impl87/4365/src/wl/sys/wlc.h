 ...
 *
 * $Id: wlc.h 808098 2022-02-09 07:59:04Z $
 */
...
#define AS_WAIT_AUTH_CONFIRM	34	/* Wait for SAE confirm from upper layer or peer device */
...
extern bool wlc_is_protected_dual_publicaction(uint8 act);
