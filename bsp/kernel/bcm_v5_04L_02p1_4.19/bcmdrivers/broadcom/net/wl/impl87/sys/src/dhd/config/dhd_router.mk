...
ifneq ($(strip $(CONFIG_UGW_BCM_DONGLE)),)
DHDIFLAGS       += -DCONFIG_UGW_BCM_DONGLE
WIFI_KERNEL_SRC = $(TOP_PATH)/cbb/wifi/tendawifi/kernel
DHDIFLAGS += -I$(WIFI_KERNEL_SRC)/dongle_drv/td_wl_core
DHDIFLAGS += -I$(WIFI_KERNEL_SRC)/dongle_drv/td_wldebug/
DHDIFLAGS += -I$(WIFI_KERNEL_SRC)/dongle_drv/include
ifneq ($(strip $(CONFIG_TD_EASYMESH)),)
DHDIFLAGS       += -DTD_EASYMESH_SUPPORT
DHDIFLAGS += -I$(WIFI_KERNEL_SRC)/dongle_drv/td_easymesh/
endif
endif
...
ifeq ($(CONFIG_UGW_BCM_DONGLE),y)
EXTRA_CFLAGS += -DCONFIG_UGW_BCM_DONGLE
endif
