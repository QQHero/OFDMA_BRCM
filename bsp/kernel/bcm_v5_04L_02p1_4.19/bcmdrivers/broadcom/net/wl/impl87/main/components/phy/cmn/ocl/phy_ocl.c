...
/* **************************************** */
int
phy_ocl_coremask_change(phy_info_t *pi, uint8 coremask)
{
...
uint8
phy_ocl_get_coremask(phy_info_t *pi)
{
	phy_type_ocl_fns_t *fns = pi->ocli->fns;
...
int
phy_ocl_status_get(phy_info_t *pi, uint16 *reqs, uint8 *coremask, bool *ocl_en)
{
	phy_type_ocl_fns_t *fns = pi->ocli->fns;
...
int
phy_ocl_disable_req_set(phy_info_t *pi, uint16 req, bool disable, uint8 req_id)
{
	phy_type_ocl_fns_t *fns = pi->ocli->fns;
