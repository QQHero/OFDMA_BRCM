 ...
 *
 * $Id: threadx_priv.h 779771 2019-10-07 11:26:40Z $
 */
...
/* top level interrupt and FIQ handlers */
void threadx_isr(void);
bool threadx_fiq_isr(void);

/* shell command handler */
void hnd_thread_cli_init(void);
