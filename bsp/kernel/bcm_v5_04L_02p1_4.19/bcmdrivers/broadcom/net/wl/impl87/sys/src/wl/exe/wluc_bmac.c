 ...
 *
 * $Id: wluc_bmac.c 791583 2020-10-02 11:25:27Z $
 */
...
static cmd_t wl_bmac_cmds[] = {
	...
	{ "axi", wlu_reg2args, WLC_GET_VAR, WLC_SET_VAR,
	"get/set a 32 bits word using a physical backplane address:\n"
	"\taxi_address [ value ]" },
#endif
#ifdef BCMDBG
