 ...
 *
 * $Id: phy_ac_rxiqcal.h 802666 2021-09-02 17:30:27Z $
 */
...
int phy_ac_rxiqcal_iovar_get_gtbl_en(phy_ac_rxiqcal_info_t *rxiqcali, int32 *ret_val);
int phy_ac_rxiqcal_iovar_set_gtbl_en(phy_ac_rxiqcal_info_t *rxiqcali, int32 set_val);
