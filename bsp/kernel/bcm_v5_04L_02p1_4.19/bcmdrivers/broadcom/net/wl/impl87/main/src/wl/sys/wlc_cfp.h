 ...
 *
 * $Id: wlc_cfp.h 803989 2021-10-14 19:10:00Z $
 */
...
/* Bit values for CFP_DEBUG_LEVEL to select debug output level */
#define CFP_DEBUG_NONE          0
#define CFP_DEBUG_ENABLE        1
#define CFP_TRACE_ENABLE        2
#define CFP_TX_TRACE_ENABLE     4
#define CFP_RX_TRACE_ENABLE     8

#ifdef CFP_DEBUG
/* By default, to turn on all debug output */
#define CFP_DEBUG_LEVEL (CFP_DEBUG_ENABLE | CFP_TRACE_ENABLE | \
			CFP_TX_TRACE_ENABLE | CFP_RX_TRACE_ENABLE)
#else
/* Disable all debug output */
#define CFP_DEBUG_LEVEL CFP_DEBUG_NONE
#endif

#if (CFP_DEBUG_LEVEL & CFP_DEBUG_ENABLE)
#define WLC_CFP_DEBUG(args)             printf args
#else
#define WLC_CFP_DEBUG(args)             WLC_CFP_NOOP
#endif
#if (CFP_DEBUG_LEVEL & CFP_TRACE_ENABLE)
#define WLC_CFP_TRACE(args)             printf args
#else
#define WLC_CFP_TRACE(args)             WLC_CFP_NOOP
#endif
#if (CFP_DEBUG_LEVEL & CFP_TX_TRACE_ENABLE)
#define WLC_CFP_TX_TRACE(args)          printf args
#else
#define WLC_CFP_TX_TRACE(args)          WLC_CFP_NOOP
#endif
#if (CFP_DEBUG_LEVEL & CFP_RX_TRACE_ENABLE)
#define WLC_CFP_RX_TRACE(args)          printf args
#else
#define WLC_CFP_RX_TRACE(args)          WLC_CFP_NOOP
#endif
