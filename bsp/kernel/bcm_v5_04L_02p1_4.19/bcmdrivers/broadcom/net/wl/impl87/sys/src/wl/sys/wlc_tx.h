 ...
 *
 * $Id: wlc_tx.h 807287 2022-01-17 11:46:31Z $
 *
 */
#ifndef _wlc_tx_h_
#define _wlc_tx_h_
...
extern void wlc_low_txq_enq(wlc_info_t *wlc,
	txq_t *txq, uint fifo_idx, void *pkt);
extern void wlc_low_txq_enq_list(wlc_info_t *wlc, txq_t *txq,
...
extern void txq_hw_fill_utxd(txq_info_t *txqi, txq_t *txq);
...
extern int wlc_prep_sdu(wlc_info_t *wlc, scb_t *scb, void *pkts[DOT11_MAXNUMFRAGS], uint *npkts,
	uint fifo);
...
#define WLC_D11HDRS_FN(wlc, pkt, scb, \
		txparams_flags, frag, nfrags, fifo, next_frag_len, \
...
extern uint16 wlc_d11hdrs(wlc_info_t *wlc, void *p, struct scb *scb, uint txparams_flags,
	uint frag, uint nfrags, uint fifo, uint next_frag_len,
	wlc_key_t *key, const wlc_key_info_t *key_info, ratespec_t rspec_override);
...
extern void wlc_scb_supp_q_map_pkts(wlc_info_t *wlc, struct spktq *spktq, map_pkts_cb_fn cb,
	void *ctx);
...
extern void wlc_tx_fill_rate_entry(wlc_info_t *wlc, scb_t *scb,
	d11ratemem_rev128_entry_t *rate_entry, wlc_rlm_rate_store_t *rate_store,
	ratesel_txparams_t *ratesel);
...
uint16 wlc_txq_pktq_pavail(struct scb *scb, uint prec);
...
void *cpktq_penq(wlc_info_t *wlc, struct cpktq *cpktq, int prec, void *p, bool head);
bool cpktq_prec_enq(wlc_info_t *wlc, struct cpktq *cpktq, void *p, int prec, bool head);
void cpktq_flush(wlc_info_t *wlc, struct cpktq *cpktq);
void cpktq_dec(struct pktq *pq, void *pkt, int prec);
...
#ifdef BCMDBG
extern void wlc_validate_empty_fifo_list(wlc_info_t *wlc);
#endif /* BCMDBG */
void wlc_txq_free_pkt(wlc_info_t *wlc, void *pkt, uint16 *pkt_cnt);

#if defined(HWA_PKTPGR_BUILD)
extern void wlc_hwa_tx_fifo_hpq_hw_fill(wlc_info_t *wlc, txq_t *txq, uint fifo);
#endif /* HWA_PKTPGR_BUILD */

void wlc_scb_cq_flush(wlc_info_t *wlc, struct scb* scb);
#endif /* _wlc_tx_h_ */
