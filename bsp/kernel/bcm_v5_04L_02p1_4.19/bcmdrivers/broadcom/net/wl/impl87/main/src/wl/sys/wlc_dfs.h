 ...
 *
 * $Id: wlc_dfs.h 808957 2022-03-03 13:01:01Z $
 */
...
#ifdef SLAVE_RADAR
extern void wlc_dfs_send_action_frame(wlc_info_t *wlc, wlc_bsscfg_t *bsscfg);
...
#endif /* BGDFS */
extern void wlc_dfs_abort_cac(wlc_dfs_info_t *dfs);
#else /* !WLDFS */
