 ...
 *
 * $Id: phy_txpwrcap.c 785036 2020-03-11 13:26:19Z $
 */
...
int
wlc_phy_txpwrcap_tbl_set(phy_info_t *pi, wl_txpwrcap_tbl_t *txpwrcap_tbl)
{
...
int
wlc_phy_txpwrcap_tbl_get(phy_info_t *pi, wl_txpwrcap_tbl_t *txpwrcap_tbl)
{
	phy_txpwrcap_info_t *ti = pi->txpwrcapi;
	uint8 i, j = 0, k;
...
int wlc_phyhal_txpwrcap_get_cellstatus(phy_info_t *pi, int32* cellstatus)
{
	phy_txpwrcap_info_t *ti = pi->txpwrcapi;
...
void
wlc_phyhal_txpwrcap_set_cellstatus(phy_info_t *pi, int status)
{
	phy_txpwrcap_info_t *ti = pi->txpwrcapi;
...
bool
wlc_phy_txpwrcap_get_enabflg(phy_info_t *pi)
{
	return pi->txpwrcapi->data->_txpwrcap;
}
...
void
wlc_phy_txpwrcap_to_shm(phy_info_t *pi, uint16 tx_ant, uint16 rx_ant)
{
	phy_txpwrcap_info_t *ti = pi->txpwrcapi;
	phy_type_txpwrcap_fns_t *fns = ti->priv->fns;
