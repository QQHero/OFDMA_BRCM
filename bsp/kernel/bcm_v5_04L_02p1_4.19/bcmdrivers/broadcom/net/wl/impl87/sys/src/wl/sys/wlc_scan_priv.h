 ...
 *
 * $Id: wlc_scan_priv.h 807674 2022-01-27 13:34:11Z $
 */
...
#define SCAN_INFO_NON_WILDCARD	0x00000001
#define SCAN_INFO_WILDCARD	0x00000002
...
struct scan_info {
	...
	uint16		home_time;	/* dwell time for the home channel between channel scan */
	...
	int		n_short_ssid;		/* number of short ssids in the short ssid list */
	uint32		*short_ssid_list;	/* short ssids to look for in
						 * scan (could be dynamic)
						 */
	...
	uint32		def_6g_scan_type;	/* 1 - RNR, 2 - PSC, 4 - FULL SCAN */
	uint32		flags;
};
