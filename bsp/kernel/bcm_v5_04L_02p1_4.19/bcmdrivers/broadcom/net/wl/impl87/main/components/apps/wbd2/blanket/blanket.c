 ...
 *
 * $Id: blanket.c 809077 2022-03-07 11:43:08Z $
 *
 *  @author
 *  @bug No known bugs.
 */
...
/* The following are copied from fils.h */
	...
	void *params, int *params_size, uint16 version)
{
	...
	params_v1->nprobes = -1;
	params_v1->active_time = BKT_CS_SCAN_DWELL_ACTIVE;
	params_v1->passive_time = BKT_CS_SCAN_DWELL;
