 ...
 *
 * $Id: wlc_offld.h 803989 2021-10-14 19:10:00Z $
 */
...
extern int wlc_offload_isr_register(wlc_info_t *wlc, uint orig_unit, uint bus,
...
extern void wlc_offload_intrs_deassert(wlc_offload_t *wlc_offload);
