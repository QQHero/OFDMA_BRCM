 ...
 *
 * $Id: wlc_tdls.h 783325 2020-01-23 10:07:53Z $
*/
...
/* BE_TDLS */
		...
		#define BE_TDLS_ENAB(cmn)		((cmn)->_betdls)
	#elif defined(BE_TDLS_DISABLED)
		#define BE_TDLS_ENAB(cmn)		(0)
	#else
		#define BE_TDLS_ENAB(cmn)		((cmn)->_betdls)
	#endif
#else
...
extern void wlc_tdls_rcv_action_frame(tdls_info_t *tdls, struct scb *scb, struct wlc_frminfo *f,
	uint pdata_offset);
extern bool wlc_tdls_recvfilter(tdls_info_t *tdls, wlc_bsscfg_t *cfg);
...
extern void wlc_tdls_cleanup(tdls_info_t *tdls, wlc_bsscfg_t *parent, bool cleanup_all);
...
extern bool wlc_tdls_stay_awake(tdls_info_t *tdls);
extern void wlc_tdls_do_chsw(tdls_info_t *tdls, wlc_bsscfg_t *bsscfg, bool off_channel);
...
extern bool wlc_tdls_auto_op(wlc_info_t *wlc);
extern void wlc_tdls_pm_timer_action(tdls_info_t *tdls, wlc_bsscfg_t *cfg);
void wlc_tdls_apsd_upd(tdls_info_t *tdls, wlc_bsscfg_t *cfg);
bool wlc_tdls_pm_enabled(tdls_info_t *tdls, wlc_bsscfg_t *cfg);
bool wlc_tdls_scb_associated(tdls_info_t *tdls, wlc_bsscfg_t *cfg);
...
#define wlc_tdls_cleanup(a, b, c) do {} while (0)
...
#define wlc_tdls_get_pmoverride(a) FALSE
#define wlc_tdls_isup(a)	FALSE
#define wlc_tdls_pm_timer_action(a, b)	do {} while (0)
#endif /* WLTDLS */
