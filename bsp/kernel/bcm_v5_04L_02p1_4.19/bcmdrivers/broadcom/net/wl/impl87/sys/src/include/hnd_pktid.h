 ...
 *
 * $Id: hnd_pktid.h 690155 2017-03-14 23:38:37Z $
 */
...
extern uint16 hnd_pktid_allocate(struct lbuf * pktptr);
extern void   hnd_pktid_release(struct lbuf * pktptr, const uint16 pktid);
extern bool   hnd_pktid_sane(struct lbuf * pktptr);
