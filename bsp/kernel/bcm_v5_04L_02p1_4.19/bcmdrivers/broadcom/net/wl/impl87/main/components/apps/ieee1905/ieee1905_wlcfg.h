...
#define I5_WLCFG_NVRAM_MAP_TS_ENABLE_ETH_VTAG "map_ts_enable_eth_vtag"
...
int Wlcfg_proto_create_m2(unsigned char band, unsigned char *m1, int m1_len,
  ieee1905_client_bssinfo_type *bssinfo, unsigned char **m2, int *m2_size, i5_dm_device_type *pdevice);
...
void wlcfg_wsc_get_data(unsigned char *msg, int len, wsc_data_t *data, i5_dm_wsc_device_info_t *device_info);
