 ...
 *
 * $Id: wl_export.h 735737 2017-12-12 07:16:33Z $
 */
...
extern uint8 wlfc_allocate_MAC_descriptor_handle(wlc_info_t* wlc);
...
extern int wl_txhdr_push(struct wl_info *wl, void *p, uint queue, bool commit);
extern int wl_reclaim_bus_txpkts(struct wl_info *wl, struct spktq *pkt_list, uint16 fifo,
	bool free);
extern void wl_map_bus_txpkts(struct wl_info *wl, map_pkts_cb_fn cb, void *ctx);
extern void wl_txhdr_commit(struct wl_info *wl);
#endif

#ifdef ECOUNTERS
typedef int (*wl_ecounters_get_stats)(uint16 stats_type, void *context);
extern int wl_ecounters_register_source(uint16 stats_type,
	wl_ecounters_get_stats some_fn, void* context);
#endif
#endif	/* _wl_export_h_ */
