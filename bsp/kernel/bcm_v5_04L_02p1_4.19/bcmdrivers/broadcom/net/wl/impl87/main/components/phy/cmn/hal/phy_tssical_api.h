 ...
 *
 * $Id: phy_tssical_api.h 785036 2020-03-11 13:26:19Z $
 */
...
int wlc_phy_tssivisible_thresh(phy_info_t *pi);
void wlc_phy_get_tssi_sens_min(phy_info_t *pi, int8 *tssiSensMinPwr);
