 ...
 *
 * $Id: phy_utils_reg.h 789857 2020-08-10 12:47:10Z $
 */
...
uint16 phy_utils_read_phyreg_p1c(phy_info_t *pi, uint16 addr);
void phy_utils_write_phyreg_p1c(phy_info_t *pi, uint16 addr, uint16 val);
...
void phy_utils_mod_phyreg_p1c(phy_info_t *pi, uint16 addr, uint16 mask, uint16 val);
...
extern void phy_utils_mod_phyreg_debug(phy_info_t *pi, uint16 addr, uint16 mask, uint16 val,
                              const char *reg_name);
extern void phy_utils_mod_phyreg_p1c_debug(phy_info_t *pi, uint16 addr, uint16 mask, uint16 val,
                              const char *reg_name);
...
extern void phy_utils_mod_radioreg_debug(phy_info_t *pi, uint16 addr, uint16 mask, uint16 val,
                                const char *reg_name);
extern void phy_utils_write_radioreg_debug(phy_info_t *pi, uint16 addr, uint16 val,
	const char *reg_name);
