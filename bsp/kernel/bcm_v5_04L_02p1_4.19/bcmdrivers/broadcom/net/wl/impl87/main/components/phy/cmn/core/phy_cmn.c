 ...
 *
 * $Id: phy_cmn.c 782892 2020-01-08 11:06:22Z $
 */
#include <phy_cfg.h>
#include <typedefs.h>
#include <bcmdefs.h>
...
BCMATTACHFN(phy_cmn_attach)(phy_info_t *pi)
{
	...
	PHY_INFORM(("\n*** wl%d: %s: cmn->pi = %p | num_d11_cores = %d phymode %d ***\n\n",
		sh->unit, __FUNCTION__, pi, cmn->num_d11_cores, cmn->phymode));
