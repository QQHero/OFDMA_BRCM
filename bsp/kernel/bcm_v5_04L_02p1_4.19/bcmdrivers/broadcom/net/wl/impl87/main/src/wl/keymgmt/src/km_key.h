 ...
 * $Id: km_key.h 802604 2021-09-01 17:08:39Z $
 */
...
#ifdef BCMWAPI_WPI
/* rotate key in place, preserving key indicies (sw, hw) such that current key
 * is always available from scb_km->key_idx and returns the current key info
 */
int km_key_wapi_rotate_key(wlc_key_t *cur_key, wlc_key_t *prev_key,
