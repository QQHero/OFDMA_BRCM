 ...
 *
 * $Id: wlutils.h 794786 2021-01-18 22:03:49Z $
 */
...
/*
 * Set msched/umsched related maxn command
 * @param	ifname		interface name
 * @param	iovar		variable name
 * @param	subcmd		msched/umsched subcommand
 * @param	bw		bandwidth
 ...
 * @return	success == 0, failure != 0
 */
extern int wl_msched_iovar_setmaxn(char *ifname, char *iovar, char *subcmd, int bw, int val);
