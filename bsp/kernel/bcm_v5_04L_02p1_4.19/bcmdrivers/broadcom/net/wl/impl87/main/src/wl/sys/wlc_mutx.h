 ...
 *
 * $Id: wlc_mutx.h 803989 2021-10-14 19:10:00Z $
 */
...
extern void wlc_mutx_process_dlhemmu_dis_change(wlc_mutx_info_t *mu_info, scb_t *scb);
extern void wlc_mutx_twtsta_evict_from_hemmu(wlc_mutx_info_t *mu_info, scb_t *scb);
extern void wlc_mutx_evict_dlofdma_client(wlc_mutx_info_t *mu_info, scb_t *scb);
extern void wlc_mutx_scb_drained(wlc_info_t *wlc, scb_t *scb);
