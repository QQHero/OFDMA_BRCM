...
$(D11SHM_HEADER): $(D11SHM_DEPS) wlconf.h
	...
	@echo "Generating D11 SHM, using shmdefs files from STD:$(D11SHMDEFS) EAP:$(D11SHMDEFS) WOWL:$(D11SHMDEFS_WOWL) blddir $(D11SHM_TEMPDIR)"
ifeq ($(D11SHM_WIN), 1)
	...
	cd $(D11SHM_TEMPDIR) && ./d11shm_rev > d11shm_revs.txt
