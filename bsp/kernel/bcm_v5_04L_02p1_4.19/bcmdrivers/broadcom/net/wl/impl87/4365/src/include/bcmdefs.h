 ...
 *
 * $Id: bcmdefs.h 708017 2017-06-29 14:11:45Z $
 */
...
#ifdef DONGLEBUILD
	extern bool _is_mutephytxerror;
	#define IS_MUTEPHYTXERROR()	(_is_mutephytxerror)
#else
	#define IS_MUTEPHYTXERROR()	0
#endif

#ifdef BCM_DHDHDR
	extern bool _bcmdhdhdr;
	#define BCMDHDHDR_ENAB()	(_bcmdhdhdr)
#else
	#define BCMDHDHDR_ENAB()	0
#endif /* BCMPCIEDEV */
#ifdef HOST_HDR_FETCH
	extern bool _hosthdrfetch;
	#define HOST_HDR_FETCH_ENAB()	(_hosthdrfetch)
#else
	#define HOST_HDR_FETCH_ENAB()	0
#endif /* HOST_HDR_FETCH */
#ifdef AMSDU_FRAG_OPT
	extern bool _amsdufrag;
	#define AMSDUFRAG_ENAB()	(_amsdufrag)
#else
	#define AMSDUFRAG_ENAB()	0
