 ...
 *
 * $Id: wlc_he.h 810190 2022-04-01 08:17:39Z $
 */
...
#define SCB_HE_UL2x996_CAP(v, a)	(SCB_HE_CAP(a) && \
	(wlc_he_get_peer_caps(v, a) & SCB_HE_UL2x996))
...
void wlc_he_omi_pmq_reset(wlc_info_t *wlc, scb_t *scb);
...
#define SCB_HE_UL2x996_CAP(v, a)		FALSE
...
#define wlc_he_omi_pmq_reset(a, b)
...
extern bool wlc_he_get_bsscolor_disable(wlc_info_t *wlc, wlc_bsscfg_t *cfg);
...
extern uint8 wlc_he_get_omi_bw(wlc_he_info_t *hei, scb_t *scb);
extern bool wlc_he_received_valid_omi(wlc_he_info_t *hei, scb_t *scb);
...
he_op_ie_t *wlc_he_process_op_ie(wlc_he_info_t *hei, wlc_bsscfg_t *bsscfg, uint8 *tlvs,
	int tlvs_len, he_op_ie_t* op_ie);
...
#endif /* STA */
extern void wlc_he_color_collision_process_report(wlc_he_info_t *hei,
