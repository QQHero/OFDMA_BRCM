 ...
 *
 * $Id: wlc_dfs.h 804739 2021-11-09 04:27:26Z $
 */
...
/* others */
extern int wlc_set_dfs_cacstate(wlc_dfs_info_t *dfs, int state);
...
extern int wlc_dfs_scan(wlc_dfs_info_t *dfs, wl_chan_switch_t *csa, bool preclear_only);
#else
...
#define wlc_dfs_scan(dfs, csa, preclear_only) 0
...
#define wlc_dfs_start_radar_report_timer(wlc) do {} while (0)
