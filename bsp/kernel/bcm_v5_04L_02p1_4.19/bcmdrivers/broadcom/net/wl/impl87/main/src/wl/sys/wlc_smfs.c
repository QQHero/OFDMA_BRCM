 ...
 *
 * $Id: wlc_smfs.c 790124 2020-08-17 08:43:19Z $
 */
...
smfstats_codetype_included(uint16 code, uint16 codetype)
{
	...
	if (codetype == SMFS_CODETYPE_SC)
		indx = linear_search_u16(smfs_sc_table, code, ARRAYSIZE(smfs_sc_table));
	else
		indx = linear_search_u16(smfs_rc_table, code, ARRAYSIZE(smfs_rc_table));
