 ...
 *
 * $Id: phy_type_samp.h 809672 2022-03-22 04:44:16Z $
 */
...
typedef int (*phy_type_samp_capture_enable_fn_t)(phy_type_samp_ctx_t *ctx,
	uint32 *save_clkgatests, uint32 start_ptr, uint32 end_ptr);
typedef int (*phy_type_samp_capture_disable_fn_t)(phy_type_samp_ctx_t *ctx);
...
typedef struct {
	...
	phy_type_samp_capture_enable_fn_t		sampcap_enable;
	phy_type_samp_capture_disable_fn_t		sampcap_disable;
} phy_type_samp_fns_t;
