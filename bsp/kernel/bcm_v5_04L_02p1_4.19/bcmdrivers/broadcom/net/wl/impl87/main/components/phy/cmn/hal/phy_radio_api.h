 ...
 *
 * $Id: phy_radio_api.h 789748 2020-08-06 11:54:53Z $
 */
...
#define BCM20708_ID		0x50e4
#define BCM20709_ID		0x50e5
#define BCM20710_ID		0x50e6
...
/* init power on reset */
void phy_radio_por_inform(phy_info_t *pi);

/* run bist config */
void phy_radio_runbist_config(phy_info_t *pi, bool start_end);

/* query supported channels for given band */
void phy_radio_get_valid_chanvec(phy_info_t *pi, int band, chanvec_t *valid_chans);
