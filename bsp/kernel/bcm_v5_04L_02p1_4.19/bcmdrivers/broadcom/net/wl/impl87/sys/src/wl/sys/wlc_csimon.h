 ...
 *
 * $Id: wlc_csimon.h 806909 2022-01-07 10:25:53Z $
 *
...
/* Max number of responer devices supported simultaneously for CSI reporting */
/* ONLY one Responder AP is supported as responder is indexed using hwrs_scb */
#define CSIMON_MAX_RESPONDER_AP 1
#ifdef BCM_CSIMON_AP
/* Max number of clients supported simultaneously for CSI reporting */
/* For both CSIMON STA and AP to AP case the total is 11 */
#define CSIMON_MAX_STA 10 + CSIMON_MAX_RESPONDER_AP
# else
