 ...
 *
 * $Id: wlc_msch.h 796796 2021-03-12 14:47:02Z $
 */
...
#define MSCH_FD_DEFAULT_BANDSWITCH_TIME		(2 * 1000)		/* usec */
#define MSCH_FD_DEFAULT_CHANNEL_SWITCH_TIME	(5 * 1000)		/* usec */
#define MSCH_NIC_DEFAULT_BANDSWITCH_TIME	(14 * 1000)		/* usec */
#define MSCH_NIC_DEFAULT_CHANNEL_SWITCH_TIME	(15 * 1000)		/* usec */

/*
 * The MIN_ONCHAN_TIME is fixed to 10 ms. The 10 ms unit available for schedule.
 */
#define MSCH_MIN_ONCHAN_TIME (10 * 1000)
#define MSCH_MIN_FREE_SLOT MSCH_MIN_ONCHAN_TIME
 ...
 * NOTE: deprecated, use wlc_msch_endtime_timeslot instead.
 */
 ...
 */
uint64 wlc_msch_endtime_timeslot(wlc_msch_info_t *msch_info, chanspec_t to);
