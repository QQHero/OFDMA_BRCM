 ...
 *
 * $Id: phy_ac_rssi.h 801841 2021-08-05 06:46:42Z $
 */
...
typedef struct phy_ac_rssi_data {
	...
	bool	hwrssi_en; /* 0 = use agc-based rssi, 1 = use HWRSSI */
...
extern void phy_ac_rssi_mode_select(phy_info_t *pi, bool hwrssi_mode);
extern void phy_ac_hwrssi_set_offset(phy_info_t *pi);
extern bool phy_ac_noise_get_hwrssi_en(phy_info_t *pi);
/* ************************************************************************* */
/* ************************************************************************* */
/* ************************************************************************* */
/* ************************************************************************* */
