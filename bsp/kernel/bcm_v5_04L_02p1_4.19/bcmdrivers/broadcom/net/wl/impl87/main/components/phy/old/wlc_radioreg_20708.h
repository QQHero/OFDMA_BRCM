 ...
 * by jz922041 on Thu Jan 14 18:04:41 2021 using:
 *
 *  $ ./merge_regs.py --always-add-macro --max 70 --macro (rev) --compare-template (RADIO20708_MAJORREV(rev) >= ${ver}) --non-register-regex JTAG_ --extended-version-checks RF_20708_REV_ID -o /home/jz922041/kudu_tobnew/components/phy/old/wlc_radioreg_20708.h ./data/radio_regs/20708_majorrev2_registers.h ./data/radio_regs/20708_majorrev0_registers.h ./data/radio_regs/20708_majorrev1_registers.h
 *
 * $Id$
 */
/* FILE-CSTYLED */
...
#define RF0_20708_REV_ID(rev)             ((RADIO20708_MAJORREV(rev) >= 3) ? INVALID_ADDRESS : (0x0 | JTAG_20708_CR0))
#define RF1_20708_REV_ID(rev)             ((RADIO20708_MAJORREV(rev) >= 3) ? INVALID_ADDRESS : (0x0 | JTAG_20708_CR1))
#define RF2_20708_REV_ID(rev)             ((RADIO20708_MAJORREV(rev) >= 3) ? INVALID_ADDRESS : (0x0 | JTAG_20708_CR2))
#define RF3_20708_REV_ID(rev)             ((RADIO20708_MAJORREV(rev) >= 3) ? INVALID_ADDRESS : (0x0 | JTAG_20708_CR3))
#define RFP0_20708_REV_ID(rev)            ((RADIO20708_MAJORREV(rev) >= 3) ? INVALID_ADDRESS : (0x0 | JTAG_20708_PLL0))
#define RFP1_20708_REV_ID(rev)            ((RADIO20708_MAJORREV(rev) >= 3) ? INVALID_ADDRESS : (0x0 | JTAG_20708_PLL1))
#define RFP2_20708_REV_ID(rev)            INVALID_ADDRESS
#define RFP3_20708_REV_ID(rev)            INVALID_ADDRESS
#define RFX_20708_REV_ID(rev)             ((RADIO20708_MAJORREV(rev) >= 3) ? INVALID_ADDRESS : (0x0 | JTAG_20708_ALL))
#define RF_20708_REV_ID_rev_id_SHIFT(rev) 0
#define RF_20708_REV_ID_rev_id_MASK(rev)  ((RADIO20708_MAJORREV(rev) >= 3) ? INVALID_MASK : 0xff)
...
#define RF_20708_RXDB_WRSSI1_REG0_rxdb_wrssi1_cur_ctrl_hst_SHIFT(rev)   12
#define RF_20708_RXDB_WRSSI1_REG0_rxdb_wrssi1_cur_ctrl_hst_MASK(rev)    0x1000
...
#define RF_20708_RXDB_WRSSI1_REG0_rxdb_wrssi1_cur_ctrl_her_SHIFT(rev)   11
#define RF_20708_RXDB_WRSSI1_REG0_rxdb_wrssi1_cur_ctrl_her_MASK(rev)    0x800
...
#define RF_20708_TXDB_REG0_tx_mx_bias_lo_res_SHIFT(rev)      7
#define RF_20708_TXDB_REG0_tx_mx_bias_lo_res_MASK(rev)       0x380
#define RF_20708_TXDB_REG0_tx_pad_band_sel_SHIFT(rev)        5
#define RF_20708_TXDB_REG0_tx_pad_band_sel_MASK(rev)         0x20
#define RF_20708_TXDB_REG0_tx_mx_bias_gm_boost_SHIFT(rev)    4
#define RF_20708_TXDB_REG0_tx_mx_bias_gm_boost_MASK(rev)     0x10
#define RF_20708_TXDB_REG0_txdb_coupler_pu_SHIFT(rev)        2
#define RF_20708_TXDB_REG0_txdb_coupler_pu_MASK(rev)         0x4
#define RF_20708_TXDB_REG0_tx_pad_att_boost_SHIFT(rev)       15
#define RF_20708_TXDB_REG0_tx_pad_att_boost_MASK(rev)        0x8000
#define RF_20708_TXDB_REG0_tx_mx_bias_gm_res_SHIFT(rev)      10
#define RF_20708_TXDB_REG0_tx_mx_bias_gm_res_MASK(rev)       0x7c00
#define RF_20708_TXDB_REG0_tx_mx_bias_lo_boost_SHIFT(rev)    6
#define RF_20708_TXDB_REG0_tx_mx_bias_lo_boost_MASK(rev)     0x40
...
/* Register RF_20708_RXADC_CFG14 */
#define RF0_20708_RXADC_CFG14(rev)                    ((RADIO20708_MAJORREV(rev) >= 2) ? (0x2a | JTAG_20708_CR0) : INVALID_ADDRESS)
#define RF1_20708_RXADC_CFG14(rev)                    ((RADIO20708_MAJORREV(rev) >= 2) ? (0x2a | JTAG_20708_CR1) : INVALID_ADDRESS)
#define RF2_20708_RXADC_CFG14(rev)                    ((RADIO20708_MAJORREV(rev) >= 2) ? (0x2a | JTAG_20708_CR2) : INVALID_ADDRESS)
#define RF3_20708_RXADC_CFG14(rev)                    ((RADIO20708_MAJORREV(rev) >= 2) ? (0x2a | JTAG_20708_CR3) : INVALID_ADDRESS)
#define RFP0_20708_RXADC_CFG14(rev)                   INVALID_ADDRESS
#define RFP1_20708_RXADC_CFG14(rev)                   INVALID_ADDRESS
#define RFP2_20708_RXADC_CFG14(rev)                   INVALID_ADDRESS
#define RFP3_20708_RXADC_CFG14(rev)                   INVALID_ADDRESS
#define RFX_20708_RXADC_CFG14(rev)                    INVALID_ADDRESS
#define RF_20708_RXADC_CFG14_rxadc_ref_dbg_SHIFT(rev) 0
#define RF_20708_RXADC_CFG14_rxadc_ref_dbg_MASK(rev)  0xff
...
#define RF_20708_AUXPGA_CFG1_auxpga_i_pu_refgen_SHIFT(rev) 11
#define RF_20708_AUXPGA_CFG1_auxpga_i_pu_refgen_MASK(rev)  0x800
...
#define RF_20708_AUXPGA_OVR1_ovr_auxpga_i_pu_refgen_SHIFT(rev) 4
#define RF_20708_AUXPGA_OVR1_ovr_auxpga_i_pu_refgen_MASK(rev)  0x10
...
#define RF_20708_RX5G_REG5_rxdb_auxgm_en_SHIFT(rev)        14
#define RF_20708_RX5G_REG5_rxdb_auxgm_en_MASK(rev)         0x4000
...
#define RF_20708_RX5G_REG5_rxdb_auxgm_bypass_SHIFT(rev)    13
#define RF_20708_RX5G_REG5_rxdb_auxgm_bypass_MASK(rev)     0x2000
...
#define RF_20708_RX5G_REG6_rxdb_killsw_5G_en2_SHIFT(rev)  1
#define RF_20708_RX5G_REG6_rxdb_killsw_5G_en2_MASK(rev)   0x2
#define RF_20708_RX5G_REG6_rxdb_killsw_2G_en2_SHIFT(rev)  0
#define RF_20708_RX5G_REG6_rxdb_killsw_2G_en2_MASK(rev)   0x1
...
#define RF_20708_TEMPSENSE_CFG_tempsense_ibias_sel_SHIFT(rev)   2
#define RF_20708_TEMPSENSE_CFG_tempsense_ibias_sel_MASK(rev)    0x4
...
#define RF_20708_BG_REG13_bg_ctat_uncal_AFE_extra_sel_SHIFT(rev) 4
#define RF_20708_BG_REG13_bg_ctat_uncal_AFE_extra_sel_MASK(rev)  0x70
...
#define RF_20708_TXDB_PAD_REG3_tx_pad_bias_gm_res_SHIFT(rev)    0
#define RF_20708_TXDB_PAD_REG3_tx_pad_bias_gm_res_MASK(rev)     0x7
#define RF_20708_TXDB_PAD_REG3_tx_pad_bias_cas_boost_SHIFT(rev) 10
#define RF_20708_TXDB_PAD_REG3_tx_pad_bias_cas_boost_MASK(rev)  0x400
...
#define RF_20708_TX2G_MIX_REG1_tx_mx_bias_bgr_sel_SHIFT(rev)              0
#define RF_20708_TX2G_MIX_REG1_tx_mx_bias_bgr_sel_MASK(rev)               0x1
...
#define RF_20708_TX2G_MIX_REG3_tx_mx_bias_cas_boost_SHIFT(rev)   0
#define RF_20708_TX2G_MIX_REG3_tx_mx_bias_cas_boost_MASK(rev)    0x3
...
#define RF_20708_BG_OVR1_ovr_bgldo_pu_SHIFT(rev)         2
#define RF_20708_BG_OVR1_ovr_bgldo_pu_MASK(rev)          0x4
...
#define RF_20708_PLL_HVLDO1_rfpll_vco_ldo_stage2_branch_SHIFT(rev) 13
#define RF_20708_PLL_HVLDO1_rfpll_vco_ldo_stage2_branch_MASK(rev)  0x2000
...
#define RF_20708_BG_REG1_bgldo_gpaio_pu_SHIFT(rev)   14
#define RF_20708_BG_REG1_bgldo_gpaio_pu_MASK(rev)    0x4000
...
/* Register RF_20708_BGLDO_REG1 */
#define RF0_20708_BGLDO_REG1(rev)                          INVALID_ADDRESS
#define RF1_20708_BGLDO_REG1(rev)                          INVALID_ADDRESS
#define RF2_20708_BGLDO_REG1(rev)                          INVALID_ADDRESS
#define RF3_20708_BGLDO_REG1(rev)                          INVALID_ADDRESS
#define RFP0_20708_BGLDO_REG1(rev)                         ((RADIO20708_MAJORREV(rev) >= 2) ? (0x83 | JTAG_20708_PLL0) : INVALID_ADDRESS)
#define RFP1_20708_BGLDO_REG1(rev)                         INVALID_ADDRESS
#define RFP2_20708_BGLDO_REG1(rev)                         INVALID_ADDRESS
#define RFP3_20708_BGLDO_REG1(rev)                         INVALID_ADDRESS
#define RFX_20708_BGLDO_REG1(rev)                          INVALID_ADDRESS
#define RF_20708_BGLDO_REG1_bgldo_rctrl_leak_SHIFT(rev)    6
#define RF_20708_BGLDO_REG1_bgldo_rctrl_leak_MASK(rev)     0xc0
#define RF_20708_BGLDO_REG1_bgldo_1p8filter_r_SHIFT(rev)   1
#define RF_20708_BGLDO_REG1_bgldo_1p8filter_r_MASK(rev)    0x6
#define RF_20708_BGLDO_REG1_bgldo_vbuck_adj_SHIFT(rev)     8
#define RF_20708_BGLDO_REG1_bgldo_vbuck_adj_MASK(rev)      0xf00
#define RF_20708_BGLDO_REG1_bgldo_pu_SHIFT(rev)            0
#define RF_20708_BGLDO_REG1_bgldo_pu_MASK(rev)             0x1
#define RF_20708_BGLDO_REG1_bgldo_vout_adj_SHIFT(rev)      12
#define RF_20708_BGLDO_REG1_bgldo_vout_adj_MASK(rev)       0x7000
#define RF_20708_BGLDO_REG1_bgldo_bias_rst_SHIFT(rev)      3
#define RF_20708_BGLDO_REG1_bgldo_bias_rst_MASK(rev)       0x8
#define RF_20708_BGLDO_REG1_bgldo_en_test_gpaio_SHIFT(rev) 15
#define RF_20708_BGLDO_REG1_bgldo_en_test_gpaio_MASK(rev)  0x8000
#define RF_20708_BGLDO_REG1_bgldo_rst_delay_SHIFT(rev)     4
#define RF_20708_BGLDO_REG1_bgldo_rst_delay_MASK(rev)      0x30
...
#define RF_20708_LOGEN_REG2_logen_loldo_filtering_en_SHIFT(rev) 14
#define RF_20708_LOGEN_REG2_logen_loldo_filtering_en_MASK(rev)  0x4000
