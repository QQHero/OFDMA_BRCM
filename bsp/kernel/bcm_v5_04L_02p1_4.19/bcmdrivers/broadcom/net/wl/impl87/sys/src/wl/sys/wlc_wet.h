 ...
 *
 *   $Id: wlc_wet.h 766250 2018-07-27 10:18:59Z $
 */
...
extern int wlc_wet_send_proc(wlc_wet_info_t *weth, wlc_bsscfg_t *bsscfg,
	void *sdu, void **new);

/* Process frames in receive direction */
extern int wlc_wet_recv_proc(wlc_wet_info_t *weth, wlc_bsscfg_t *bsscfg, void *sdu);
...
#ifdef DPSTA
extern void wl_dpsta_wet_register(struct wl_info *wl, wlc_bsscfg_t *cfg);
#endif /* DPSTA */
