 ...
 *
 * $Id: phy_samp.h 809672 2022-03-22 04:44:16Z $
 */
...
#define SAMPLE_COLLECT_PLAY_CTRL_SINGLE_PKT_MASK 0xfbffu
...
int phy_samp_capture_enable(phy_info_t *pi, uint32 *save_clkgatests,
       uint32 start_ptr, uint32 end_ptr);
int phy_samp_capture_disable(phy_info_t *pi);
