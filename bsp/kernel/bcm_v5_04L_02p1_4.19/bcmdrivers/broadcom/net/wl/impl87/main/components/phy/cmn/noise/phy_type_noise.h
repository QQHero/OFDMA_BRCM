 ...
 *
 * $Id: phy_type_noise.h 810501 2022-04-08 03:34:50Z $
 */
...
typedef int (*phy_type_noise_hwknoise_enabled_fns_t)(phy_type_noise_ctx_t *ctx);
...
typedef struct {
	...
	/* hw knoise 'is enabled' checker */
	phy_type_noise_hwknoise_enabled_fns_t hwknoise_ena;
