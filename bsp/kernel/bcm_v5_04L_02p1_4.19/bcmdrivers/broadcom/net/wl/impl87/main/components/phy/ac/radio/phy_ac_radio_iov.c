...
static const bcm_iovar_t phy_ac_radio_iovars[] = {
	...
	{"wbcal_afediv", IOV_WBCAL_AFEDIV, 0, 0, IOVT_INT32, 0},
	{NULL, 0, 0, 0, 0, 0}
};
	...
	void *p, uint plen, void *a, uint alen, uint vsize, struct wlc_if *wlcif)
{
	...
	case IOV_GVAL(IOV_WBCAL_AFEDIV):
	{
		err = phy_ac_get_wbcal_afediv_ratio(radioi, ret_int_ptr);
		break;
	}
	case IOV_SVAL(IOV_WBCAL_AFEDIV):
	{
		err = phy_ac_set_wbcal_afediv_ratio(radioi, (int32)int_val);
		break;
	}
	default:
		err = BCME_UNSUPPORTED;
