 ...
 *
 * $Id: wl_export.h 798625 2021-05-07 20:57:13Z $
 */
...
#if defined(linux)
extern void wl_reset_dump_signature(struct wl_info *wl);
...
#else
#define wl_reset_dump_signature(a);
#define wl_sched_macdbg_dump(a)
#define wl_sched_dtrace(a, b, c)
#endif /* linux */
#ifdef BCMPCIEDEV
extern void wl_scb_flow_ring_delink(struct wl_info *wl, uint16 flowid);
extern void wlc_scb_flow_ps_update(struct wl_info *wl, uint16 scb_flowid, bool ps_on);
#endif
...
#ifdef WLSQS
extern void wl_sqs_stride_resume(struct wl_info *wl);
#endif /* WLSQS */
#endif	/* _wl_export_h_ */
