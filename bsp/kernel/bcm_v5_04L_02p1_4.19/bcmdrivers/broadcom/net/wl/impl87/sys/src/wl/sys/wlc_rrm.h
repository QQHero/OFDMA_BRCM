 ...
 *
 * $Id: wlc_rrm.h 806439 2021-12-21 10:50:22Z $
 */
...
extern int wlc_write_neighbor_ap_info_field(uint8 *ibuf, uint16 ibuf_len,
	wlc_rnr_info_t *nbr_rnr_info, uint8 *len_copied);
extern int wlc_rrm_fill_static_rnr_info(wlc_info_t *wlc, wlc_bsscfg_t *bsscfg, uint8 *pbuffer,
	uint8 max_pbuf_len, uint8 *len_copied, bool is_handling_directed_prb_rqst);
extern bool wlc_rrm_ssid_is_in_nbr_list(wlc_bsscfg_t *cfg, wlc_ssid_t *ssid, uint32 *s_ssid,
	uint8 short_ssid_len);

extern bool wlc_rrm_any_nbr_hidden(wlc_bsscfg_t *cfg);
