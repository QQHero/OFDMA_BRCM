 ...
 *
 * $Id: wlc_mcnx.h 783333 2020-01-23 21:23:05Z $
 */
...
extern void wlc_mcnx_bssid_set(wlc_mcnx_info_t *mcnx, wlc_bsscfg_t *cfg);
...
extern void wlc_mcnx_unaligned_tbtt_upd(wlc_mcnx_info_t *mcnx, wlc_bsscfg_t *cfg,
	uint32 tbtt_tsfo);
extern uint32 wlc_mcnx_unaligned_tbtt_get(wlc_mcnx_info_t *mcnx, wlc_bsscfg_t *cfg);
...
extern void wlc_mcnx_ap_ps_enab(wlc_mcnx_info_t *mcnx, wlc_bsscfg_t *cfg, bool enab);
...
extern uint16 wlc_mcnx_read_dtim_prd(wlc_mcnx_info_t *mcnx, wlc_bsscfg_t *bsscfg);
extern void wlc_mcnx_write_dtim_prd(wlc_mcnx_info_t *mcnx, wlc_bsscfg_t *bsscfg, uint16 dtim);
...
extern int wlc_mcnx_multidtim_upd(wlc_mcnx_info_t *mcnx, wlc_bsscfg_t *cfg, bool enab);
...
/* configures ucode to stop TX aggregation and framebursting in dts in microseconds */
/* from [cur_time] also in microseconds */
extern void wlc_set_cfg_tx_stop_time(wlc_info_t *wlc, wlc_bsscfg_t *cfg, int32 dts);
extern void wlc_mcnx_rcmta_type_set(wlc_mcnx_info_t *mcnx, int idx, uint16 mask, uint16 val);
/* address match tables */
extern int wlc_set_ra_hw(wlc_info_t *wlc, int index, const struct ether_addr *ea);
extern int wlc_set_bssid_hw(wlc_info_t *wlc, int index, const struct ether_addr *ea, bool a2_also);
extern int wlc_mcnx_rcmta_alloc(wlc_mcnx_info_t *mcnx, int *idx);
void
wlc_mcnx_rcmta_free(wlc_mcnx_info_t *mcnx, int idx);
/* notifications */
#endif	/* !_wlc_mcnx_h_ */
