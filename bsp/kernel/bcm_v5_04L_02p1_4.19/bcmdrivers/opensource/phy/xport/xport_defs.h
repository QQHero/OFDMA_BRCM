...
typedef enum
{
    ...
    XPORT_INTF_0_2 = 3,
    XPORT_INTF_1_0 = 5,
    XPORT_INTF_1_1 = 6,     /* USXGMII-M */
    XPORT_INTF_1_2 = 7,     /* USXGMII-M */
    XPORT_INTF_1_3 = 8,     /* USXGMII-M */
#else
...
typedef enum
{
    ...
    XPORT_PORT_ID_1_0 = 4, /* Supports 10G 5G 2.5G */
    XPORT_PORT_ID_1_1 = 5, /* Supports     5G 2.5G */
    XPORT_PORT_ID_1_2 = 6, /* Supports        2.5G */
    XPORT_PORT_ID_1_3 = 7, /* Supports        2.5G */
#else
...
#if defined(CONFIG_BCM94912) || defined(CONFIG_BCM96813)
#define XPORT_PORT_ID_2_BBHTX_ID(_port)     (((_port) == 0) ? 0 : (((_port) == 2) ? 1 : 3))
#else
#define XPORT_PORT_ID_2_BBHTX_ID(_port)     (((_port) == 0) ? 1 : 2)
#endif
