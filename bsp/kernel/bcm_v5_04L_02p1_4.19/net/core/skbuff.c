...
#ifdef CONFIG_TENDA_PRIVATE_KM
    km___copy_skb_header_hook(new, old);
#endif
             ...
             gfp_t gfp_mask)
{
     ...
     * Note that skb_release_data/skb_free_head might have already cleared it
     * but it is not guaranteed. If the buffer is cloned, then skb_release_data
