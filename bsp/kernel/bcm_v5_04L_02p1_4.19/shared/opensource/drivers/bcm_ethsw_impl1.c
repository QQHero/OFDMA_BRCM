...
extern spinlock_t mdio_access;
    ...
    defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912) || defined(CONFIG_BCM96813) || !defined(__KERNEL__)
...
void bcm_ethsw_phy_write_reg(int phy_id, int reg, uint16 data)
{
    ...
    defined(_BCM94908_) || defined(CONFIG_BCM94908) || defined(_BCM963158_) || defined(CONFIG_BCM963158) || \
    defined(_BCM963178_) || defined(CONFIG_BCM963178) || defined(_BCM947622_) || defined(CONFIG_BCM947622) || \
    defined(_BCM963146_) || defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912) || \
    defined(CONFIG_BCM96813) || defined(_BCM96756_) || defined(CONFIG_BCM96756)
...
static void phy_adjust_afe(unsigned int phy_id_base, int is_quad)
{
    ...
    defined(CONFIG_BCM94912) || defined(CONFIG_BCM96813)  || \
...
#elif defined(_BCM96756_) || defined(CONFIG_BCM96756)
static void phy_adjust_afe(unsigned int phy_id_base, int is_quad)
{
    // TODO 6756
    printk("TODO 6756 implement phy_adjust_afe");
    return;
}
#endif
...
static void extsw_register_save_restore(int save)
{
    ...
    defined(CONFIG_BCM963146) || defined(_BCM963146_) || \
    defined(CONFIG_BCM94912)  || defined(CONFIG_BCM96813)  || \
...
#if defined(PHY_TEST_CTRL)
    *PHY_TEST_CTRL =1;
#endif
#if defined(QPHY_TEST_CTRL)
    *QPHY_TEST_CTRL =1;
#endif
...
#if !defined(CONFIG_BCM963146) && !defined(CONFIG_BCM94912) && !defined(CONFIG_BCM96813)  //TODO146: for simulation don't init led
    bcm_ethsw_led_init();
#endif
