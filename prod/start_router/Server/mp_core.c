...
{
	DEBUG_LOG_I("qq===============get_wifi_info111=============\n");
...
{
	DEBUG_LOG_I("qq===============get_wifi_info222=============\n");
	debug_print("qq===============get_wifi_info222=============\n");
...
{
	DEBUG_LOG_I("qq===============get_wifi_info333=============\n");
...
{
	DEBUG_LOG_I("qq===============get_wifi_info444=============\n");
	int proxy_index;
...
{
	DEBUG_LOG_I("qq===============get_wifi_info555=============\n");
    int proxy_index;
...
{	
	DEBUG_LOG_I("qq===============get_wifi_info666=============\n");
...
{
	DEBUG_LOG_I("qq===============get_wifi_info777=============\n");
